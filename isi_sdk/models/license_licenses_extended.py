...
class LicenseLicensesExtended(object):
    ...
    def __init__(self, activation_incomplete_alert=None, base_only_licenses=None, evaluatable=None, guid=None, resume=None, swid=None, total=None, valid_signature=None, _configuration=None):  # noqa: E501
    ...
    def activation_incomplete_alert(self, activation_incomplete_alert):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and activation_incomplete_alert is None:
    ...
    def base_only_licenses(self, base_only_licenses):
        ...
        :type: list[str]
        """
        if self._configuration.client_side_validation and base_only_licenses is None:
    ...
    def evaluatable(self, evaluatable):
        ...
        :type: list[str]
        """
        if self._configuration.client_side_validation and evaluatable is None:
    ...
    @property
    def guid(self):
        """Gets the guid of this LicenseLicensesExtended.  # noqa: E501

        Cluster GUID  # noqa: E501

        :return: The guid of this LicenseLicensesExtended.  # noqa: E501
        :rtype: str
        """
        return self._guid
    ...
    @guid.setter
    def guid(self, guid):
        """Sets the guid of this LicenseLicensesExtended.

        Cluster GUID  # noqa: E501

        :param guid: The guid of this LicenseLicensesExtended.  # noqa: E501
        :type: str
        """
        ...
        if (self._configuration.client_side_validation and
                guid is not None and len(guid) < 1):
    ...
    def swid(self, swid):
        ...
        if (self._configuration.client_side_validation and
                swid is not None and len(swid) < 1):
            raise ValueError("Invalid value for `swid`, length must be greater than or equal to `1`")  # noqa: E501
        if (self._configuration.client_side_validation and
                swid is not None and not re.search(r'.+', swid)):  # noqa: E501
            raise ValueError(r"Invalid value for `swid`, must be a follow pattern or equal to `/.+/`")  # noqa: E501
    ...
    def valid_signature(self, valid_signature):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and valid_signature is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LicenseLicensesExtended, dict):

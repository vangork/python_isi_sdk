...
class DatamoverPolicy(object):
    ...
    def __init__(self, base_policy_id=None, briefcase=None, enabled=None, name=None, parent_exec_policy_id=None, policy_specific_attr=None, priority=None, run_now=None, schedule=None, version=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DatamoverPolicy, dict):

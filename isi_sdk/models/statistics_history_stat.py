...
class StatisticsHistoryStat(object):
    ...
    def __init__(self, devid=None, error=None, error_code=None, key=None, node=None, resolution=None, values=None, _configuration=None):  # noqa: E501
    ...
    def devid(self, devid):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and devid is None:
    ...
    @property
    def node(self):
        """Gets the node of this StatisticsHistoryStat.  # noqa: E501

        The LNN of node, if requested.  # noqa: E501

        :return: The node of this StatisticsHistoryStat.  # noqa: E501
        :rtype: int
        """
        return self._node
    ...
    @node.setter
    def node(self, node):
        """Sets the node of this StatisticsHistoryStat.

        The LNN of node, if requested.  # noqa: E501

        :param node: The node of this StatisticsHistoryStat.  # noqa: E501
        :type: int
        """
    ...
    def resolution(self, resolution):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and resolution is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StatisticsHistoryStat, dict):

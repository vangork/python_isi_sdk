...
class AuthNetgroup(object):
    ...
    def __init__(self, domainname=None, hostname=None, id=None, netgroup=None, username=None, _configuration=None):  # noqa: E501

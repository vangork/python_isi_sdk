...
class DiagnosticsGatherStatusGatherStatus(object):
    ...
    def __init__(self, active_status=None, last_status=None, _configuration=None):  # noqa: E501
    ...
    def active_status(self, active_status):
        ...
        if (self._configuration.client_side_validation and
                active_status not in allowed_values):
            raise ValueError(
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DiagnosticsGatherStatusGatherStatus, dict):

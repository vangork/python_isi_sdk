...
class ClusterDrainTimeoutExtended(object):
    ...
    def __init__(self, alert_timeout=None, drain_timeout=None, _configuration=None):  # noqa: E501
        """ClusterDrainTimeoutExtended - a model defined in Swagger"""  # noqa: E501
    ...
    def alert_timeout(self):
        """Gets the alert_timeout of this ClusterDrainTimeoutExtended.  # noqa: E501
        ...
        :return: The alert_timeout of this ClusterDrainTimeoutExtended.  # noqa: E501
        :rtype: int
        """
    ...
    def alert_timeout(self, alert_timeout):
        """Sets the alert_timeout of this ClusterDrainTimeoutExtended.

        The duration in seconds after drain begins that an alert will be raised. An alert timeout must be set to a smaller value than the drain timeout to be used. If not specified, an alert will not be raised (legacy behavior).  # noqa: E501

        :param alert_timeout: The alert_timeout of this ClusterDrainTimeoutExtended.  # noqa: E501
        :type: int
        """
    ...
    def drain_timeout(self):
        """Gets the drain_timeout of this ClusterDrainTimeoutExtended.  # noqa: E501
        ...
        :return: The drain_timeout of this ClusterDrainTimeoutExtended.  # noqa: E501
        :rtype: int
        """
    ...
    def drain_timeout(self, drain_timeout):
        """Sets the drain_timeout of this ClusterDrainTimeoutExtended.

        The duration in seconds that upgrade waits for all SMB clients to disconnect from a node before rebooting it. A value of 0 means wait indefinitely. If not specified, upgrade proceeds with reboots regardless of SMB client connections (legacy behavior).  # noqa: E501

        :param drain_timeout: The drain_timeout of this ClusterDrainTimeoutExtended.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClusterDrainTimeoutExtended, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterDrainTimeoutExtended):
            return False

...
class S3SettingsGlobalSettings(object):
    ...
    def __init__(self, http_port=None, https_only=None, https_port=None, service=None, _configuration=None):  # noqa: E501
    ...
    def http_port(self, http_port):
        ...
        if (self._configuration.client_side_validation and
                http_port is not None and http_port < 1024):  # noqa: E501
    ...
    def https_port(self, https_port):
        ...
        if (self._configuration.client_side_validation and
                https_port is not None and https_port < 1024):  # noqa: E501

...
class DatasetFilterMetricValues(object):
    ...
    def __init__(self, export_id=None, groupname=None, job_type=None, local_address=None, path=None, protocol=None, remote_address=None, share_name=None, system_name=None, username=None, zone_name=None, _configuration=None):  # noqa: E501
    ...
    def export_id(self, export_id):
        ...
        if (self._configuration.client_side_validation and
                export_id is not None and export_id > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `export_id`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                export_id is not None and export_id < 0):  # noqa: E501
    ...
    def zone_name(self, zone_name):
        ...
        if (self._configuration.client_side_validation and
                zone_name is not None and len(zone_name) < 1):

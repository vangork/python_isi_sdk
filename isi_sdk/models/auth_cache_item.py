...
class AuthCacheItem(object):
    ...
    def __init__(self, all=None, gid=None, group_name=None, provider=None, sid=None, uid=None, user_name=None, _configuration=None):  # noqa: E501

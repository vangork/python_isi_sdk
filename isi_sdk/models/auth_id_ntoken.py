...
class AuthIdNtoken(object):
    ...
    def __init__(self, additional_id=None, gid=None, group_sid=None, ifs_restricted=None, local_address=None, on_disk_group_id=None, on_disk_user_id=None, privilege=None, protocol=None, remote_address=None, uid=None, user_sid=None, zid=None, zone_id=None, _configuration=None):  # noqa: E501
    ...
    def local_address(self, local_address):
        ...
        if (self._configuration.client_side_validation and
                local_address is not None and len(local_address) > 255):
            raise ValueError("Invalid value for `local_address`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                local_address is not None and len(local_address) < 0):
    ...
    def remote_address(self, remote_address):
        ...
        """
        if (self._configuration.client_side_validation and
                remote_address is not None and len(remote_address) > 255):
            raise ValueError("Invalid value for `remote_address`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                remote_address is not None and len(remote_address) < 0):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AuthIdNtoken, dict):

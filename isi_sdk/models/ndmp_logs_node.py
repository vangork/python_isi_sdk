...
class NdmpLogsNode(object):
    ...
    def __init__(self, current_page=None, error=None, id=None, lnn=None, logs=None, max_page=None, status=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NdmpLogsNode, dict):

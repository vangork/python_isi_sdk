...
class PoolsPoolInterfacesInterface(object):
    ...
    def __init__(self, id=None, ip_addrs=None, lnn=None, name=None, nic_name=None, owners=None, status=None, type=None, _configuration=None):  # noqa: E501
    ...
    def type(self, type):
        ...
        allowed_values = ["any", "gige", "fastgige", "10gige", "25gige", "40gige", "100gige", "200gige", "mgmt", "ib", "ib_qdr", "ib_fdr", "aggregated", "vlan", "vmxnet3", "loopback"]  # noqa: E501
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PoolsPoolInterfacesInterface, dict):

...
class NodeStateNodeReadonly(object):
    ...
    def __init__(self, allowed=None, enabled=None, mode=None, status=None, valid=None, value=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NodeStateNodeReadonly, dict):

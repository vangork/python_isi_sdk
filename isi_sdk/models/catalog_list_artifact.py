...
class CatalogListArtifact(object):
    ...
    def __init__(self, content_type=None, desc=None, hash=None, onefs_version=None, readme=None, reference=None, _configuration=None):  # noqa: E501
    ...
    def desc(self, desc):
        ...
        if (self._configuration.client_side_validation and
                desc is not None and len(desc) < 3):
    ...
    def onefs_version(self, onefs_version):
        ...
        """
        if (self._configuration.client_side_validation and
                onefs_version is not None and onefs_version > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `onefs_version`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                onefs_version is not None and onefs_version < 0):  # noqa: E501

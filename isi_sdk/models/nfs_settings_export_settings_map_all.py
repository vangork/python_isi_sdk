...
class NfsSettingsExportSettingsMapAll(object):
    ...
    def __init__(self, enabled=None, primary_group=None, secondary_groups=None, user=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NfsSettingsExportSettingsMapAll, dict):

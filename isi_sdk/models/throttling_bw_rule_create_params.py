...
class ThrottlingBwRuleCreateParams(object):
    ...
    def __init__(self, bw_limit=None, netmask=None, rule_type=None, _configuration=None):  # noqa: E501
    ...
    def bw_limit(self, bw_limit):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and bw_limit is None:
    ...
    def netmask(self, netmask):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and netmask is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ThrottlingBwRuleCreateParams, dict):

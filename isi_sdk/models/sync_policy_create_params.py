...
class SyncPolicyCreateParams(object):
    ...
    def allow_copy_fb(self):
        """Gets the allow_copy_fb of this SyncPolicyCreateParams.  # noqa: E501

        If set to true, SyncIQ will allow a policy with copy action failback which is not supported by default.  # noqa: E501

        :return: The allow_copy_fb of this SyncPolicyCreateParams.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_copy_fb(self, allow_copy_fb):
        """Sets the allow_copy_fb of this SyncPolicyCreateParams.

        If set to true, SyncIQ will allow a policy with copy action failback which is not supported by default.  # noqa: E501

        :param allow_copy_fb: The allow_copy_fb of this SyncPolicyCreateParams.  # noqa: E501
        :type: bool
        """
    ...
    def elliptic_curve_list(self):
        """Gets the elliptic_curve_list of this SyncPolicyCreateParams.  # noqa: E501
        ...
        :return: The elliptic_curve_list of this SyncPolicyCreateParams.  # noqa: E501
        :rtype: str
        """
    ...
    def elliptic_curve_list(self, elliptic_curve_list):
        """Sets the elliptic_curve_list of this SyncPolicyCreateParams.

        The elliptic curve list being used with encryption. For SyncIQ targets, this list serves as a list of supported elliptic curves. For SyncIQ sources, the list of elliptic curves will be attempted to be used in order.  # noqa: E501

        :param elliptic_curve_list: The elliptic_curve_list of this SyncPolicyCreateParams.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def ignore_recursive_quota(self):
        """Gets the ignore_recursive_quota of this SyncPolicyCreateParams.  # noqa: E501
        ...
        :return: The ignore_recursive_quota of this SyncPolicyCreateParams.  # noqa: E501
        :rtype: bool
        """
    ...
    def ignore_recursive_quota(self, ignore_recursive_quota):
        """Sets the ignore_recursive_quota of this SyncPolicyCreateParams.

        If set to true, SyncIQ will not check the recursive quota in target paths to aid in replication to target paths which contain no quota but target cluster has lots of quotas.  # noqa: E501

        :param ignore_recursive_quota: The ignore_recursive_quota of this SyncPolicyCreateParams.  # noqa: E501
        :type: bool
        """
    ...
    def sync_existing_snapshot_expiration(self):
        """Gets the sync_existing_snapshot_expiration of this SyncPolicyCreateParams.  # noqa: E501
        ...
        :return: The sync_existing_snapshot_expiration of this SyncPolicyCreateParams.  # noqa: E501
        :rtype: bool
        """
    ...
    def sync_existing_snapshot_expiration(self, sync_existing_snapshot_expiration):
        """Sets the sync_existing_snapshot_expiration of this SyncPolicyCreateParams.

        If set to true, the expire duration for target archival snapshot is the remaining expire duration of source snapshot, requires --sync-existing-snapshot=true  # noqa: E501

        :param sync_existing_snapshot_expiration: The sync_existing_snapshot_expiration of this SyncPolicyCreateParams.  # noqa: E501
        :type: bool
        """
    ...
    def sync_existing_target_snapshot_pattern(self):
        """Gets the sync_existing_target_snapshot_pattern of this SyncPolicyCreateParams.  # noqa: E501

        The naming pattern for snapshot on the destination cluster when --sync-existing-snapshot is true  # noqa: E501

        :return: The sync_existing_target_snapshot_pattern of this SyncPolicyCreateParams.  # noqa: E501
        :rtype: str
        """
    ...
    def sync_existing_target_snapshot_pattern(self, sync_existing_target_snapshot_pattern):
        """Sets the sync_existing_target_snapshot_pattern of this SyncPolicyCreateParams.

        The naming pattern for snapshot on the destination cluster when --sync-existing-snapshot is true  # noqa: E501

        :param sync_existing_target_snapshot_pattern: The sync_existing_target_snapshot_pattern of this SyncPolicyCreateParams.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SyncPolicyCreateParams, dict):

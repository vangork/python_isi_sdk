...
class ResultDirectoriesExtended(object):
    ...
    def __init__(self, attribute_count=None, begin_time=None, dir_depth=None, dir_usage=None, path_parts=None, total_usage=None, usage_data=None, _configuration=None):  # noqa: E501
    ...
    def path_parts(self, path_parts):
        ...
        :type: list[str]
        """
        if self._configuration.client_side_validation and path_parts is None:
    ...
    def total_usage(self, total_usage):
        ...
        """
        if self._configuration.client_side_validation and total_usage is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResultDirectoriesExtended, dict):

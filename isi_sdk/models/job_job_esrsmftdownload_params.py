...
class JobJobEsrsmftdownloadParams(object):
    ...
    def __init__(self, checksum=None, file=None, path=None, size=None, _configuration=None):  # noqa: E501
    ...
    def checksum(self, checksum):
        ...
        if (self._configuration.client_side_validation and
                checksum is not None and len(checksum) > 64):
        ...
        if (self._configuration.client_side_validation and
                checksum is not None and not re.search(r'^[a-f0-9A-F]{64}', checksum)):  # noqa: E501
    ...
    def path(self, path):
        ...
        if (self._configuration.client_side_validation and
                path is not None and not re.search(r'^\/ifs', path)):  # noqa: E501

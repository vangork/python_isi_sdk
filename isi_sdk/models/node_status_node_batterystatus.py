...
class NodeStatusNodeBatterystatus(object):
    ...
    def __init__(self, last_test_time1=None, last_test_time2=None, next_test_time1=None, next_test_time2=None, present=None, result1=None, result2=None, status1=None, status2=None, supported=None, _configuration=None):  # noqa: E501
    ...
    def last_test_time1(self, last_test_time1):
        ...
        if (self._configuration.client_side_validation and
                last_test_time1 is not None and len(last_test_time1) > 255):
            raise ValueError("Invalid value for `last_test_time1`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                last_test_time1 is not None and len(last_test_time1) < 0):
    ...
    def last_test_time2(self, last_test_time2):
        ...
        """
        if (self._configuration.client_side_validation and
                last_test_time2 is not None and len(last_test_time2) > 255):
            raise ValueError("Invalid value for `last_test_time2`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                last_test_time2 is not None and len(last_test_time2) < 0):
    ...
    def next_test_time1(self, next_test_time1):
        ...
        """
        if (self._configuration.client_side_validation and
                next_test_time1 is not None and len(next_test_time1) > 255):
            raise ValueError("Invalid value for `next_test_time1`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                next_test_time1 is not None and len(next_test_time1) < 0):
    ...
    def next_test_time2(self, next_test_time2):
        ...
        """
        if (self._configuration.client_side_validation and
                next_test_time2 is not None and len(next_test_time2) > 255):
            raise ValueError("Invalid value for `next_test_time2`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                next_test_time2 is not None and len(next_test_time2) < 0):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NodeStatusNodeBatterystatus, dict):

...
class ConfigNetworkNetwork(object):
    ...
    def __init__(self, gateway=None, prefixlen=None, ranges=None, _configuration=None):  # noqa: E501
    ...
    def gateway(self, gateway):
        ...
        if (self._configuration.client_side_validation and
                gateway is not None and len(gateway) < 2):
            raise ValueError("Invalid value for `gateway`, length must be greater than or equal to `2`")  # noqa: E501
        if (self._configuration.client_side_validation and
                gateway is not None and not re.search(r'^([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])(\\.([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])){3}$', gateway)):  # noqa: E501
    ...
    def prefixlen(self, prefixlen):
        ...
        """
        if (self._configuration.client_side_validation and
                prefixlen is not None and prefixlen > 32):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConfigNetworkNetwork, dict):

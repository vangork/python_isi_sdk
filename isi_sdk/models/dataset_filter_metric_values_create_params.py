...
class DatasetFilterMetricValuesCreateParams(object):
    ...
    def __init__(self, export_id=None, groupname=None, local_address=None, path=None, protocol=None, remote_address=None, share_name=None, username=None, zone_name=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DatasetFilterMetricValuesCreateParams, dict):

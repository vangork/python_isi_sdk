...
class AuthPrivilege(object):
    ...
    def __init__(self, category=None, description=None, id=None, name=None, parent_id=None, permission=None, privilegelevel=None, uri=None, _configuration=None):  # noqa: E501
    ...
    def permission(self):
        ...
        Permissions the privilege has: r=unary (on/off only) , x=read-execute, w=read-execute-write.  # noqa: E501
    ...
    def privilegelevel(self, privilegelevel):
        ...
        """
        if (self._configuration.client_side_validation and
                privilegelevel is not None and len(privilegelevel) > 255):
            raise ValueError("Invalid value for `privilegelevel`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                privilegelevel is not None and len(privilegelevel) < 0):

...
class AuditProgressProgress(object):
    ...
    def __init__(self, protocol_audit_cee_time=None, protocol_audit_log_time=None, protocol_audit_syslog_time=None, _configuration=None):  # noqa: E501
    ...
    def protocol_audit_cee_time(self, protocol_audit_cee_time):
        ...
        if (self._configuration.client_side_validation and
                protocol_audit_cee_time is not None and protocol_audit_cee_time > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `protocol_audit_cee_time`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                protocol_audit_cee_time is not None and protocol_audit_cee_time < 0):  # noqa: E501
    ...
    def protocol_audit_log_time(self, protocol_audit_log_time):
        ...
        """
        if (self._configuration.client_side_validation and
                protocol_audit_log_time is not None and protocol_audit_log_time > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `protocol_audit_log_time`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                protocol_audit_log_time is not None and protocol_audit_log_time < 0):  # noqa: E501
    ...
    def protocol_audit_syslog_time(self, protocol_audit_syslog_time):
        ...
        """
        if (self._configuration.client_side_validation and
                protocol_audit_syslog_time is not None and protocol_audit_syslog_time > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `protocol_audit_syslog_time`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                protocol_audit_syslog_time is not None and protocol_audit_syslog_time < 0):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AuditProgressProgress, dict):

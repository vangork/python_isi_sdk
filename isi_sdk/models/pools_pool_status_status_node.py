...
class PoolsPoolStatusStatusNode(object):
    ...
    def __init__(self, devid=None, interface_status=None, ip_status=None, lnn=None, node_state=None, protocols_running=None, sc_dns_resolvable=None, suspended=None, _configuration=None):  # noqa: E501
    ...
    def ip_status(self, ip_status):
        ...
        if (self._configuration.client_side_validation and
                ip_status not in allowed_values):
            raise ValueError(
    ...
    def node_state(self, node_state):
        ...
        if (self._configuration.client_side_validation and
                node_state not in allowed_values):
            raise ValueError(
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PoolsPoolStatusStatusNode, dict):

...
class AvscanJobCreateParams(object):
    ...
    def __init__(self, description=None, enabled=None, file_extension_action=None, file_extensions=None, id=None, ignore_previous_scan_status=None, impact=None, job_name=None, paths_to_exclude=None, paths_to_include=None, scan_cloudpool_files=None, scan_if_no_extension=None, schedule=None, _configuration=None):  # noqa: E501

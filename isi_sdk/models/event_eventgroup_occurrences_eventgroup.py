...
class EventEventgroupOccurrencesEventgroup(object):
    ...
    def __init__(self, causes=None, channels=None, event_count=None, eventgroup_instance=None, id=None, ignore=None, ignore_time=None, last_event=None, ref_groups=None, resolve_time=None, resolved=None, resolver=None, sequence=None, severity=None, specifier=None, time_noticed=None, _configuration=None):  # noqa: E501
    ...
    def event_count(self, event_count):
        ...
        if (self._configuration.client_side_validation and
                event_count is not None and event_count > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `event_count`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                event_count is not None and event_count < 0):  # noqa: E501
    ...
    def eventgroup_instance(self, eventgroup_instance):
        ...
        """
        if (self._configuration.client_side_validation and
                eventgroup_instance is not None and len(eventgroup_instance) > 255):
            raise ValueError("Invalid value for `eventgroup_instance`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                eventgroup_instance is not None and len(eventgroup_instance) < 0):
    ...
    def ignore_time(self, ignore_time):
        ...
        """
        if (self._configuration.client_side_validation and
                ignore_time is not None and ignore_time > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `ignore_time`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ignore_time is not None and ignore_time < 0):  # noqa: E501
    ...
    def last_event(self, last_event):
        ...
        """
        if (self._configuration.client_side_validation and
                last_event is not None and last_event > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `last_event`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                last_event is not None and last_event < 0):  # noqa: E501
    ...
    @property
    def ref_groups(self):
        """Gets the ref_groups of this EventEventgroupOccurrencesEventgroup.  # noqa: E501

        Comma separated list of relevant log gather groups. This object will be absent in the case where no relevant logs exist.  # noqa: E501

        :return: The ref_groups of this EventEventgroupOccurrencesEventgroup.  # noqa: E501
        :rtype: str
        """
    ...
    def ref_groups(self, ref_groups):
        """Sets the ref_groups of this EventEventgroupOccurrencesEventgroup.

        Comma separated list of relevant log gather groups. This object will be absent in the case where no relevant logs exist.  # noqa: E501

        :param ref_groups: The ref_groups of this EventEventgroupOccurrencesEventgroup.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def resolve_time(self, resolve_time):
        ...
        """
        if (self._configuration.client_side_validation and
                resolve_time is not None and resolve_time > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `resolve_time`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                resolve_time is not None and resolve_time < 0):  # noqa: E501
    ...
    def sequence(self, sequence):
        ...
        """
        if (self._configuration.client_side_validation and
                sequence is not None and sequence > 9223372036854775807):  # noqa: E501
    ...
    def time_noticed(self, time_noticed):
        ...
        """
        if (self._configuration.client_side_validation and
                time_noticed is not None and time_noticed > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `time_noticed`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                time_noticed is not None and time_noticed < 0):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EventEventgroupOccurrencesEventgroup, dict):

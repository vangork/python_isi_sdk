...
class LicenseGenerateHardwareItem(object):
    ...
    def __init__(self, drive_capacity=None, node_count=None, nodes_with_seds_count=None, tier=None, _configuration=None):  # noqa: E501
    ...
    def drive_capacity(self, drive_capacity):
        ...
        if (self._configuration.client_side_validation and
                drive_capacity is not None and drive_capacity > 2147483647):  # noqa: E501
            raise ValueError("Invalid value for `drive_capacity`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self._configuration.client_side_validation and
                drive_capacity is not None and drive_capacity < 0):  # noqa: E501
    ...
    def nodes_with_seds_count(self, nodes_with_seds_count):
        ...
        """
        if (self._configuration.client_side_validation and
                nodes_with_seds_count is not None and nodes_with_seds_count > 2147483647):  # noqa: E501
            raise ValueError("Invalid value for `nodes_with_seds_count`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self._configuration.client_side_validation and
                nodes_with_seds_count is not None and nodes_with_seds_count < 0):  # noqa: E501

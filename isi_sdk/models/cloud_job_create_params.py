...
class CloudJobCreateParams(object):
    ...
    def __init__(self, accounts=None, directories=None, expiration_date=None, file_matching_pattern=None, files=None, policy=None, type=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudJobCreateParams, dict):

...
class ClusterConfigOnefsVersion(object):
    ...
    def __init__(self, build=None, copyright=None, reldate=None, release=None, revision=None, type=None, version=None, _configuration=None):  # noqa: E501
    ...
    def reldate(self, reldate):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and reldate is None:
    ...
    def release(self, release):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and release is None:

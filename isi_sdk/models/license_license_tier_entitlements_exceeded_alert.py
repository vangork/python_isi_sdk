...
class LicenseLicenseTierEntitlementsExceededAlert(object):
    ...
    def __init__(self, current=None, issue_type=None, licensed=None, _configuration=None):  # noqa: E501
    ...
    def current(self, current):
        ...
        if (self._configuration.client_side_validation and
                current is not None and current > 2147483647):  # noqa: E501
    ...
    def issue_type(self, issue_type):
        ...
        if (self._configuration.client_side_validation and
                issue_type not in allowed_values):
            raise ValueError(

...
class IdResolutionDomainsError(object):
    ...
    def __init__(self, field=None, field_value=None, message=None, _configuration=None):  # noqa: E501
    ...
    def field_value(self, field_value):
        ...
        """
        if (self._configuration.client_side_validation and
                field_value is not None and len(field_value) > 255):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IdResolutionDomainsError, dict):

...
class SummaryWorkloadWorkloadItem(object):
    ...
    def __init__(self, bytes_in=None, bytes_out=None, cpu=None, domain_id=None, error=None, export_id=None, group_id=None, group_sid=None, groupname=None, job_type=None, l2=None, l3=None, latency_other=None, latency_read=None, latency_write=None, local_address=None, local_name=None, node=None, ops=None, path=None, protocol=None, reads=None, remote_address=None, remote_name=None, share_name=None, system_name=None, time=None, user_id=None, user_sid=None, username=None, workload_id=None, workload_type=None, writes=None, zone_id=None, zone_name=None, _configuration=None):  # noqa: E501
        ...
        self.l2 = l2
        self.l3 = l3
        self.latency_other = latency_other
    ...
    def latency_other(self):
        """Gets the latency_other of this SummaryWorkloadWorkloadItem.  # noqa: E501

        Latency on other operations.  # noqa: E501

        :return: The latency_other of this SummaryWorkloadWorkloadItem.  # noqa: E501
        :rtype: float
        """
    ...
    def latency_other(self, latency_other):
        """Sets the latency_other of this SummaryWorkloadWorkloadItem.

        Latency on other operations.  # noqa: E501

        :param latency_other: The latency_other of this SummaryWorkloadWorkloadItem.  # noqa: E501
        :type: float
        """
        if self._configuration.client_side_validation and latency_other is None:
            raise ValueError("Invalid value for `latency_other`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                latency_other is not None and latency_other > 18446744073709551615):  # noqa: E501
            raise ValueError("Invalid value for `latency_other`, must be a value less than or equal to `18446744073709551615`")  # noqa: E501
        if (self._configuration.client_side_validation and
                latency_other is not None and latency_other < 0):  # noqa: E501
            raise ValueError("Invalid value for `latency_other`, must be a value greater than or equal to `0`")  # noqa: E501

        self._latency_other = latency_other

    @property
    def latency_read(self):
        """Gets the latency_read of this SummaryWorkloadWorkloadItem.  # noqa: E501

        Latency on disk read operations.  # noqa: E501

        :return: The latency_read of this SummaryWorkloadWorkloadItem.  # noqa: E501
        :rtype: float
        """
    ...
    def latency_read(self, latency_read):
        """Sets the latency_read of this SummaryWorkloadWorkloadItem.

        Latency on disk read operations.  # noqa: E501

        :param latency_read: The latency_read of this SummaryWorkloadWorkloadItem.  # noqa: E501
        :type: float
        """
        if self._configuration.client_side_validation and latency_read is None:
            raise ValueError("Invalid value for `latency_read`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                latency_read is not None and latency_read > 18446744073709551615):  # noqa: E501
            raise ValueError("Invalid value for `latency_read`, must be a value less than or equal to `18446744073709551615`")  # noqa: E501
        if (self._configuration.client_side_validation and
                latency_read is not None and latency_read < 0):  # noqa: E501
            raise ValueError("Invalid value for `latency_read`, must be a value greater than or equal to `0`")  # noqa: E501

        self._latency_read = latency_read

    @property
    def latency_write(self):
        """Gets the latency_write of this SummaryWorkloadWorkloadItem.  # noqa: E501

        Latency on disk write operations.  # noqa: E501

        :return: The latency_write of this SummaryWorkloadWorkloadItem.  # noqa: E501
        :rtype: float
        """
    ...
    def latency_write(self, latency_write):
        """Sets the latency_write of this SummaryWorkloadWorkloadItem.

        Latency on disk write operations.  # noqa: E501

        :param latency_write: The latency_write of this SummaryWorkloadWorkloadItem.  # noqa: E501
        :type: float
        """
        if self._configuration.client_side_validation and latency_write is None:
            raise ValueError("Invalid value for `latency_write`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                latency_write is not None and latency_write > 18446744073709551615):  # noqa: E501
            raise ValueError("Invalid value for `latency_write`, must be a value less than or equal to `18446744073709551615`")  # noqa: E501
        if (self._configuration.client_side_validation and
                latency_write is not None and latency_write < 0):  # noqa: E501
            raise ValueError("Invalid value for `latency_write`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def path(self):
        ...
        The path which the operation was requested on.  # noqa: E501
    ...
    def time(self, time):
        ...
        if (self._configuration.client_side_validation and
                time is not None and time > 9223372036854775807):  # noqa: E501

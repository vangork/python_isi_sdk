...
class AdsProviderDomainsDomain(object):
    ...
    def __init__(self, client_site=None, dc_address=None, dc_name=None, dc_site=None, domain=None, guid=None, id=None, netbios_name=None, sid=None, status=None, trust_type=None, _configuration=None):  # noqa: E501
    ...
    def domain(self, domain):
        ...
        if (self._configuration.client_side_validation and
                domain is not None and len(domain) < 2):

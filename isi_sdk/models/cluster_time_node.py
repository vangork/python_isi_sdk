...
class ClusterTimeNode(object):
    ...
    def __init__(self, error=None, id=None, lnn=None, status=None, time=None, _configuration=None):  # noqa: E501
        """ClusterTimeNode - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this ClusterTimeNode.  # noqa: E501

        Error message, if the HTTP status returned from this node was not 200.  # noqa: E501

        :return: The error of this ClusterTimeNode.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        ...
        :param error: The error of this ClusterTimeNode.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this ClusterTimeNode.  # noqa: E501

        Node ID (Device Number) of a node.  # noqa: E501

        :return: The id of this ClusterTimeNode.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this ClusterTimeNode.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def lnn(self):
        """Gets the lnn of this ClusterTimeNode.  # noqa: E501

        Logical Node Number (LNN) of a node.  # noqa: E501

        :return: The lnn of this ClusterTimeNode.  # noqa: E501
        :rtype: int
        """
        return self._lnn
    ...
    def lnn(self, lnn):
        ...
        :param lnn: The lnn of this ClusterTimeNode.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def status(self):
        """Gets the status of this ClusterTimeNode.  # noqa: E501

        Status of the HTTP response from this node if not 200.  If 200, this field does not appear.  # noqa: E501

        :return: The status of this ClusterTimeNode.  # noqa: E501
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this ClusterTimeNode.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def time(self, time):
        ...
        :param time: The time of this ClusterTimeNode.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
        ...
        if (self._configuration.client_side_validation and
                time is not None and time < -9223372036854775808):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClusterTimeNode, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterTimeNode):
            return False

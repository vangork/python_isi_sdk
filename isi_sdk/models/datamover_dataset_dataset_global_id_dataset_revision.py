...
class DatamoverDatasetDatasetGlobalIdDatasetRevision(object):
    ...
    def __init__(self, local_unid=None, system_guid=None, _configuration=None):  # noqa: E501
    ...
    def local_unid(self, local_unid):
        ...
        if (self._configuration.client_side_validation and
                local_unid is not None and local_unid > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `local_unid`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                local_unid is not None and local_unid < 0):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DatamoverDatasetDatasetGlobalIdDatasetRevision, dict):

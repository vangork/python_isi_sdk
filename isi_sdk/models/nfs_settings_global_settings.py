...
class NfsSettingsGlobalSettings(object):
    ...
    attribute_map = {
        ...
        'nfsv40_enabled': 'nfsv40_enabled',
        'nfsv41_enabled': 'nfsv41_enabled',
        'nfsv42_enabled': 'nfsv42_enabled',
    ...
    def __init__(self, nfs_rdma_enabled=None, nfsv3_enabled=None, nfsv40_enabled=None, nfsv41_enabled=None, nfsv42_enabled=None, nfsv4_enabled=None, rpc_maxthreads=None, rpc_minthreads=None, rquota_enabled=None, service=None, _configuration=None):  # noqa: E501
        """NfsSettingsGlobalSettings - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._nfs_rdma_enabled = None
        self._nfsv3_enabled = None
        self._nfsv40_enabled = None
        self._nfsv41_enabled = None
        self._nfsv42_enabled = None
    ...
    @property
    def nfs_rdma_enabled(self):
        """Gets the nfs_rdma_enabled of this NfsSettingsGlobalSettings.  # noqa: E501

        True if the RDMA is enabled for NFS  # noqa: E501

        :return: The nfs_rdma_enabled of this NfsSettingsGlobalSettings.  # noqa: E501
        :rtype: bool
        """
        return self._nfs_rdma_enabled

    @nfs_rdma_enabled.setter
    def nfs_rdma_enabled(self, nfs_rdma_enabled):
        """Sets the nfs_rdma_enabled of this NfsSettingsGlobalSettings.

        True if the RDMA is enabled for NFS  # noqa: E501

        :param nfs_rdma_enabled: The nfs_rdma_enabled of this NfsSettingsGlobalSettings.  # noqa: E501
        :type: bool
        """

        self._nfs_rdma_enabled = nfs_rdma_enabled
    ...
    @property
    def nfsv40_enabled(self):
        """Gets the nfsv40_enabled of this NfsSettingsGlobalSettings.  # noqa: E501

        Enable/disable minor version 0 of NFSv4 protocol.  # noqa: E501

        :return: The nfsv40_enabled of this NfsSettingsGlobalSettings.  # noqa: E501
        :rtype: bool
        """
        return self._nfsv40_enabled

    @nfsv40_enabled.setter
    def nfsv40_enabled(self, nfsv40_enabled):
        """Sets the nfsv40_enabled of this NfsSettingsGlobalSettings.

        Enable/disable minor version 0 of NFSv4 protocol.  # noqa: E501

        :param nfsv40_enabled: The nfsv40_enabled of this NfsSettingsGlobalSettings.  # noqa: E501
        :type: bool
        """

        self._nfsv40_enabled = nfsv40_enabled

    @property
    def nfsv41_enabled(self):
        """Gets the nfsv41_enabled of this NfsSettingsGlobalSettings.  # noqa: E501

        Enable/disable minor version 1 of NFSv4 protocol.  # noqa: E501

        :return: The nfsv41_enabled of this NfsSettingsGlobalSettings.  # noqa: E501
        :rtype: bool
        """
        return self._nfsv41_enabled

    @nfsv41_enabled.setter
    def nfsv41_enabled(self, nfsv41_enabled):
        """Sets the nfsv41_enabled of this NfsSettingsGlobalSettings.

        Enable/disable minor version 1 of NFSv4 protocol.  # noqa: E501

        :param nfsv41_enabled: The nfsv41_enabled of this NfsSettingsGlobalSettings.  # noqa: E501
        :type: bool
        """

        self._nfsv41_enabled = nfsv41_enabled

    @property
    def nfsv42_enabled(self):
        """Gets the nfsv42_enabled of this NfsSettingsGlobalSettings.  # noqa: E501

        Enable/disable minor version 2 of NFSv4 protocol.  # noqa: E501

        :return: The nfsv42_enabled of this NfsSettingsGlobalSettings.  # noqa: E501
        :rtype: bool
        """
        return self._nfsv42_enabled

    @nfsv42_enabled.setter
    def nfsv42_enabled(self, nfsv42_enabled):
        """Sets the nfsv42_enabled of this NfsSettingsGlobalSettings.

        Enable/disable minor version 2 of NFSv4 protocol.  # noqa: E501

        :param nfsv42_enabled: The nfsv42_enabled of this NfsSettingsGlobalSettings.  # noqa: E501
        :type: bool
        """

        self._nfsv42_enabled = nfsv42_enabled

    @property
    def nfsv4_enabled(self):
        """Gets the nfsv4_enabled of this NfsSettingsGlobalSettings.  # noqa: E501

        Enable/disable all minor versions of NFSv4 protocol.  # noqa: E501
    ...
    def rpc_maxthreads(self, rpc_maxthreads):
        ...
        if (self._configuration.client_side_validation and
                rpc_maxthreads is not None and rpc_maxthreads > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `rpc_maxthreads`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                rpc_maxthreads is not None and rpc_maxthreads < 1):  # noqa: E501
    ...
    def rpc_minthreads(self, rpc_minthreads):
        ...
        """
        if (self._configuration.client_side_validation and
                rpc_minthreads is not None and rpc_minthreads > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `rpc_minthreads`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                rpc_minthreads is not None and rpc_minthreads < 1):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NfsSettingsGlobalSettings, dict):

...
class ClusterIdentity(object):
    ...
    def __init__(self, description=None, logon=None, mttdl_level_msg=None, name=None, _configuration=None):  # noqa: E501
    ...
    def logon(self, logon):
        ...
        """
        if self._configuration.client_side_validation and logon is None:

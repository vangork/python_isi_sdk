...
class AuditSettingsSettings(object):
    ...
    def __init__(self, audit_failure=None, audit_success=None, syslog_audit_events=None, syslog_forwarding_enabled=None, _configuration=None):  # noqa: E501
    ...
    def audit_success(self, audit_success):
        ...
        allowed_values = ["close", "close_directory", "close_file", "close_file_modified", "close_file_unmodified", "create", "create_directory", "create_file", "delete", "delete_directory", "delete_file", "get_security", "get_security_directory", "get_security_file", "logoff", "logon", "open", "open_directory", "open_file", "open_file_noaccess", "open_file_read", "open_file_write", "read", "read_file", "rename", "rename_directory", "rename_file", "set_security", "set_security_directory", "set_security_file", "tree_connect", "write", "write_file", "share_access_check"]  # noqa: E501
        if (self._configuration.client_side_validation and
                not set(audit_success).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
    ...
    def syslog_audit_events(self, syslog_audit_events):
        ...
        allowed_values = ["close", "close_directory", "close_file", "close_file_modified", "close_file_unmodified", "create", "create_directory", "create_file", "delete", "delete_directory", "delete_file", "get_security", "get_security_directory", "get_security_file", "logoff", "logon", "open", "open_directory", "open_file", "open_file_noaccess", "open_file_read", "open_file_write", "read", "read_file", "rename", "rename_directory", "rename_file", "set_security", "set_security_directory", "set_security_file", "tree_connect", "write", "write_file", "share_access_check"]  # noqa: E501
        if (self._configuration.client_side_validation and
                not set(syslog_audit_events).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(

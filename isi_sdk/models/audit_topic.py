...
class AuditTopic(object):
    ...
    def __init__(self, id=None, max_cached_messages=None, _configuration=None):  # noqa: E501
    ...
    def max_cached_messages(self, max_cached_messages):
        ...
        """
        if (self._configuration.client_side_validation and
                max_cached_messages is not None and max_cached_messages > 16384):  # noqa: E501
            raise ValueError("Invalid value for `max_cached_messages`, must be a value less than or equal to `16384`")  # noqa: E501
        if (self._configuration.client_side_validation and
                max_cached_messages is not None and max_cached_messages < 0):  # noqa: E501

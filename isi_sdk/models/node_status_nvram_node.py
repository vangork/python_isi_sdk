...
class NodeStatusNvramNode(object):
    ...
    def __init__(self, batteries=None, battery_count=None, charge_status=None, charge_status_number=None, error=None, id=None, lnn=None, present=None, present_flash=None, present_size=None, present_type=None, status=None, supported=None, supported_flash=None, supported_type=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NodeStatusNvramNode, dict):

...
class CreateHardwareTapeNameResponseNodeRescanReportItem(object):
    ...
    def __init__(self, devicename=None, path=None, product=None, serial=None, status_report=None, wwnn=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateHardwareTapeNameResponseNodeRescanReportItem, dict):

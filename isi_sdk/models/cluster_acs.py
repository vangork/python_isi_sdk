...
class ClusterAcs(object):
    ...
    def __init__(self, failed_nodes_sn=None, joined_nodes=None, license_status=None, srs_status=None, total_nodes=None, unresponsive_sn=None, _configuration=None):  # noqa: E501
    ...
    def joined_nodes(self, joined_nodes):
        ...
        if (self._configuration.client_side_validation and
                joined_nodes is not None and joined_nodes > 2147483647):  # noqa: E501
            raise ValueError("Invalid value for `joined_nodes`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self._configuration.client_side_validation and
                joined_nodes is not None and joined_nodes < 0):  # noqa: E501
    ...
    def license_status(self, license_status):
        ...
        """
        if (self._configuration.client_side_validation and
                license_status is not None and len(license_status) > 255):
            raise ValueError("Invalid value for `license_status`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                license_status is not None and len(license_status) < 1):
    ...
    def total_nodes(self, total_nodes):
        ...
        """
        if (self._configuration.client_side_validation and
                total_nodes is not None and total_nodes > 2147483647):  # noqa: E501
            raise ValueError("Invalid value for `total_nodes`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self._configuration.client_side_validation and
                total_nodes is not None and total_nodes < 0):  # noqa: E501

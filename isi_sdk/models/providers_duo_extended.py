...
class ProvidersDuoExtended(object):
    ...
    def __init__(self, autopush=None, enabled=None, failmode=None, fallback_local_ip=None, groups=None, host=None, http_proxy=None, https_timeout=None, ikey=None, prompts=None, pushinfo=None, skey=None, _configuration=None):  # noqa: E501

...
class SettingsReportsSettings(object):
    ...
    def __init__(self, live_dir=None, live_retain=None, schedule=None, scheduled_dir=None, scheduled_retain=None, _configuration=None):  # noqa: E501
    ...
    def live_retain(self, live_retain):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and live_retain is None:
            raise ValueError("Invalid value for `live_retain`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                live_retain is not None and live_retain < 1):  # noqa: E501
    ...
    def scheduled_retain(self, scheduled_retain):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and scheduled_retain is None:
            raise ValueError("Invalid value for `scheduled_retain`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                scheduled_retain is not None and scheduled_retain < 1):  # noqa: E501

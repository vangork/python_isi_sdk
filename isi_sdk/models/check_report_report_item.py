...
class CheckReportReportItem(object):
    ...
    def __init__(self, category=None, check_failed=None, reason=None, _configuration=None):  # noqa: E501
    ...
    def reason(self, reason):
        ...
        """
        if (self._configuration.client_side_validation and
                reason is not None and len(reason) > 8192):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CheckReportReportItem, dict):

...
class NodeStateNode(object):
    ...
    swagger_types = {
        ...
        'id': 'int',
        'lnn': 'int',
        'readonly': 'NodeStateNodeReadonly',
        'servicelight': 'NodeStateNodeServicelight',
        'smartfail': 'NodeStateNodeSmartfail',
        'status': 'int'
    }
    ...
    def __init__(self, error=None, id=None, lnn=None, readonly=None, servicelight=None, smartfail=None, status=None, _configuration=None):  # noqa: E501
        """NodeStateNode - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this NodeStateNode.  # noqa: E501

        Error message, if the HTTP status returned from this node was not 200.  # noqa: E501

        :return: The error of this NodeStateNode.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this NodeStateNode.

        Error message, if the HTTP status returned from this node was not 200.  # noqa: E501

        :param error: The error of this NodeStateNode.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this NodeStateNode.  # noqa: E501

        Node ID (Device Number) of a node.  # noqa: E501

        :return: The id of this NodeStateNode.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this NodeStateNode.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def lnn(self):
        """Gets the lnn of this NodeStateNode.  # noqa: E501

        Logical Node Number (LNN) of a node.  # noqa: E501

        :return: The lnn of this NodeStateNode.  # noqa: E501
        :rtype: int
        """
        return self._lnn
    ...
    def lnn(self, lnn):
        ...
        :param lnn: The lnn of this NodeStateNode.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def readonly(self):
        """Gets the readonly of this NodeStateNode.  # noqa: E501

        Node readonly state.  # noqa: E501

        :return: The readonly of this NodeStateNode.  # noqa: E501
        :rtype: NodeStateNodeReadonly
        """
    ...
    def readonly(self, readonly):
        ...
        :param readonly: The readonly of this NodeStateNode.  # noqa: E501
        :type: NodeStateNodeReadonly
        """
    ...
    def servicelight(self):
        """Gets the servicelight of this NodeStateNode.  # noqa: E501

        Node service light state.  # noqa: E501

        :return: The servicelight of this NodeStateNode.  # noqa: E501
    ...
    def servicelight(self, servicelight):
        ...
        :param servicelight: The servicelight of this NodeStateNode.  # noqa: E501
    ...
    @property
    def smartfail(self):
        """Gets the smartfail of this NodeStateNode.  # noqa: E501

        Node smartfail state.  # noqa: E501

        :return: The smartfail of this NodeStateNode.  # noqa: E501
        :rtype: NodeStateNodeSmartfail
        """
    ...
    def smartfail(self, smartfail):
        ...
        :param smartfail: The smartfail of this NodeStateNode.  # noqa: E501
        :type: NodeStateNodeSmartfail
        """
    ...
    def status(self, status):
        """Sets the status of this NodeStateNode.

        Status of the HTTP response from this node if not 200.  If 200, this field does not appear.  # noqa: E501

        :param status: The status of this NodeStateNode.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NodeStateNode, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NodeStateNode):
            return False

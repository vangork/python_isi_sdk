...
class PoolsPoolRulesRule(object):
    ...
    def __init__(self, description=None, groupnet=None, id=None, iface=None, linklayer=None, name=None, node_type=None, pool=None, subnet=None, _configuration=None):  # noqa: E501
    ...
    @property
    def linklayer(self):
        """Gets the linklayer of this PoolsPoolRulesRule.  # noqa: E501

        Linklayer of the subnet this rule belongs to.  # noqa: E501

        :return: The linklayer of this PoolsPoolRulesRule.  # noqa: E501
        :rtype: str
        """
    ...
    def linklayer(self, linklayer):
        """Sets the linklayer of this PoolsPoolRulesRule.

        Linklayer of the subnet this rule belongs to.  # noqa: E501

        :param linklayer: The linklayer of this PoolsPoolRulesRule.  # noqa: E501
        :type: str
        """
    ...
    def pool(self, pool):
        ...
        if (self._configuration.client_side_validation and
                pool is not None and len(pool) < 1):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PoolsPoolRulesRule, dict):

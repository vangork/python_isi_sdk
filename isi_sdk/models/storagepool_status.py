...
class StoragepoolStatus(object):
    ...
    swagger_types = {
        ...
        'unprovisioned': 'list[StoragepoolStatusUnhealthyItemAffectedItemDevice]'
    }
    ...
    def __init__(self, unhealthy=None, unprovisioned=None, _configuration=None):  # noqa: E501
    ...
    def unhealthy(self, unhealthy):
        ...
        """
        if self._configuration.client_side_validation and unhealthy is None:
    ...
    def unprovisioned(self, unprovisioned):
        ...
        """
        if self._configuration.client_side_validation and unprovisioned is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StoragepoolStatus, dict):

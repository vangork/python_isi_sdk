...
class LicenseActivationElmsError(object):
    ...
    def __init__(self, code=None, error=None, _configuration=None):  # noqa: E501
    ...
    def error(self):
        ...
        An error string returned from the SRS ELMS rest call  # noqa: E501
    ...
    def error(self, error):
        ...
        """
        if (self._configuration.client_side_validation and
                error is not None and len(error) > 50):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LicenseActivationElmsError, dict):

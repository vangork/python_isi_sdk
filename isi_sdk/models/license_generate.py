...
class LicenseGenerate(object):
    ...
    def __init__(self, activated_license_list=None, activation=None, hardware=None, not_activated_license_list=None, _configuration=None):  # noqa: E501
    ...
    def activation(self, activation):
        ...
        if (self._configuration.client_side_validation and
                activation is not None and len(activation) > 2147483647):
            raise ValueError("Invalid value for `activation`, length must be less than or equal to `2147483647`")  # noqa: E501
        if (self._configuration.client_side_validation and
                activation is not None and len(activation) < 1):
            raise ValueError("Invalid value for `activation`, length must be greater than or equal to `1`")  # noqa: E501
        if (self._configuration.client_side_validation and
                activation is not None and not re.search(r'.+', activation)):  # noqa: E501
            raise ValueError(r"Invalid value for `activation`, must be a follow pattern or equal to `/.+/`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LicenseGenerate, dict):

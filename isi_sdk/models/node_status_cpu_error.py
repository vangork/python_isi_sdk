...
class NodeStatusCpuError(object):
    ...
    def __init__(self, code=None, field=None, id=None, lnn=None, message=None, status=None, _configuration=None):  # noqa: E501
    ...
    def code(self, code):
        ...
        if (self._configuration.client_side_validation and
                code is not None and len(code) > 8192):
    ...
    def field(self, field):
        ...
        """
        if (self._configuration.client_side_validation and
                field is not None and len(field) > 8192):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NodeStatusCpuError, dict):

...
class PerformanceMetric(object):
    ...
    def __init__(self, datatype=None, description=None, id=None, system_only=None, value_set=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PerformanceMetric, dict):

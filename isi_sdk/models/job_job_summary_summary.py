...
class JobJobSummarySummary(object):
    ...
    attribute_map = {
        ...
        'smartthrottling_enabled': 'smartthrottling_enabled',
        'stats_ready': 'stats_ready'
    }

    def __init__(self, cluster_is_degraded=None, connected=None, coordinator=None, coordinator_lnn=None, disconnected_nodes=None, down_or_read_only_nodes=None, job_d_enabled=None, next_jid=None, non_responding_nodes=None, pp_enabled=None, run_degraded=None, smartthrottling_enabled=None, stats_ready=None, _configuration=None):  # noqa: E501
        ...
        self._pp_enabled = None
        self._run_degraded = None
        self._smartthrottling_enabled = None
        ...
        self.smartthrottling_enabled = smartthrottling_enabled
    ...
    def cluster_is_degraded(self, cluster_is_degraded):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and cluster_is_degraded is None:
    ...
    def coordinator_lnn(self, coordinator_lnn):
        ...
        """
        if (self._configuration.client_side_validation and
                coordinator_lnn is not None and coordinator_lnn > 65535):  # noqa: E501
            raise ValueError("Invalid value for `coordinator_lnn`, must be a value less than or equal to `65535`")  # noqa: E501
        if (self._configuration.client_side_validation and
                coordinator_lnn is not None and coordinator_lnn < 1):  # noqa: E501
    ...
    def down_or_read_only_nodes(self, down_or_read_only_nodes):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and down_or_read_only_nodes is None:
    ...
    def job_d_enabled(self, job_d_enabled):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and job_d_enabled is None:
    ...
    @property
    def pp_enabled(self):
        """Gets the pp_enabled of this JobJobSummarySummary.  # noqa: E501

        Whether Job Engine uses SmartThrottling  # noqa: E501

        :return: The pp_enabled of this JobJobSummarySummary.  # noqa: E501
        :rtype: bool
        """
        return self._pp_enabled

    @pp_enabled.setter
    def pp_enabled(self, pp_enabled):
        """Sets the pp_enabled of this JobJobSummarySummary.

        Whether Job Engine uses SmartThrottling  # noqa: E501

        :param pp_enabled: The pp_enabled of this JobJobSummarySummary.  # noqa: E501
        :type: bool
        """
        if self._configuration.client_side_validation and pp_enabled is None:
            raise ValueError("Invalid value for `pp_enabled`, must not be `None`")  # noqa: E501
    ...
    def run_degraded(self, run_degraded):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and run_degraded is None:
            raise ValueError("Invalid value for `run_degraded`, must not be `None`")  # noqa: E501

        self._run_degraded = run_degraded

    @property
    def smartthrottling_enabled(self):
        """Gets the smartthrottling_enabled of this JobJobSummarySummary.  # noqa: E501

        Whether Job Engine uses SmartThrottling  # noqa: E501

        :return: The smartthrottling_enabled of this JobJobSummarySummary.  # noqa: E501
        :rtype: bool
        """
        return self._smartthrottling_enabled

    @smartthrottling_enabled.setter
    def smartthrottling_enabled(self, smartthrottling_enabled):
        """Sets the smartthrottling_enabled of this JobJobSummarySummary.

        Whether Job Engine uses SmartThrottling  # noqa: E501

        :param smartthrottling_enabled: The smartthrottling_enabled of this JobJobSummarySummary.  # noqa: E501
        :type: bool
        """
        if self._configuration.client_side_validation and smartthrottling_enabled is None:
            raise ValueError("Invalid value for `smartthrottling_enabled`, must not be `None`")  # noqa: E501

        self._smartthrottling_enabled = smartthrottling_enabled
    ...
    def stats_ready(self, stats_ready):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and stats_ready is None:

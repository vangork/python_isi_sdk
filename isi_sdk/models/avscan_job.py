...
class AvscanJob(object):
    ...
    def __init__(self, description=None, enabled=None, file_extension_action=None, file_extensions=None, id=None, ignore_previous_scan_status=None, impact=None, new_name=None, paths_to_exclude=None, paths_to_include=None, scan_cloudpool_files=None, scan_if_no_extension=None, schedule=None, _configuration=None):  # noqa: E501
    ...
    def new_name(self, new_name):
        ...
        """
        if (self._configuration.client_side_validation and
                new_name is not None and len(new_name) > 128):

...
class CertificatesSyslogItem(object):
    ...
    def __init__(self, certificate_key_password=None, certificate_key_path=None, certificate_path=None, description=None, name=None, _configuration=None):  # noqa: E501
    ...
    def certificate_key_path(self, certificate_key_path):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and certificate_key_path is None:

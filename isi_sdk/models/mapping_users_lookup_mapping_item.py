...
class MappingUsersLookupMappingItem(object):
    ...
    def __init__(self, groups=None, object_history=None, privileges=None, user=None, zid=None, zone=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MappingUsersLookupMappingItem, dict):

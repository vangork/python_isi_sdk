...
class HistogramStatBy(object):
    ...
    def __init__(self, begin_time=None, breakouts=None, result_length=None, _configuration=None):  # noqa: E501
    ...
    def breakouts(self, breakouts):
        ...
        """
        if self._configuration.client_side_validation and breakouts is None:
    ...
    def result_length(self, result_length):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and result_length is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HistogramStatBy, dict):

...
class NetworkDnscacheSettings(object):
    ...
    def __init__(self, cache_entry_limit=None, cluster_timeout=None, dns_timeout=None, eager_refresh=None, testping_delta=None, ttl_max_noerror=None, ttl_max_nxdomain=None, ttl_max_other=None, ttl_max_servfail=None, ttl_min_noerror=None, ttl_min_nxdomain=None, ttl_min_other=None, ttl_min_servfail=None, _configuration=None):  # noqa: E501
    ...
    def cache_entry_limit(self, cache_entry_limit):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and cache_entry_limit is None:
            raise ValueError("Invalid value for `cache_entry_limit`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                cache_entry_limit is not None and cache_entry_limit > 1048576):  # noqa: E501
            raise ValueError("Invalid value for `cache_entry_limit`, must be a value less than or equal to `1048576`")  # noqa: E501
        if (self._configuration.client_side_validation and
                cache_entry_limit is not None and cache_entry_limit < 1):  # noqa: E501
    ...
    def cluster_timeout(self, cluster_timeout):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and cluster_timeout is None:
            raise ValueError("Invalid value for `cluster_timeout`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                cluster_timeout is not None and cluster_timeout > 30):  # noqa: E501
            raise ValueError("Invalid value for `cluster_timeout`, must be a value less than or equal to `30`")  # noqa: E501
        if (self._configuration.client_side_validation and
                cluster_timeout is not None and cluster_timeout < 1):  # noqa: E501
    ...
    def dns_timeout(self, dns_timeout):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and dns_timeout is None:
            raise ValueError("Invalid value for `dns_timeout`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                dns_timeout is not None and dns_timeout > 30):  # noqa: E501
            raise ValueError("Invalid value for `dns_timeout`, must be a value less than or equal to `30`")  # noqa: E501
        if (self._configuration.client_side_validation and
                dns_timeout is not None and dns_timeout < 1):  # noqa: E501
    ...
    def eager_refresh(self, eager_refresh):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and eager_refresh is None:
            raise ValueError("Invalid value for `eager_refresh`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                eager_refresh is not None and eager_refresh > 60):  # noqa: E501
            raise ValueError("Invalid value for `eager_refresh`, must be a value less than or equal to `60`")  # noqa: E501
        if (self._configuration.client_side_validation and
                eager_refresh is not None and eager_refresh < 0):  # noqa: E501
    ...
    def testping_delta(self, testping_delta):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and testping_delta is None:
            raise ValueError("Invalid value for `testping_delta`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                testping_delta is not None and testping_delta > 60):  # noqa: E501
            raise ValueError("Invalid value for `testping_delta`, must be a value less than or equal to `60`")  # noqa: E501
        if (self._configuration.client_side_validation and
                testping_delta is not None and testping_delta < 0):  # noqa: E501
    ...
    def ttl_max_noerror(self, ttl_max_noerror):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and ttl_max_noerror is None:
            raise ValueError("Invalid value for `ttl_max_noerror`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ttl_max_noerror is not None and ttl_max_noerror > 3600):  # noqa: E501
            raise ValueError("Invalid value for `ttl_max_noerror`, must be a value less than or equal to `3600`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ttl_max_noerror is not None and ttl_max_noerror < 0):  # noqa: E501
    ...
    def ttl_max_nxdomain(self, ttl_max_nxdomain):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and ttl_max_nxdomain is None:
            raise ValueError("Invalid value for `ttl_max_nxdomain`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ttl_max_nxdomain is not None and ttl_max_nxdomain > 3600):  # noqa: E501
            raise ValueError("Invalid value for `ttl_max_nxdomain`, must be a value less than or equal to `3600`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ttl_max_nxdomain is not None and ttl_max_nxdomain < 0):  # noqa: E501
    ...
    def ttl_max_other(self, ttl_max_other):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and ttl_max_other is None:
            raise ValueError("Invalid value for `ttl_max_other`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ttl_max_other is not None and ttl_max_other > 3600):  # noqa: E501
            raise ValueError("Invalid value for `ttl_max_other`, must be a value less than or equal to `3600`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ttl_max_other is not None and ttl_max_other < 0):  # noqa: E501
    ...
    def ttl_max_servfail(self, ttl_max_servfail):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and ttl_max_servfail is None:
            raise ValueError("Invalid value for `ttl_max_servfail`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ttl_max_servfail is not None and ttl_max_servfail > 3600):  # noqa: E501
            raise ValueError("Invalid value for `ttl_max_servfail`, must be a value less than or equal to `3600`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ttl_max_servfail is not None and ttl_max_servfail < 0):  # noqa: E501
    ...
    def ttl_min_noerror(self, ttl_min_noerror):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and ttl_min_noerror is None:
            raise ValueError("Invalid value for `ttl_min_noerror`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ttl_min_noerror is not None and ttl_min_noerror > 3600):  # noqa: E501
            raise ValueError("Invalid value for `ttl_min_noerror`, must be a value less than or equal to `3600`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ttl_min_noerror is not None and ttl_min_noerror < 0):  # noqa: E501
    ...
    def ttl_min_nxdomain(self, ttl_min_nxdomain):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and ttl_min_nxdomain is None:
            raise ValueError("Invalid value for `ttl_min_nxdomain`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ttl_min_nxdomain is not None and ttl_min_nxdomain > 3600):  # noqa: E501
            raise ValueError("Invalid value for `ttl_min_nxdomain`, must be a value less than or equal to `3600`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ttl_min_nxdomain is not None and ttl_min_nxdomain < 0):  # noqa: E501
    ...
    def ttl_min_other(self, ttl_min_other):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and ttl_min_other is None:
            raise ValueError("Invalid value for `ttl_min_other`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ttl_min_other is not None and ttl_min_other > 3600):  # noqa: E501
            raise ValueError("Invalid value for `ttl_min_other`, must be a value less than or equal to `3600`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ttl_min_other is not None and ttl_min_other < 0):  # noqa: E501
    ...
    def ttl_min_servfail(self, ttl_min_servfail):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and ttl_min_servfail is None:
            raise ValueError("Invalid value for `ttl_min_servfail`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ttl_min_servfail is not None and ttl_min_servfail > 3600):  # noqa: E501
            raise ValueError("Invalid value for `ttl_min_servfail`, must be a value less than or equal to `3600`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ttl_min_servfail is not None and ttl_min_servfail < 0):  # noqa: E501

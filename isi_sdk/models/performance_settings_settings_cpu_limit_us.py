...
class PerformanceSettingsSettingsCpuLimitUs(object):
    ...
    def __init__(self, base_limit=None, health_modifier=None, impact_multiplier=None, max_health_multiplier_unhealthy=None, min_health_multiplier=None, starting_health_multiplier=None, _configuration=None):  # noqa: E501
    ...
    def base_limit(self, base_limit):
        ...
        if (self._configuration.client_side_validation and
                base_limit is not None and base_limit > 30000000):  # noqa: E501
            raise ValueError("Invalid value for `base_limit`, must be a value less than or equal to `30000000`")  # noqa: E501
        if (self._configuration.client_side_validation and
                base_limit is not None and base_limit < 10):  # noqa: E501
    ...
    def max_health_multiplier_unhealthy(self, max_health_multiplier_unhealthy):
        ...
        """
        if (self._configuration.client_side_validation and
                max_health_multiplier_unhealthy is not None and max_health_multiplier_unhealthy > 10000):  # noqa: E501
            raise ValueError("Invalid value for `max_health_multiplier_unhealthy`, must be a value less than or equal to `10000`")  # noqa: E501
        if (self._configuration.client_side_validation and
                max_health_multiplier_unhealthy is not None and max_health_multiplier_unhealthy < 0.1):  # noqa: E501
    ...
    def min_health_multiplier(self, min_health_multiplier):
        ...
        """
        if (self._configuration.client_side_validation and
                min_health_multiplier is not None and min_health_multiplier > 10000):  # noqa: E501
            raise ValueError("Invalid value for `min_health_multiplier`, must be a value less than or equal to `10000`")  # noqa: E501
        if (self._configuration.client_side_validation and
                min_health_multiplier is not None and min_health_multiplier < 0.1):  # noqa: E501
    ...
    def starting_health_multiplier(self, starting_health_multiplier):
        ...
        """
        if (self._configuration.client_side_validation and
                starting_health_multiplier is not None and starting_health_multiplier > 10000):  # noqa: E501
            raise ValueError("Invalid value for `starting_health_multiplier`, must be a value less than or equal to `10000`")  # noqa: E501
        if (self._configuration.client_side_validation and
                starting_health_multiplier is not None and starting_health_multiplier < 0.1):  # noqa: E501
            raise ValueError("Invalid value for `starting_health_multiplier`, must be a value greater than or equal to `0.1`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PerformanceSettingsSettingsCpuLimitUs, dict):

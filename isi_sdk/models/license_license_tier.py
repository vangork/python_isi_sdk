...
class LicenseLicenseTier(object):
    ...
    def __init__(self, entitlements_exceeded_alerts=None, licensed_drive_capacity=None, licensed_node_count=None, licensed_nodes_with_seds_count=None, platform=None, tier=None, used_drive_capacity=None, used_node_count=None, used_nodes_with_seds_count=None, _configuration=None):  # noqa: E501
    ...
    @property
    def platform(self):
        """Gets the platform of this LicenseLicenseTier.  # noqa: E501

        Platform  # noqa: E501

        :return: The platform of this LicenseLicenseTier.  # noqa: E501
        :rtype: str
        """
    ...
    def platform(self, platform):
        """Sets the platform of this LicenseLicenseTier.

        Platform  # noqa: E501

        :param platform: The platform of this LicenseLicenseTier.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
        ...
        if (self._configuration.client_side_validation and
                platform is not None and len(platform) < 0):
            raise ValueError("Invalid value for `platform`, length must be greater than or equal to `0`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LicenseLicenseTier, dict):

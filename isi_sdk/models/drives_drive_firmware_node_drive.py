...
class DrivesDriveFirmwareNodeDrive(object):
    ...
    def __init__(self, bay_group=None, baynum=None, current_firmware=None, desired_firmware=None, devname=None, lnum=None, locnstr=None, model=None, _configuration=None):  # noqa: E501
    ...
    @property
    def bay_group(self):
        """Gets the bay_group of this DrivesDriveFirmwareNodeDrive.  # noqa: E501

        This drive's sled letter in node.  # noqa: E501

        :return: The bay_group of this DrivesDriveFirmwareNodeDrive.  # noqa: E501
        :rtype: str
        """
    ...
    def bay_group(self, bay_group):
        """Sets the bay_group of this DrivesDriveFirmwareNodeDrive.

        This drive's sled letter in node.  # noqa: E501

        :param bay_group: The bay_group of this DrivesDriveFirmwareNodeDrive.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                bay_group is not None and len(bay_group) > 255):
            raise ValueError("Invalid value for `bay_group`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
    ...
    def current_firmware(self, current_firmware):
        ...
        """
        if (self._configuration.client_side_validation and
                current_firmware is not None and len(current_firmware) > 255):
            raise ValueError("Invalid value for `current_firmware`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                current_firmware is not None and len(current_firmware) < 0):
    ...
    def desired_firmware(self, desired_firmware):
        ...
        """
        if (self._configuration.client_side_validation and
                desired_firmware is not None and len(desired_firmware) > 255):
            raise ValueError("Invalid value for `desired_firmware`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                desired_firmware is not None and len(desired_firmware) < 0):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DrivesDriveFirmwareNodeDrive, dict):

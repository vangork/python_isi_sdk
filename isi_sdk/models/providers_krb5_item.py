...
class ProvidersKrb5Item(object):
    ...
    def __init__(self, groupnet=None, keytab_entries=None, keytab_file=None, manual_keying=None, name=None, password=None, realm=None, user=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProvidersKrb5Item, dict):

...
class PerformanceDataset(object):
    ...
    def __init__(self, name=None, _configuration=None):  # noqa: E501
        """PerformanceDataset - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this PerformanceDataset.  # noqa: E501
        ...
        :return: The name of this PerformanceDataset.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PerformanceDataset.

        The name of the performance dataset. If a name is not specified then a default name is assigned. The default name will be an underscore separated list of the performance metrics and filters used to configure the dataset.  # noqa: E501

        :param name: The name of this PerformanceDataset.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PerformanceDataset, dict):

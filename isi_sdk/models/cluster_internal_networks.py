...
class ClusterInternalNetworks(object):
    ...
    swagger_types = {
        ...
        'failover_status': 'str',
        'int_a_fabric': 'str',
        'int_a_ip_addresses': 'list[ClusterInternalNetworksIntAIpAddresse]',
        'int_a_mtu': 'int',
        'int_a_prefix_length': 'int',
        'int_a_status': 'str',
        'int_b_fabric': 'str',
        'int_b_ip_addresses': 'list[ClusterInternalNetworksIntBIpAddresse]',
        'int_b_mtu': 'int',
    ...
    def __init__(self, failover_ip_addresses=None, failover_status=None, int_a_fabric=None, int_a_ip_addresses=None, int_a_mtu=None, int_a_prefix_length=None, int_a_status=None, int_b_fabric=None, int_b_ip_addresses=None, int_b_mtu=None, int_b_prefix_length=None, _configuration=None):  # noqa: E501
    ...
    def failover_status(self, failover_status):
        ...
        if (self._configuration.client_side_validation and
                failover_status not in allowed_values):
            raise ValueError(
    ...
    def int_a_fabric(self, int_a_fabric):
        ...
        if (self._configuration.client_side_validation and
                int_a_fabric not in allowed_values):
            raise ValueError(
    ...
    def int_a_ip_addresses(self):
        ...
        :rtype: list[ClusterInternalNetworksIntAIpAddresse]
        """
    ...
    def int_a_ip_addresses(self, int_a_ip_addresses):
        ...
        :type: list[ClusterInternalNetworksIntAIpAddresse]
        """
    ...
    def int_a_mtu(self, int_a_mtu):
        ...
        """
        if (self._configuration.client_side_validation and
                int_a_mtu is not None and int_a_mtu > 65535):  # noqa: E501
            raise ValueError("Invalid value for `int_a_mtu`, must be a value less than or equal to `65535`")  # noqa: E501
        if (self._configuration.client_side_validation and
                int_a_mtu is not None and int_a_mtu < 1):  # noqa: E501
            raise ValueError("Invalid value for `int_a_mtu`, must be a value greater than or equal to `1`")  # noqa: E501
    ...
    def int_a_prefix_length(self, int_a_prefix_length):
        ...
        """
        if (self._configuration.client_side_validation and
                int_a_prefix_length is not None and int_a_prefix_length > 128):  # noqa: E501
            raise ValueError("Invalid value for `int_a_prefix_length`, must be a value less than or equal to `128`")  # noqa: E501
        if (self._configuration.client_side_validation and
                int_a_prefix_length is not None and int_a_prefix_length < 0):  # noqa: E501
    ...
    def int_a_status(self, int_a_status):
        ...
        allowed_values = ["enabled", "disabled"]  # noqa: E501
        if (self._configuration.client_side_validation and
                int_a_status not in allowed_values):
            raise ValueError(
    ...
    def int_b_fabric(self, int_b_fabric):
        ...
        allowed_values = ["Ethernet", "InfiniBand"]  # noqa: E501
        if (self._configuration.client_side_validation and
                int_b_fabric not in allowed_values):
            raise ValueError(
    ...
    def int_b_ip_addresses(self):
        ...
        :rtype: list[ClusterInternalNetworksIntBIpAddresse]
        """
    ...
    def int_b_ip_addresses(self, int_b_ip_addresses):
        ...
        :type: list[ClusterInternalNetworksIntBIpAddresse]
        """
    ...
    def int_b_prefix_length(self, int_b_prefix_length):
        ...
        """
        if (self._configuration.client_side_validation and
                int_b_prefix_length is not None and int_b_prefix_length > 128):  # noqa: E501
            raise ValueError("Invalid value for `int_b_prefix_length`, must be a value less than or equal to `128`")  # noqa: E501
        if (self._configuration.client_side_validation and
                int_b_prefix_length is not None and int_b_prefix_length < 0):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClusterInternalNetworks, dict):

...
class NetworkGroupnet(object):
    ...
    def __init__(self, allow_wildcard_subdomains=None, description=None, dns_cache_enabled=None, dns_options=None, dns_search=None, dns_servers=None, name=None, server_side_dns_search=None, _configuration=None):  # noqa: E501
    ...
    def allow_wildcard_subdomains(self):
        """Gets the allow_wildcard_subdomains of this NetworkGroupnet.  # noqa: E501
        ...
        :return: The allow_wildcard_subdomains of this NetworkGroupnet.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_wildcard_subdomains(self, allow_wildcard_subdomains):
        """Sets the allow_wildcard_subdomains of this NetworkGroupnet.

        If enabled, SmartConnect treats subdomains of known dns zones as the known dns zone. This is required for S3 Virtual Host domains. Defaults to True.  # noqa: E501

        :param allow_wildcard_subdomains: The allow_wildcard_subdomains of this NetworkGroupnet.  # noqa: E501
        :type: bool
        """
    ...
    def dns_options(self, dns_options):
        ...
        if (self._configuration.client_side_validation and
                not set(dns_options).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(

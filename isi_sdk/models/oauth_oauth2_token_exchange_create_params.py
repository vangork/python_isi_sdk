...
class OauthOauth2TokenExchangeCreateParams(object):
    ...
    def __init__(self, customer_client_id=None, customer_metadata_url=None, oauth2_client_id=None, _configuration=None):  # noqa: E501
        """OauthOauth2TokenExchangeCreateParams - a model defined in Swagger"""  # noqa: E501
    ...
    def customer_client_id(self):
        """Gets the customer_client_id of this OauthOauth2TokenExchangeCreateParams.  # noqa: E501
        ...
        :return: The customer_client_id of this OauthOauth2TokenExchangeCreateParams.  # noqa: E501
        :rtype: str
        """
    ...
    def customer_client_id(self, customer_client_id):
        """Sets the customer_client_id of this OauthOauth2TokenExchangeCreateParams.

        External client created by customer IdP for customer server application, this client generates the original token to be exchanged.  # noqa: E501

        :param customer_client_id: The customer_client_id of this OauthOauth2TokenExchangeCreateParams.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and customer_client_id is None:
            raise ValueError("Invalid value for `customer_client_id`, must not be `None`")  # noqa: E501
    ...
    def customer_metadata_url(self):
        """Gets the customer_metadata_url of this OauthOauth2TokenExchangeCreateParams.  # noqa: E501

        URL to query client token signing public key (or certificate).  # noqa: E501

        :return: The customer_metadata_url of this OauthOauth2TokenExchangeCreateParams.  # noqa: E501
        :rtype: str
        """
    ...
    def customer_metadata_url(self, customer_metadata_url):
        """Sets the customer_metadata_url of this OauthOauth2TokenExchangeCreateParams.

        URL to query client token signing public key (or certificate).  # noqa: E501

        :param customer_metadata_url: The customer_metadata_url of this OauthOauth2TokenExchangeCreateParams.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and customer_metadata_url is None:
            raise ValueError("Invalid value for `customer_metadata_url`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
    ...
    def oauth2_client_id(self):
        """Gets the oauth2_client_id of this OauthOauth2TokenExchangeCreateParams.  # noqa: E501

        Unique identifier of the OAuth2 client.  # noqa: E501

        :return: The oauth2_client_id of this OauthOauth2TokenExchangeCreateParams.  # noqa: E501
        :rtype: str
        """
    ...
    def oauth2_client_id(self, oauth2_client_id):
        """Sets the oauth2_client_id of this OauthOauth2TokenExchangeCreateParams.

        Unique identifier of the OAuth2 client.  # noqa: E501

        :param oauth2_client_id: The oauth2_client_id of this OauthOauth2TokenExchangeCreateParams.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and oauth2_client_id is None:
            raise ValueError("Invalid value for `oauth2_client_id`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OauthOauth2TokenExchangeCreateParams, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OauthOauth2TokenExchangeCreateParams):
            return False

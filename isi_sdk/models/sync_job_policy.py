...
class SyncJobPolicy(object):
    ...
    def __init__(self, action=None, file_matching_pattern=None, name=None, source_exclude_directories=None, source_include_directories=None, source_root_path=None, target_host=None, target_path=None, _configuration=None):  # noqa: E501
    ...
    def action(self):
        ...
        The action to be taken by the job.  # noqa: E501
    ...
    def source_root_path(self, source_root_path):
        ...
        if (self._configuration.client_side_validation and
                source_root_path is not None and len(source_root_path) < 0):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SyncJobPolicy, dict):

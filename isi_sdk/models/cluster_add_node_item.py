...
class ClusterAddNodeItem(object):
    ...
    def __init__(self, allow_down=None, _async=False, serial_number=None, skip_hardware_version_check=None, _configuration=None):  # noqa: E501
    ...
    def serial_number(self, serial_number):
        ...
        if (self._configuration.client_side_validation and
                serial_number is not None and len(serial_number) < 1):

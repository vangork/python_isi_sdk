...
class AvscanSettingsSettings(object):
    ...
    def __init__(self, ip_pool=None, report_expiry=None, scan_cloudpool_timeout=None, scan_size_maximum=None, scan_timeout=None, scan_zones=None, service_enabled=None, _configuration=None):  # noqa: E501
    ...
    def scan_cloudpool_timeout(self, scan_cloudpool_timeout):
        ...
        """
        if (self._configuration.client_side_validation and
                scan_cloudpool_timeout is not None and scan_cloudpool_timeout > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `scan_cloudpool_timeout`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                scan_cloudpool_timeout is not None and scan_cloudpool_timeout < 1):  # noqa: E501
    ...
    def scan_size_maximum(self, scan_size_maximum):
        ...
        """
        if (self._configuration.client_side_validation and
                scan_size_maximum is not None and scan_size_maximum > 17179869184):  # noqa: E501
    ...
    def scan_timeout(self, scan_timeout):
        ...
        """
        if (self._configuration.client_side_validation and
                scan_timeout is not None and scan_timeout > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `scan_timeout`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                scan_timeout is not None and scan_timeout < 1):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AvscanSettingsSettings, dict):

...
class ChangelistLins(object):
    ...
    def __init__(self, atime=None, ctime=None, id=None, mtime=None, path=None, size=None, type=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ChangelistLins, dict):

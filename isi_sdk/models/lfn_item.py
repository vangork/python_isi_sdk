...
class LfnItem(object):
    ...
    def __init__(self, path=None, _configuration=None):  # noqa: E501
        """LfnItem - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def path(self):
        """Gets the path of this LfnItem.  # noqa: E501


        :return: The path of this LfnItem.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this LfnItem.


        :param path: The path of this LfnItem.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LfnItem):
            return False

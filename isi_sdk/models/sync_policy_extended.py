...
class SyncPolicyExtended(object):
    ...
    def elliptic_curve_list(self):
        """Gets the elliptic_curve_list of this SyncPolicyExtended.  # noqa: E501
        ...
        :return: The elliptic_curve_list of this SyncPolicyExtended.  # noqa: E501
        :rtype: str
        """
    ...
    def elliptic_curve_list(self, elliptic_curve_list):
        """Sets the elliptic_curve_list of this SyncPolicyExtended.

        The elliptic curve list being used with encryption. For SyncIQ targets, this list serves as a list of supported elliptic curves. For SyncIQ sources, the list of elliptic curves will be attempted to be used in order.  # noqa: E501

        :param elliptic_curve_list: The elliptic_curve_list of this SyncPolicyExtended.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SyncPolicyExtended, dict):

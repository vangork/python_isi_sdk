...
class QuotaQuotaThresholds(object):
    ...
    def __init__(self, advisory=None, hard=None, percent_advisory=None, percent_soft=None, soft=None, soft_grace=None, _configuration=None):  # noqa: E501
    ...
    def percent_advisory(self, percent_advisory):
        ...
        """
        if (self._configuration.client_side_validation and
                percent_advisory is not None and percent_advisory > 99.99):  # noqa: E501
            raise ValueError("Invalid value for `percent_advisory`, must be a value less than or equal to `99.99`")  # noqa: E501
        if (self._configuration.client_side_validation and
                percent_advisory is not None and percent_advisory < 0.01):  # noqa: E501
    ...
    def percent_soft(self, percent_soft):
        ...
        """
        if (self._configuration.client_side_validation and
                percent_soft is not None and percent_soft > 99.99):  # noqa: E501
            raise ValueError("Invalid value for `percent_soft`, must be a value less than or equal to `99.99`")  # noqa: E501
        if (self._configuration.client_side_validation and
                percent_soft is not None and percent_soft < 0.01):  # noqa: E501
    ...
    def soft_grace(self, soft_grace):
        ...
        """
        if (self._configuration.client_side_validation and
                soft_grace is not None and soft_grace > 1073741823):  # noqa: E501
            raise ValueError("Invalid value for `soft_grace`, must be a value less than or equal to `1073741823`")  # noqa: E501
        if (self._configuration.client_side_validation and
                soft_grace is not None and soft_grace < 1):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(QuotaQuotaThresholds, dict):

...
class SettingsKrb5RealmsRealmItem(object):
    ...
    def __init__(self, admin_server=None, default_domain=None, id=None, is_default_realm=None, is_joined=None, kdc=None, realm=None, _configuration=None):  # noqa: E501
    ...
    def default_domain(self, default_domain):
        ...
        """
        if (self._configuration.client_side_validation and
                default_domain is not None and len(default_domain) > 255):
            raise ValueError("Invalid value for `default_domain`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                default_domain is not None and len(default_domain) < 0):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SettingsKrb5RealmsRealmItem, dict):

...
class GroupnetSubnet(object):
    ...
    def __init__(self, description=None, dsr_addrs=None, gateway=None, gateway_priority=None, mtu=None, name=None, prefixlen=None, sc_service_addrs=None, sc_service_name=None, vlan_enabled=None, vlan_id=None, _configuration=None):  # noqa: E501
    ...
    def gateway(self, gateway):
        ...
        """
        if (self._configuration.client_side_validation and
                gateway is not None and len(gateway) > 40):
    ...
    def gateway_priority(self, gateway_priority):
        ...
        """
        if (self._configuration.client_side_validation and
                gateway_priority is not None and gateway_priority > 2147483647):  # noqa: E501
            raise ValueError("Invalid value for `gateway_priority`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self._configuration.client_side_validation and
                gateway_priority is not None and gateway_priority < 1):  # noqa: E501
    ...
    def mtu(self, mtu):
        ...
        if (self._configuration.client_side_validation and
                mtu is not None and mtu < 576):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GroupnetSubnet, dict):

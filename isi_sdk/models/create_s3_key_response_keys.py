...
class CreateS3KeyResponseKeys(object):
    ...
    def __init__(self, access_id=None, old_key_expiry=None, old_key_timestamp=None, old_secret_key=None, secret_key=None, secret_key_timestamp=None, _configuration=None):  # noqa: E501
    ...
    def old_secret_key(self, old_secret_key):
        ...
        """
        if (self._configuration.client_side_validation and
                old_secret_key is not None and len(old_secret_key) > 255):
            raise ValueError("Invalid value for `old_secret_key`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                old_secret_key is not None and len(old_secret_key) < 1):
    ...
    def secret_key(self, secret_key):
        ...
        """
        if (self._configuration.client_side_validation and
                secret_key is not None and len(secret_key) > 255):

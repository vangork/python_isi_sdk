...
class S3SettingsZoneSettings(object):
    ...
    def __init__(self, base_domain=None, bucket_directory_create_mode=None, object_acl_policy=None, root_path=None, use_md5_for_etag=None, validate_content_md5=None, _configuration=None):  # noqa: E501
    ...
    def base_domain(self, base_domain):
        ...
        if (self._configuration.client_side_validation and
                base_domain is not None and len(base_domain) > 255):
            raise ValueError("Invalid value for `base_domain`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                base_domain is not None and len(base_domain) < 0):
            raise ValueError("Invalid value for `base_domain`, length must be greater than or equal to `0`")  # noqa: E501
        if (self._configuration.client_side_validation and
                base_domain is not None and not re.search(r'^$|^((([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])(\\.([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])*)$', base_domain)):  # noqa: E501
    ...
    def bucket_directory_create_mode(self, bucket_directory_create_mode):
        ...
        """
        if (self._configuration.client_side_validation and
                bucket_directory_create_mode is not None and bucket_directory_create_mode > 511):  # noqa: E501
            raise ValueError("Invalid value for `bucket_directory_create_mode`, must be a value less than or equal to `511`")  # noqa: E501
        if (self._configuration.client_side_validation and
                bucket_directory_create_mode is not None and bucket_directory_create_mode < 0):  # noqa: E501

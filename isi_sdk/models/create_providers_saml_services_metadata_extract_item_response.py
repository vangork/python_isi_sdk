...
class CreateProvidersSamlServicesMetadataExtractItemResponse(object):
    ...
    def __init__(self, entity_id=None, login_endpoints=None, logout_endpoints=None, signing_certificates=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateProvidersSamlServicesMetadataExtractItemResponse, dict):

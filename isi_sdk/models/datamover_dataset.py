...
class DatamoverDataset(object):
    ...
    def __init__(self, dataset_base_path=None, dataset_creation_time=None, dataset_expiry_action=None, dataset_global_id=None, dataset_retention_period=None, dataset_state=None, dataset_subpaths=None, dataset_type=None, dataset_version=None, id=None, snapshot_path=None, _configuration=None):  # noqa: E501
    ...
    def dataset_version(self):
        """Gets the dataset_version of this DatamoverDataset.  # noqa: E501

        The version of dataset.  # noqa: E501

        :return: The dataset_version of this DatamoverDataset.  # noqa: E501
        :rtype: str
        """
    ...
    def dataset_version(self, dataset_version):
        """Sets the dataset_version of this DatamoverDataset.

        The version of dataset.  # noqa: E501

        :param dataset_version: The dataset_version of this DatamoverDataset.  # noqa: E501
        :type: str
        """
    ...
    def snapshot_path(self, snapshot_path):
        ...
        """
        if (self._configuration.client_side_validation and
                snapshot_path is not None and len(snapshot_path) > 4096):
            raise ValueError("Invalid value for `snapshot_path`, length must be less than or equal to `4096`")  # noqa: E501
        if (self._configuration.client_side_validation and
                snapshot_path is not None and len(snapshot_path) < 0):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DatamoverDataset, dict):

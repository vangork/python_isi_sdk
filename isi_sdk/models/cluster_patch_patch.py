...
class ClusterPatchPatch(object):
    ...
    def __init__(self, location=None, patch=None, process_type=None, _configuration=None):  # noqa: E501
    ...
    def location(self, location):
        ...
        if (self._configuration.client_side_validation and
                location is not None and len(location) > 4096):

...
class HttpSettingsSettings(object):
    ...
    def httpd_controlpath_redirect(self):
        """Gets the httpd_controlpath_redirect of this HttpSettingsSettings.  # noqa: E501

        Enable or disable WebUI redirect to HTTP service.  # noqa: E501

        :return: The httpd_controlpath_redirect of this HttpSettingsSettings.  # noqa: E501
        :rtype: bool
        """
    ...
    def httpd_controlpath_redirect(self, httpd_controlpath_redirect):
        """Sets the httpd_controlpath_redirect of this HttpSettingsSettings.

        Enable or disable WebUI redirect to HTTP service.  # noqa: E501

        :param httpd_controlpath_redirect: The httpd_controlpath_redirect of this HttpSettingsSettings.  # noqa: E501
        :type: bool
        """
    ...
    def inactive_timeout(self):
        """Gets the inactive_timeout of this HttpSettingsSettings.  # noqa: E501

        Get the HTTP Session inactivity timeout (in seconds).  # noqa: E501

        :return: The inactive_timeout of this HttpSettingsSettings.  # noqa: E501
        :rtype: int
        """
    ...
    def inactive_timeout(self, inactive_timeout):
        """Sets the inactive_timeout of this HttpSettingsSettings.

        Get the HTTP Session inactivity timeout (in seconds).  # noqa: E501

        :param inactive_timeout: The inactive_timeout of this HttpSettingsSettings.  # noqa: E501
        :type: int
        """
        if self._configuration.client_side_validation and inactive_timeout is None:
            raise ValueError("Invalid value for `inactive_timeout`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                inactive_timeout is not None and inactive_timeout > 31536000):  # noqa: E501
            raise ValueError("Invalid value for `inactive_timeout`, must be a value less than or equal to `31536000`")  # noqa: E501
        if (self._configuration.client_side_validation and
                inactive_timeout is not None and inactive_timeout < 0):  # noqa: E501
    ...
    def service_timeout(self):
        """Gets the service_timeout of this HttpSettingsSettings.  # noqa: E501

        Get the HTTP Timeout directive from Apache. Value 0 means service timeout is disabled.  # noqa: E501

        :return: The service_timeout of this HttpSettingsSettings.  # noqa: E501
        :rtype: int
        """
    ...
    def service_timeout(self, service_timeout):
        """Sets the service_timeout of this HttpSettingsSettings.

        Get the HTTP Timeout directive from Apache. Value 0 means service timeout is disabled.  # noqa: E501

        :param service_timeout: The service_timeout of this HttpSettingsSettings.  # noqa: E501
        :type: int
        """
        if self._configuration.client_side_validation and service_timeout is None:
            raise ValueError("Invalid value for `service_timeout`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                service_timeout is not None and service_timeout > 2147483647):  # noqa: E501
            raise ValueError("Invalid value for `service_timeout`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self._configuration.client_side_validation and
                service_timeout is not None and service_timeout < 0):  # noqa: E501
    ...
    def session_max_age(self):
        """Gets the session_max_age of this HttpSettingsSettings.  # noqa: E501

        Get the HTTP Session absolute timeout (in seconds).  # noqa: E501

        :return: The session_max_age of this HttpSettingsSettings.  # noqa: E501
        :rtype: int
        """
    ...
    def session_max_age(self, session_max_age):
        """Sets the session_max_age of this HttpSettingsSettings.

        Get the HTTP Session absolute timeout (in seconds).  # noqa: E501

        :param session_max_age: The session_max_age of this HttpSettingsSettings.  # noqa: E501
        :type: int
        """
        if self._configuration.client_side_validation and session_max_age is None:
            raise ValueError("Invalid value for `session_max_age`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                session_max_age is not None and session_max_age > 31536000):  # noqa: E501
            raise ValueError("Invalid value for `session_max_age`, must be a value less than or equal to `31536000`")  # noqa: E501
        if (self._configuration.client_side_validation and
                session_max_age is not None and session_max_age < 60):  # noqa: E501
    ...
    def webhdfs_ran_https_port(self):
        """Gets the webhdfs_ran_https_port of this HttpSettingsSettings.  # noqa: E501

        Configure Data Services Port for HTTP service.  # noqa: E501

        :return: The webhdfs_ran_https_port of this HttpSettingsSettings.  # noqa: E501
        :rtype: int
        """
    ...
    def webhdfs_ran_https_port(self, webhdfs_ran_https_port):
        """Sets the webhdfs_ran_https_port of this HttpSettingsSettings.

        Configure Data Services Port for HTTP service.  # noqa: E501

        :param webhdfs_ran_https_port: The webhdfs_ran_https_port of this HttpSettingsSettings.  # noqa: E501
        :type: int
        """
        if self._configuration.client_side_validation and webhdfs_ran_https_port is None:
            raise ValueError("Invalid value for `webhdfs_ran_https_port`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                webhdfs_ran_https_port is not None and webhdfs_ran_https_port > 65535):  # noqa: E501
            raise ValueError("Invalid value for `webhdfs_ran_https_port`, must be a value less than or equal to `65535`")  # noqa: E501
        if (self._configuration.client_side_validation and
                webhdfs_ran_https_port is not None and webhdfs_ran_https_port < 1025):  # noqa: E501

...
class SupportassistPayloadItem(object):
    ...
    def __init__(self, payload_type=None, payload_version='1.0', sub_type=None, timestamp='<ISO 8601 UTC format>', _configuration=None):  # noqa: E501
    ...
    def payload_type(self, payload_type):
        ...
        if (self._configuration.client_side_validation and
                payload_type not in allowed_values):
            raise ValueError(
    ...
    def payload_version(self, payload_version):
        ...
        """
        if (self._configuration.client_side_validation and
                payload_version is not None and len(payload_version) > 255):
            raise ValueError("Invalid value for `payload_version`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                payload_version is not None and len(payload_version) < 1):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SupportassistPayloadItem, dict):

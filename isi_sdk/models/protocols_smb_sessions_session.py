...
class ProtocolsSmbSessionsSession(object):
    ...
    def __init__(self, active_time=None, client_type=None, computer=None, encryption=None, guest_login=None, id=None, idle_time=None, openfiles=None, user=None, _configuration=None):  # noqa: E501
    ...
    def guest_login(self, guest_login):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and guest_login is None:

...
class CreateProvidersSamlServicesMetadataExtractItemResponseSigningCertificate(object):
    ...
    def __init__(self, fingerprints=None, issuer=None, not_after=None, not_before=None, status=None, subject=None, value=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateProvidersSamlServicesMetadataExtractItemResponseSigningCertificate, dict):

...
class SupportassistSettings(object):
    ...
    def __init__(self, automatic_case_creation=True, connection=None, connection_state=None, contact=None, enable_download=True, enable_remote_support=False, onefs_software_id=None, supportassist_enabled=None, telemetry=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SupportassistSettings, dict):

...
class SupportassistSettingsContactPrimary(object):
    ...
    def __init__(self, email='', first_name='', last_name='', phone='', _configuration=None):  # noqa: E501
    ...
    def last_name(self, last_name):
        ...
        if (self._configuration.client_side_validation and
                last_name is not None and not re.search(r'[a-zA-Z]*[\\-\\.\\\']*', last_name)):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SupportassistSettingsContactPrimary, dict):

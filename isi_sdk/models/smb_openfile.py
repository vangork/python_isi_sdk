...
class SmbOpenfile(object):
    ...
    def __init__(self, file=None, id=None, locks=None, permissions=None, user=None, _configuration=None):  # noqa: E501
    ...
    def locks(self, locks):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and locks is None:

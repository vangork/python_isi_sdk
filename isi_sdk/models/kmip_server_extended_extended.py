...
class KmipServerExtendedExtended(object):
    ...
    """
    swagger_types = {
        'ca_chain': 'list[KmipServerCaChainItem]',
    ...
    def __init__(self, ca_chain=None, client_cert=None, connection_timeout=None, host=None, id=None, minimum_tls_version=None, port=None, retry_timeout=None, tls_ciphers=None, _configuration=None):  # noqa: E501
    ...
    @property
    def ca_chain(self):
        """Gets the ca_chain of this KmipServerExtendedExtended.  # noqa: E501

        CA certificate chain.  # noqa: E501

        :return: The ca_chain of this KmipServerExtendedExtended.  # noqa: E501
        :rtype: list[KmipServerCaChainItem]
        """
        return self._ca_chain

    @ca_chain.setter
    def ca_chain(self, ca_chain):
        """Sets the ca_chain of this KmipServerExtendedExtended.

        CA certificate chain.  # noqa: E501

        :param ca_chain: The ca_chain of this KmipServerExtendedExtended.  # noqa: E501
        :type: list[KmipServerCaChainItem]
        """
        if self._configuration.client_side_validation and ca_chain is None:
            raise ValueError("Invalid value for `ca_chain`, must not be `None`")  # noqa: E501
    ...
    def client_cert(self, client_cert):
        ...
        """
        if self._configuration.client_side_validation and client_cert is None:
    ...
    def connection_timeout(self, connection_timeout):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and connection_timeout is None:
    ...
    def minimum_tls_version(self, minimum_tls_version):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and minimum_tls_version is None:
    ...
    def retry_timeout(self, retry_timeout):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and retry_timeout is None:
    ...
    def tls_ciphers(self):
        """Gets the tls_ciphers of this KmipServerExtendedExtended.  # noqa: E501

        TLS cipher suite to use for communication with the KMIP server.  # noqa: E501

        :return: The tls_ciphers of this KmipServerExtendedExtended.  # noqa: E501
        :rtype: str
        """
    ...
    def tls_ciphers(self, tls_ciphers):
        """Sets the tls_ciphers of this KmipServerExtendedExtended.

        TLS cipher suite to use for communication with the KMIP server.  # noqa: E501

        :param tls_ciphers: The tls_ciphers of this KmipServerExtendedExtended.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and tls_ciphers is None:
            raise ValueError("Invalid value for `tls_ciphers`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(KmipServerExtendedExtended, dict):

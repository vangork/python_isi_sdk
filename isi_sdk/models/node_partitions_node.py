...
class NodePartitionsNode(object):
    ...
    def __init__(self, count=None, error=None, id=None, lnn=None, partitions=None, status=None, _configuration=None):  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this NodePartitionsNode.  # noqa: E501

        Error message, if the HTTP status returned from this node was not 200.  # noqa: E501

        :return: The error of this NodePartitionsNode.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        ...
        :param error: The error of this NodePartitionsNode.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def status(self):
        """Gets the status of this NodePartitionsNode.  # noqa: E501

        Status of the HTTP response from this node if not 200.  If 200, this field does not appear.  # noqa: E501

        :return: The status of this NodePartitionsNode.  # noqa: E501
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this NodePartitionsNode.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NodePartitionsNode, dict):

...
class NetworkInterfaceOwner(object):
    ...
    def __init__(self, access_zone=None, groupnet=None, id=None, ip_addrs=None, pool=None, prefixlen=None, subnet=None, subtype=None, type=None, vlan_id=None, _configuration=None):  # noqa: E501
    ...
    def access_zone(self, access_zone):
        ...
        if (self._configuration.client_side_validation and
                access_zone is not None and len(access_zone) < 0):
    ...
    def pool(self, pool):
        ...
        """
        if (self._configuration.client_side_validation and
                pool is not None and len(pool) > 32):
    ...
    @property
    def prefixlen(self):
        """Gets the prefixlen of this NetworkInterfaceOwner.  # noqa: E501

        Prefix length of the subnet this owner belongs to.  # noqa: E501

        :return: The prefixlen of this NetworkInterfaceOwner.  # noqa: E501
        :rtype: int
        """
    ...
    def prefixlen(self, prefixlen):
        """Sets the prefixlen of this NetworkInterfaceOwner.

        Prefix length of the subnet this owner belongs to.  # noqa: E501

        :param prefixlen: The prefixlen of this NetworkInterfaceOwner.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
        ...
        if (self._configuration.client_side_validation and
                prefixlen is not None and prefixlen < 0):  # noqa: E501
    ...
    @property
    def subtype(self):
        """Gets the subtype of this NetworkInterfaceOwner.  # noqa: E501

        Name of the system allocating the IPs for this Network Pool.  # noqa: E501

        :return: The subtype of this NetworkInterfaceOwner.  # noqa: E501
        :rtype: str
        """
    ...
    def subtype(self, subtype):
        """Sets the subtype of this NetworkInterfaceOwner.

        Name of the system allocating the IPs for this Network Pool.  # noqa: E501

        :param subtype: The subtype of this NetworkInterfaceOwner.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                subtype is not None and len(subtype) > 128):
            raise ValueError("Invalid value for `subtype`, length must be less than or equal to `128`")  # noqa: E501
        if (self._configuration.client_side_validation and
                subtype is not None and len(subtype) < 0):
            raise ValueError("Invalid value for `subtype`, length must be greater than or equal to `0`")  # noqa: E501
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["static", "dynamic", "smartconnect_service", "ipv6_link_local", "internal", "externally_managed"]  # noqa: E501
        if (self._configuration.client_side_validation and

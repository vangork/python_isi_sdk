...
class ProvidersSamlServicesMetadataExtractItem(object):
    ...
    def __init__(self, entity_id=None, metadata=None, metadata_location=None, _configuration=None):  # noqa: E501
    ...
    def entity_id(self, entity_id):
        ...
        if (self._configuration.client_side_validation and
                entity_id is not None and len(entity_id) < 1):
    ...
    def metadata_location(self, metadata_location):
        ...
        """
        if (self._configuration.client_side_validation and
                metadata_location is not None and len(metadata_location) > 4096):
            raise ValueError("Invalid value for `metadata_location`, length must be less than or equal to `4096`")  # noqa: E501
        if (self._configuration.client_side_validation and
                metadata_location is not None and len(metadata_location) < 2):

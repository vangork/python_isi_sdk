...
class ClusterFirmwareAssessItem(object):
    ...
    def __init__(self, exclude_device=None, exclude_type=None, fw_pkg=None, fw_pkg_id=None, include_device=None, include_type=None, _configuration=None):  # noqa: E501
    ...
    @property
    def fw_pkg_id(self):
        """Gets the fw_pkg_id of this ClusterFirmwareAssessItem.  # noqa: E501

        The ID of the signed artifact stored in the catalog.  # noqa: E501

        :return: The fw_pkg_id of this ClusterFirmwareAssessItem.  # noqa: E501
        :rtype: str
        """
    ...
    def fw_pkg_id(self, fw_pkg_id):
        """Sets the fw_pkg_id of this ClusterFirmwareAssessItem.

        The ID of the signed artifact stored in the catalog.  # noqa: E501

        :param fw_pkg_id: The fw_pkg_id of this ClusterFirmwareAssessItem.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and

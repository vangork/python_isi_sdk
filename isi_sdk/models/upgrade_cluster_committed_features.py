...
class UpgradeClusterCommittedFeatures(object):
    ...
    def __init__(self, default_gen=None, gen_bits=None, _configuration=None):  # noqa: E501
    ...
    def default_gen(self, default_gen):
        ...
        if (self._configuration.client_side_validation and
                default_gen is not None and default_gen > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `default_gen`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                default_gen is not None and default_gen < 0):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpgradeClusterCommittedFeatures, dict):

...
class ClusterEmailExtended(object):
    ...
    def __init__(self, batch_mode=None, mail_relay=None, mail_sender=None, mail_subject=None, smtp_auth_passwd=None, smtp_auth_security=None, smtp_auth_username=None, smtp_port=None, use_smtp_auth=None, user_template=None, _configuration=None):  # noqa: E501
    ...
    def mail_sender(self, mail_sender):
        ...
        if (self._configuration.client_side_validation and
                mail_sender is not None and len(mail_sender) < 3):
            raise ValueError("Invalid value for `mail_sender`, length must be greater than or equal to `3`")  # noqa: E501
        if (self._configuration.client_side_validation and
                mail_sender is not None and not re.search(r'[a-zA-Z0-9!#%&\'*+= ^_`{|}~\/?$.-]{1,64}@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,63}', mail_sender)):  # noqa: E501
    ...
    def smtp_auth_username(self, smtp_auth_username):
        ...
        if (self._configuration.client_side_validation and
                smtp_auth_username is not None and len(smtp_auth_username) < 1):
            raise ValueError("Invalid value for `smtp_auth_username`, length must be greater than or equal to `1`")  # noqa: E501
        if (self._configuration.client_side_validation and
                smtp_auth_username is not None and not re.search(r'^[^]\"\/\\[\\:;|=,+*?<>$]+', smtp_auth_username)):  # noqa: E501
    ...
    def user_template(self, user_template):
        ...
        """
        if (self._configuration.client_side_validation and
                user_template is not None and not re.search(r'^\/ifs$|^\/ifs\/', user_template)):  # noqa: E501

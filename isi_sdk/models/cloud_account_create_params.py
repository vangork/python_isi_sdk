...
class CloudAccountCreateParams(object):
    ...
    def __init__(self, account_id=None, account_username=None, birth_cluster_id=None, credential_provider=None, enable_ocsp=None, enabled=None, key=None, maximum_capacity=None, name=None, ocsp_responder_url_required=None, proxy=None, skip_ssl_validation=None, storage_region=None, telemetry_bucket=None, type=None, uri=None, _configuration=None):  # noqa: E501
    ...
    def account_username(self, account_username):
        ...
        if (self._configuration.client_side_validation and
                account_username is not None and len(account_username) > 256):
            raise ValueError("Invalid value for `account_username`, length must be less than or equal to `256`")  # noqa: E501
        if (self._configuration.client_side_validation and
                account_username is not None and len(account_username) < 0):
    ...
    def maximum_capacity(self):
        """Gets the maximum_capacity of this CloudAccountCreateParams.  # noqa: E501

        The maximum capacity of this account in bytes (value is not used to limit capacity, if not user defined, it is set to 1099511627776 in case of MS Azure cloud provider and to 0 in case of other cloud providers)  # noqa: E501

        :return: The maximum_capacity of this CloudAccountCreateParams.  # noqa: E501
        :rtype: int
        """
    ...
    def maximum_capacity(self, maximum_capacity):
        """Sets the maximum_capacity of this CloudAccountCreateParams.

        The maximum capacity of this account in bytes (value is not used to limit capacity, if not user defined, it is set to 1099511627776 in case of MS Azure cloud provider and to 0 in case of other cloud providers)  # noqa: E501

        :param maximum_capacity: The maximum_capacity of this CloudAccountCreateParams.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                maximum_capacity is not None and maximum_capacity > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `maximum_capacity`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                maximum_capacity is not None and maximum_capacity < 0):  # noqa: E501
            raise ValueError("Invalid value for `maximum_capacity`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def telemetry_bucket(self, telemetry_bucket):
        ...
        """
        if (self._configuration.client_side_validation and
                telemetry_bucket is not None and len(telemetry_bucket) > 255):
            raise ValueError("Invalid value for `telemetry_bucket`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                telemetry_bucket is not None and len(telemetry_bucket) < 0):

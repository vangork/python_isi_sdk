...
class EventEventlist(object):
    ...
    def __init__(self, event_count=None, eventgroup_instance=None, events=None, id=None, _configuration=None):  # noqa: E501
    ...
    def event_count(self, event_count):
        ...
        if (self._configuration.client_side_validation and
                event_count is not None and event_count > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `event_count`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                event_count is not None and event_count < 1):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EventEventlist, dict):

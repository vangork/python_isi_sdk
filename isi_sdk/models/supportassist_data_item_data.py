...
class SupportassistDataItemData(object):
    ...
    def __init__(self, message=None, operation=None, sent_transaction_id=None, status=None, transaction_id=None, _configuration=None):  # noqa: E501
    ...
    def operation(self, operation):
        ...
        if (self._configuration.client_side_validation and
                operation is not None and len(operation) > 255):
    ...
    def sent_transaction_id(self, sent_transaction_id):
        ...
        """
        if (self._configuration.client_side_validation and
                sent_transaction_id is not None and len(sent_transaction_id) > 255):
            raise ValueError("Invalid value for `sent_transaction_id`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                sent_transaction_id is not None and len(sent_transaction_id) < 1):
    ...
    def transaction_id(self):
        ...
        Payload's transaction ID - matches `x-dell-ese-trans-id` of the response header returned from Product -> ESE /Payload request.  # noqa: E501

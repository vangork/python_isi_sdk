...
class SummaryDriveDriveItem(object):
    ...
    def __init__(self, access_latency=None, access_slow=None, busy=None, bytes_in=None, bytes_out=None, drive_id=None, iosched_latency=None, iosched_queue=None, time=None, type=None, used_bytes_percent=None, used_inodes=None, xfer_size_in=None, xfer_size_out=None, xfers_in=None, xfers_out=None, _configuration=None):  # noqa: E501
    ...
    def access_latency(self, access_latency):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and access_latency is None:
    ...
    def access_slow(self, access_slow):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and access_slow is None:
    ...
    def busy(self, busy):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and busy is None:
    ...
    def drive_id(self, drive_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and drive_id is None:
    ...
    def iosched_latency(self, iosched_latency):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and iosched_latency is None:
    ...
    def iosched_queue(self, iosched_queue):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and iosched_queue is None:
    ...
    def used_bytes_percent(self, used_bytes_percent):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and used_bytes_percent is None:
    ...
    def used_inodes(self, used_inodes):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and used_inodes is None:
    ...
    def xfer_size_in(self, xfer_size_in):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and xfer_size_in is None:
    ...
    def xfer_size_out(self, xfer_size_out):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and xfer_size_out is None:
    ...
    def xfers_in(self, xfers_in):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and xfers_in is None:
    ...
    def xfers_out(self, xfers_out):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and xfers_out is None:

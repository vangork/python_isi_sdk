...
class EventEventlistEvent(object):
    ...
    def __init__(self, devid=None, ended=None, event=None, id=None, lnn=None, message=None, resolve_time=None, severity=None, specifier=None, time=None, value=None, _configuration=None):  # noqa: E501
    ...
    def lnn(self, lnn):
        ...
        """
        if (self._configuration.client_side_validation and
                lnn is not None and lnn > 65435):  # noqa: E501
    ...
    def value(self, value):
        ...
        """
        if (self._configuration.client_side_validation and
                value is not None and value > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `value`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                value is not None and value < -9223372036854775808):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EventEventlistEvent, dict):

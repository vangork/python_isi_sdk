...
class SummaryHeatHeatItem(object):
    ...
    def __init__(self, class_name=None, event_name=None, event_type=None, lin=None, node=None, operation_rate=None, path=None, time=None, _configuration=None):  # noqa: E501
    ...
    def event_name(self, event_name):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and event_name is None:

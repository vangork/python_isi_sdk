...
class ProvidersFileIdParams(object):
    ...
    def __init__(self, authentication=None, create_home_directory=None, delete_password_hashes=None, enabled=None, enumerate_groups=None, enumerate_users=None, findable_groups=None, findable_users=None, group_domain=None, group_file=None, home_directory_template=None, listable_groups=None, listable_users=None, login_shell=None, modifiable_groups=None, modifiable_users=None, name=None, netgroup_file=None, normalize_groups=None, normalize_users=None, ntlm_support=None, password_file=None, password_hash_type=None, provider_domain=None, restrict_findable=None, restrict_listable=None, restrict_modifiable=None, unfindable_groups=None, unfindable_users=None, unlistable_groups=None, unlistable_users=None, unmodifiable_groups=None, unmodifiable_users=None, user_domain=None, _configuration=None):  # noqa: E501
    ...
    def delete_password_hashes(self):
        """Gets the delete_password_hashes of this ProvidersFileIdParams.  # noqa: E501

        Delete all password hashes that do not match Password Hash Type and force password change at next login.  # noqa: E501

        :return: The delete_password_hashes of this ProvidersFileIdParams.  # noqa: E501
        :rtype: bool
        """
    ...
    def delete_password_hashes(self, delete_password_hashes):
        """Sets the delete_password_hashes of this ProvidersFileIdParams.

        Delete all password hashes that do not match Password Hash Type and force password change at next login.  # noqa: E501

        :param delete_password_hashes: The delete_password_hashes of this ProvidersFileIdParams.  # noqa: E501
        :type: bool
        """
    ...
    def netgroup_file(self, netgroup_file):
        ...
        """
        if (self._configuration.client_side_validation and
                netgroup_file is not None and len(netgroup_file) > 4096):
            raise ValueError("Invalid value for `netgroup_file`, length must be less than or equal to `4096`")  # noqa: E501
        if (self._configuration.client_side_validation and
                netgroup_file is not None and len(netgroup_file) < 0):
    ...
    def password_file(self, password_file):
        ...
        """
        if (self._configuration.client_side_validation and
                password_file is not None and len(password_file) > 4096):
            raise ValueError("Invalid value for `password_file`, length must be less than or equal to `4096`")  # noqa: E501
        if (self._configuration.client_side_validation and
                password_file is not None and len(password_file) < 0):
    ...
    def password_hash_type(self):
        """Gets the password_hash_type of this ProvidersFileIdParams.  # noqa: E501

        Specifies the password hash algorithm to use.  # noqa: E501

        :return: The password_hash_type of this ProvidersFileIdParams.  # noqa: E501
        :rtype: str
        """
    ...
    def password_hash_type(self, password_hash_type):
        """Sets the password_hash_type of this ProvidersFileIdParams.

        Specifies the password hash algorithm to use.  # noqa: E501

        :param password_hash_type: The password_hash_type of this ProvidersFileIdParams.  # noqa: E501
        :type: str
        """

...
class HdfsInotifyStreamStream(object):
    ...
    def __init__(self, current_transaction_id=None, sync_transaction_id=None, _configuration=None):  # noqa: E501
    ...
    def current_transaction_id(self, current_transaction_id):
        ...
        if (self._configuration.client_side_validation and
                current_transaction_id is not None and current_transaction_id > 2147483647):  # noqa: E501
            raise ValueError("Invalid value for `current_transaction_id`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self._configuration.client_side_validation and
                current_transaction_id is not None and current_transaction_id < 0):  # noqa: E501
    ...
    def sync_transaction_id(self, sync_transaction_id):
        ...
        """
        if (self._configuration.client_side_validation and
                sync_transaction_id is not None and sync_transaction_id > 2147483647):  # noqa: E501
            raise ValueError("Invalid value for `sync_transaction_id`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self._configuration.client_side_validation and
                sync_transaction_id is not None and sync_transaction_id < 0):  # noqa: E501

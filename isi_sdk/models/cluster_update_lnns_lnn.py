...
class ClusterUpdateLnnsLnn(object):
    ...
    def __init__(self, current_lnn=None, new_lnn=None, _configuration=None):  # noqa: E501
    ...
    def current_lnn(self, current_lnn):
        ...
        if (self._configuration.client_side_validation and
                current_lnn is not None and current_lnn > 65535):  # noqa: E501
            raise ValueError("Invalid value for `current_lnn`, must be a value less than or equal to `65535`")  # noqa: E501
        if (self._configuration.client_side_validation and
                current_lnn is not None and current_lnn < 1):  # noqa: E501

...
class DatamoverDatasetExtended(object):
    ...
    def __init__(self, dataset_base_path=None, dataset_creation_time=None, dataset_expiry_action=None, dataset_global_id=None, dataset_retention_period=None, dataset_state=None, dataset_subpaths=None, dataset_type=None, dataset_version=None, id=None, _configuration=None):  # noqa: E501
        """DatamoverDatasetExtended - a model defined in Swagger"""  # noqa: E501
    ...
    def dataset_base_path(self):
        """Gets the dataset_base_path of this DatamoverDatasetExtended.  # noqa: E501


        :return: The dataset_base_path of this DatamoverDatasetExtended.  # noqa: E501
        :rtype: str
        """
    ...
    def dataset_base_path(self, dataset_base_path):
        """Sets the dataset_base_path of this DatamoverDatasetExtended.


        :param dataset_base_path: The dataset_base_path of this DatamoverDatasetExtended.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                dataset_base_path is not None and len(dataset_base_path) > 4096):
            raise ValueError("Invalid value for `dataset_base_path`, length must be less than or equal to `4096`")  # noqa: E501
        if (self._configuration.client_side_validation and
                dataset_base_path is not None and len(dataset_base_path) < 1):
    ...
    def dataset_creation_time(self):
        """Gets the dataset_creation_time of this DatamoverDatasetExtended.  # noqa: E501

        The time when the dataset is created. The time in seconds past the epoch  # noqa: E501

        :return: The dataset_creation_time of this DatamoverDatasetExtended.  # noqa: E501
        :rtype: int
        """
    ...
    def dataset_creation_time(self, dataset_creation_time):
        """Sets the dataset_creation_time of this DatamoverDatasetExtended.

        The time when the dataset is created. The time in seconds past the epoch  # noqa: E501

        :param dataset_creation_time: The dataset_creation_time of this DatamoverDatasetExtended.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                dataset_creation_time is not None and dataset_creation_time > 9223372036854775807):  # noqa: E501
        ...
        if (self._configuration.client_side_validation and
                dataset_creation_time is not None and dataset_creation_time < 1):  # noqa: E501
    ...
    def dataset_expiry_action(self):
        """Gets the dataset_expiry_action of this DatamoverDatasetExtended.  # noqa: E501

        The action to be taken after dataset expiry.  # noqa: E501

        :return: The dataset_expiry_action of this DatamoverDatasetExtended.  # noqa: E501
        :rtype: str
        """
    ...
    def dataset_expiry_action(self, dataset_expiry_action):
        """Sets the dataset_expiry_action of this DatamoverDatasetExtended.

        The action to be taken after dataset expiry.  # noqa: E501

        :param dataset_expiry_action: The dataset_expiry_action of this DatamoverDatasetExtended.  # noqa: E501
        :type: str
        """
        allowed_values = ["DELETE"]  # noqa: E501
        if (self._configuration.client_side_validation and
                dataset_expiry_action not in allowed_values):
            raise ValueError(
    ...
    def dataset_global_id(self):
        """Gets the dataset_global_id of this DatamoverDatasetExtended.  # noqa: E501

        The globally unique identifier of dataset.  # noqa: E501

        :return: The dataset_global_id of this DatamoverDatasetExtended.  # noqa: E501
    ...
    def dataset_global_id(self, dataset_global_id):
        """Sets the dataset_global_id of this DatamoverDatasetExtended.

        The globally unique identifier of dataset.  # noqa: E501

        :param dataset_global_id: The dataset_global_id of this DatamoverDatasetExtended.  # noqa: E501
    ...
    def dataset_retention_period(self):
        """Gets the dataset_retention_period of this DatamoverDatasetExtended.  # noqa: E501
        ...
        :return: The dataset_retention_period of this DatamoverDatasetExtended.  # noqa: E501
        :rtype: int
        """
    ...
    def dataset_retention_period(self, dataset_retention_period):
        """Sets the dataset_retention_period of this DatamoverDatasetExtended.

        The time when dataset will expire which is calculated based upon dataset creation time plus dataset retention period specified for the dataset. It is the time in seconds past the epoch  # noqa: E501

        :param dataset_retention_period: The dataset_retention_period of this DatamoverDatasetExtended.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                dataset_retention_period is not None and dataset_retention_period > 9223372036854775807):  # noqa: E501
        ...
        if (self._configuration.client_side_validation and
                dataset_retention_period is not None and dataset_retention_period < 1):  # noqa: E501
    ...
    def dataset_state(self):
        """Gets the dataset_state of this DatamoverDatasetExtended.  # noqa: E501

        The state of dataset.  # noqa: E501

        :return: The dataset_state of this DatamoverDatasetExtended.  # noqa: E501
        :rtype: str
        """
    ...
    def dataset_state(self, dataset_state):
        """Sets the dataset_state of this DatamoverDatasetExtended.

        The state of dataset.  # noqa: E501

        :param dataset_state: The dataset_state of this DatamoverDatasetExtended.  # noqa: E501
        :type: str
        """
        allowed_values = ["INVALID", "INPROGRESS", "COMPLETE", "COMPLETE_PARTIAL", "ERROR"]  # noqa: E501
        if (self._configuration.client_side_validation and
                dataset_state not in allowed_values):
            raise ValueError(
    ...
    def dataset_subpaths(self):
        """Gets the dataset_subpaths of this DatamoverDatasetExtended.  # noqa: E501

        Set of filesystem paths relative to base path.  # noqa: E501

        :return: The dataset_subpaths of this DatamoverDatasetExtended.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def dataset_subpaths(self, dataset_subpaths):
        """Sets the dataset_subpaths of this DatamoverDatasetExtended.

        Set of filesystem paths relative to base path.  # noqa: E501

        :param dataset_subpaths: The dataset_subpaths of this DatamoverDatasetExtended.  # noqa: E501
        :type: list[str]
        """
    ...
    def dataset_type(self):
        """Gets the dataset_type of this DatamoverDatasetExtended.  # noqa: E501
        ...
        :return: The dataset_type of this DatamoverDatasetExtended.  # noqa: E501
        :rtype: str
        """
    ...
    def dataset_type(self, dataset_type):
        """Sets the dataset_type of this DatamoverDatasetExtended.

        Dataset type from one of these: A file system on object store in a copy format, a file system on object store in a backup format or file on file dataset.  # noqa: E501

        :param dataset_type: The dataset_type of this DatamoverDatasetExtended.  # noqa: E501
        :type: str
        """
    ...
    def dataset_version(self):
        """Gets the dataset_version of this DatamoverDatasetExtended.  # noqa: E501

        The version of dataset.  # noqa: E501

        :return: The dataset_version of this DatamoverDatasetExtended.  # noqa: E501
        :rtype: str
        """
    ...
    def dataset_version(self, dataset_version):
        """Sets the dataset_version of this DatamoverDatasetExtended.

        The version of dataset.  # noqa: E501

        :param dataset_version: The dataset_version of this DatamoverDatasetExtended.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this DatamoverDatasetExtended.  # noqa: E501

        The locally unique dataset identifier.  # noqa: E501

        :return: The id of this DatamoverDatasetExtended.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DatamoverDatasetExtended.

        The locally unique dataset identifier.  # noqa: E501

        :param id: The id of this DatamoverDatasetExtended.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DatamoverDatasetExtended, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DatamoverDatasetExtended):
            return False

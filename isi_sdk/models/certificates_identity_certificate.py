...
class CertificatesIdentityCertificate(object):
    ...
    def __init__(self, description=None, dnsnames=None, fingerprints=None, id=None, issuer=None, name=None, not_after=None, not_before=None, status=None, subject=None, _configuration=None):  # noqa: E501
    ...
    def dnsnames(self, dnsnames):
        ...
        :type: list[str]
        """
        if self._configuration.client_side_validation and dnsnames is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CertificatesIdentityCertificate, dict):

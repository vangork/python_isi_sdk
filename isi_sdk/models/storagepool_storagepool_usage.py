...
class StoragepoolStoragepoolUsage(object):
    ...
    def avail_bytes(self):
        """Gets the avail_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501

        Available free bytes remaining in the pool when virtual hot spare is taken into account.  # noqa: E501

        :return: The avail_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def avail_bytes(self, avail_bytes):
        """Sets the avail_bytes of this StoragepoolStoragepoolUsage.

        Available free bytes remaining in the pool when virtual hot spare is taken into account.  # noqa: E501

        :param avail_bytes: The avail_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and avail_bytes is None:
            raise ValueError("Invalid value for `avail_bytes`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                avail_bytes is not None and len(avail_bytes) > 255):
            raise ValueError("Invalid value for `avail_bytes`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                avail_bytes is not None and len(avail_bytes) < 1):
    ...
    def avail_hdd_bytes(self):
        """Gets the avail_hdd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501

        Available free bytes remaining in the pool on HDD drives when virtual hot spare is taken into account.  # noqa: E501

        :return: The avail_hdd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def avail_hdd_bytes(self, avail_hdd_bytes):
        """Sets the avail_hdd_bytes of this StoragepoolStoragepoolUsage.

        Available free bytes remaining in the pool on HDD drives when virtual hot spare is taken into account.  # noqa: E501

        :param avail_hdd_bytes: The avail_hdd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and avail_hdd_bytes is None:
            raise ValueError("Invalid value for `avail_hdd_bytes`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                avail_hdd_bytes is not None and len(avail_hdd_bytes) > 255):
            raise ValueError("Invalid value for `avail_hdd_bytes`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                avail_hdd_bytes is not None and len(avail_hdd_bytes) < 1):
    ...
    def avail_ssd_bytes(self):
        """Gets the avail_ssd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501

        Available free bytes remaining in the pool on SSD drives when virtual hot spare is taken into account.  # noqa: E501

        :return: The avail_ssd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def avail_ssd_bytes(self, avail_ssd_bytes):
        """Sets the avail_ssd_bytes of this StoragepoolStoragepoolUsage.

        Available free bytes remaining in the pool on SSD drives when virtual hot spare is taken into account.  # noqa: E501

        :param avail_ssd_bytes: The avail_ssd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and avail_ssd_bytes is None:
            raise ValueError("Invalid value for `avail_ssd_bytes`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                avail_ssd_bytes is not None and len(avail_ssd_bytes) > 255):
            raise ValueError("Invalid value for `avail_ssd_bytes`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                avail_ssd_bytes is not None and len(avail_ssd_bytes) < 1):
    ...
    @property
    def balanced(self):
        """Gets the balanced of this StoragepoolStoragepoolUsage.  # noqa: E501

        Whether or not the pool usage is currently balanced.  # noqa: E501

        :return: The balanced of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: bool
        """
    ...
    def balanced(self, balanced):
        """Sets the balanced of this StoragepoolStoragepoolUsage.

        Whether or not the pool usage is currently balanced.  # noqa: E501

        :param balanced: The balanced of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: bool
        """
        if self._configuration.client_side_validation and balanced is None:
    ...
    @property
    def free_bytes(self):
        """Gets the free_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501

        Free bytes remaining in the pool.  # noqa: E501

        :return: The free_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def free_bytes(self, free_bytes):
        """Sets the free_bytes of this StoragepoolStoragepoolUsage.

        Free bytes remaining in the pool.  # noqa: E501

        :param free_bytes: The free_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and free_bytes is None:
            raise ValueError("Invalid value for `free_bytes`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                free_bytes is not None and len(free_bytes) > 255):
            raise ValueError("Invalid value for `free_bytes`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                free_bytes is not None and len(free_bytes) < 1):
    ...
    def free_hdd_bytes(self):
        """Gets the free_hdd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501

        Free bytes remaining in the pool on HDD drives.  # noqa: E501

        :return: The free_hdd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def free_hdd_bytes(self, free_hdd_bytes):
        """Sets the free_hdd_bytes of this StoragepoolStoragepoolUsage.

        Free bytes remaining in the pool on HDD drives.  # noqa: E501

        :param free_hdd_bytes: The free_hdd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and free_hdd_bytes is None:
            raise ValueError("Invalid value for `free_hdd_bytes`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                free_hdd_bytes is not None and len(free_hdd_bytes) > 255):
            raise ValueError("Invalid value for `free_hdd_bytes`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                free_hdd_bytes is not None and len(free_hdd_bytes) < 1):
    ...
    def free_ssd_bytes(self):
        """Gets the free_ssd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501

        Free bytes remaining in the pool on SSD drives.  # noqa: E501

        :return: The free_ssd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def free_ssd_bytes(self, free_ssd_bytes):
        """Sets the free_ssd_bytes of this StoragepoolStoragepoolUsage.

        Free bytes remaining in the pool on SSD drives.  # noqa: E501

        :param free_ssd_bytes: The free_ssd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and free_ssd_bytes is None:
            raise ValueError("Invalid value for `free_ssd_bytes`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                free_ssd_bytes is not None and len(free_ssd_bytes) > 255):
            raise ValueError("Invalid value for `free_ssd_bytes`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                free_ssd_bytes is not None and len(free_ssd_bytes) < 1):
    ...
    @property
    def pct_used(self):
        """Gets the pct_used of this StoragepoolStoragepoolUsage.  # noqa: E501

        Percentage of usable space in the pool which is used.  # noqa: E501

        :return: The pct_used of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def pct_used(self, pct_used):
        """Sets the pct_used of this StoragepoolStoragepoolUsage.

        Percentage of usable space in the pool which is used.  # noqa: E501

        :param pct_used: The pct_used of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and pct_used is None:
            raise ValueError("Invalid value for `pct_used`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                pct_used is not None and len(pct_used) > 255):
            raise ValueError("Invalid value for `pct_used`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                pct_used is not None and len(pct_used) < 1):
    ...
    def pct_used_hdd(self):
        """Gets the pct_used_hdd of this StoragepoolStoragepoolUsage.  # noqa: E501

        Percentage of usable space on HDD drives in the pool which is used.  # noqa: E501

        :return: The pct_used_hdd of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def pct_used_hdd(self, pct_used_hdd):
        """Sets the pct_used_hdd of this StoragepoolStoragepoolUsage.

        Percentage of usable space on HDD drives in the pool which is used.  # noqa: E501

        :param pct_used_hdd: The pct_used_hdd of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and pct_used_hdd is None:
            raise ValueError("Invalid value for `pct_used_hdd`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                pct_used_hdd is not None and len(pct_used_hdd) > 255):
            raise ValueError("Invalid value for `pct_used_hdd`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                pct_used_hdd is not None and len(pct_used_hdd) < 1):
    ...
    def pct_used_ssd(self):
        """Gets the pct_used_ssd of this StoragepoolStoragepoolUsage.  # noqa: E501

        Percentage of usable space on SSD drives in the pool which is used.  # noqa: E501

        :return: The pct_used_ssd of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def pct_used_ssd(self, pct_used_ssd):
        """Sets the pct_used_ssd of this StoragepoolStoragepoolUsage.

        Percentage of usable space on SSD drives in the pool which is used.  # noqa: E501

        :param pct_used_ssd: The pct_used_ssd of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and pct_used_ssd is None:
            raise ValueError("Invalid value for `pct_used_ssd`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                pct_used_ssd is not None and len(pct_used_ssd) > 255):
            raise ValueError("Invalid value for `pct_used_ssd`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                pct_used_ssd is not None and len(pct_used_ssd) < 1):
    ...
    def total_bytes(self):
        """Gets the total_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501

        Total bytes in the pool.  # noqa: E501

        :return: The total_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def total_bytes(self, total_bytes):
        """Sets the total_bytes of this StoragepoolStoragepoolUsage.

        Total bytes in the pool.  # noqa: E501

        :param total_bytes: The total_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
    ...
    def total_hdd_bytes(self):
        """Gets the total_hdd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501

        Total bytes in the pool on HDD drives.  # noqa: E501

        :return: The total_hdd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def total_hdd_bytes(self, total_hdd_bytes):
        """Sets the total_hdd_bytes of this StoragepoolStoragepoolUsage.

        Total bytes in the pool on HDD drives.  # noqa: E501

        :param total_hdd_bytes: The total_hdd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and total_hdd_bytes is None:
            raise ValueError("Invalid value for `total_hdd_bytes`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                total_hdd_bytes is not None and len(total_hdd_bytes) > 255):
            raise ValueError("Invalid value for `total_hdd_bytes`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                total_hdd_bytes is not None and len(total_hdd_bytes) < 1):
    ...
    def total_ssd_bytes(self):
        """Gets the total_ssd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501

        Total bytes in the pool on SSD drives.  # noqa: E501

        :return: The total_ssd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def total_ssd_bytes(self, total_ssd_bytes):
        """Sets the total_ssd_bytes of this StoragepoolStoragepoolUsage.

        Total bytes in the pool on SSD drives.  # noqa: E501

        :param total_ssd_bytes: The total_ssd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and total_ssd_bytes is None:
            raise ValueError("Invalid value for `total_ssd_bytes`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                total_ssd_bytes is not None and len(total_ssd_bytes) > 255):
            raise ValueError("Invalid value for `total_ssd_bytes`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                total_ssd_bytes is not None and len(total_ssd_bytes) < 1):
    ...
    def usable_bytes(self):
        """Gets the usable_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501

        Total bytes in the pool drives when virtual hot spare is taken into account.  # noqa: E501

        :return: The usable_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def usable_bytes(self, usable_bytes):
        """Sets the usable_bytes of this StoragepoolStoragepoolUsage.

        Total bytes in the pool drives when virtual hot spare is taken into account.  # noqa: E501

        :param usable_bytes: The usable_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and usable_bytes is None:
            raise ValueError("Invalid value for `usable_bytes`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                usable_bytes is not None and len(usable_bytes) > 255):
            raise ValueError("Invalid value for `usable_bytes`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                usable_bytes is not None and len(usable_bytes) < 1):
    ...
    def usable_hdd_bytes(self):
        """Gets the usable_hdd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501

        Total bytes in the pool on HDD drives when virtual hot spare is taken into account.  # noqa: E501

        :return: The usable_hdd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def usable_hdd_bytes(self, usable_hdd_bytes):
        """Sets the usable_hdd_bytes of this StoragepoolStoragepoolUsage.

        Total bytes in the pool on HDD drives when virtual hot spare is taken into account.  # noqa: E501

        :param usable_hdd_bytes: The usable_hdd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and usable_hdd_bytes is None:
            raise ValueError("Invalid value for `usable_hdd_bytes`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                usable_hdd_bytes is not None and len(usable_hdd_bytes) > 255):
            raise ValueError("Invalid value for `usable_hdd_bytes`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                usable_hdd_bytes is not None and len(usable_hdd_bytes) < 1):
    ...
    def usable_ssd_bytes(self):
        """Gets the usable_ssd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501

        Total bytes in the pool on SSD drives when virtual hot spare is taken into account.  # noqa: E501

        :return: The usable_ssd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def usable_ssd_bytes(self, usable_ssd_bytes):
        """Sets the usable_ssd_bytes of this StoragepoolStoragepoolUsage.

        Total bytes in the pool on SSD drives when virtual hot spare is taken into account.  # noqa: E501

        :param usable_ssd_bytes: The usable_ssd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and usable_ssd_bytes is None:
            raise ValueError("Invalid value for `usable_ssd_bytes`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                usable_ssd_bytes is not None and len(usable_ssd_bytes) > 255):
            raise ValueError("Invalid value for `usable_ssd_bytes`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                usable_ssd_bytes is not None and len(usable_ssd_bytes) < 1):
    ...
    @property
    def used_bytes(self):
        """Gets the used_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501

        Used bytes in the pool.  # noqa: E501

        :return: The used_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def used_bytes(self, used_bytes):
        """Sets the used_bytes of this StoragepoolStoragepoolUsage.

        Used bytes in the pool.  # noqa: E501

        :param used_bytes: The used_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                used_bytes is not None and len(used_bytes) > 255):
            raise ValueError("Invalid value for `used_bytes`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                used_bytes is not None and len(used_bytes) < 1):
    ...
    def used_hdd_bytes(self):
        """Gets the used_hdd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501

        Used bytes in the pool on HDD drives.  # noqa: E501

        :return: The used_hdd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def used_hdd_bytes(self, used_hdd_bytes):
        """Sets the used_hdd_bytes of this StoragepoolStoragepoolUsage.

        Used bytes in the pool on HDD drives.  # noqa: E501

        :param used_hdd_bytes: The used_hdd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and used_hdd_bytes is None:
            raise ValueError("Invalid value for `used_hdd_bytes`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                used_hdd_bytes is not None and len(used_hdd_bytes) > 255):
            raise ValueError("Invalid value for `used_hdd_bytes`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                used_hdd_bytes is not None and len(used_hdd_bytes) < 1):
    ...
    def used_ssd_bytes(self):
        """Gets the used_ssd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501

        Used bytes in the pool on SSD drives.  # noqa: E501

        :return: The used_ssd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def used_ssd_bytes(self, used_ssd_bytes):
        """Sets the used_ssd_bytes of this StoragepoolStoragepoolUsage.

        Used bytes in the pool on SSD drives.  # noqa: E501

        :param used_ssd_bytes: The used_ssd_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and used_ssd_bytes is None:
            raise ValueError("Invalid value for `used_ssd_bytes`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                used_ssd_bytes is not None and len(used_ssd_bytes) > 255):
            raise ValueError("Invalid value for `used_ssd_bytes`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                used_ssd_bytes is not None and len(used_ssd_bytes) < 1):
    ...
    def virtual_hot_spare_bytes(self):
        """Gets the virtual_hot_spare_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501

        Bytes reserved for virtual hot spare in the pool.  # noqa: E501

        :return: The virtual_hot_spare_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def virtual_hot_spare_bytes(self, virtual_hot_spare_bytes):
        """Sets the virtual_hot_spare_bytes of this StoragepoolStoragepoolUsage.

        Bytes reserved for virtual hot spare in the pool.  # noqa: E501

        :param virtual_hot_spare_bytes: The virtual_hot_spare_bytes of this StoragepoolStoragepoolUsage.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                virtual_hot_spare_bytes is not None and len(virtual_hot_spare_bytes) > 255):
            raise ValueError("Invalid value for `virtual_hot_spare_bytes`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                virtual_hot_spare_bytes is not None and len(virtual_hot_spare_bytes) < 1):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StoragepoolStoragepoolUsage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StoragepoolStoragepoolUsage):
            return False

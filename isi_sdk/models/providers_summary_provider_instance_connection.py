...
class ProvidersSummaryProviderInstanceConnection(object):
    ...
    def __init__(self, address=None, last_used=None, server=None, _configuration=None):  # noqa: E501

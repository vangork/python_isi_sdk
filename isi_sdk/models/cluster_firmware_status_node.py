...
class ClusterFirmwareStatusNode(object):
    ...
    def __init__(self, devices=None, error=None, id=None, lnn=None, node_unavailable=None, status=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClusterFirmwareStatusNode, dict):

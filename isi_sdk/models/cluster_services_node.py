...
class ClusterServicesNode(object):
    ...
    def __init__(self, devid=None, lnn=None, services=None, _configuration=None):  # noqa: E501
    ...
    def devid(self, devid):
        ...
        if (self._configuration.client_side_validation and
                devid is not None and devid > 9223372036854775807):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClusterServicesNode, dict):

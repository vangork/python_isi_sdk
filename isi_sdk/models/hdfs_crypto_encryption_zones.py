...
class HdfsCryptoEncryptionZones(object):
    ...
    def __init__(self, encryption_zones=None, resume=None, total=None, _configuration=None):  # noqa: E501
    ...
    @property
    def resume(self):
        """Gets the resume of this HdfsCryptoEncryptionZones.  # noqa: E501

        Provide this token as the 'resume' query argument to continue listing results.  # noqa: E501

        :return: The resume of this HdfsCryptoEncryptionZones.  # noqa: E501
        :rtype: str
        """
        return self._resume
    ...
    def resume(self, resume):
        """Sets the resume of this HdfsCryptoEncryptionZones.

        Provide this token as the 'resume' query argument to continue listing results.  # noqa: E501

        :param resume: The resume of this HdfsCryptoEncryptionZones.  # noqa: E501
        :type: str
        """
    ...
    @property
    def total(self):
        """Gets the total of this HdfsCryptoEncryptionZones.  # noqa: E501

        Total number of items available.  # noqa: E501

        :return: The total of this HdfsCryptoEncryptionZones.  # noqa: E501
        :rtype: int
        """
        return self._total
    ...
    def total(self, total):
        """Sets the total of this HdfsCryptoEncryptionZones.

        Total number of items available.  # noqa: E501

        :param total: The total of this HdfsCryptoEncryptionZones.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HdfsCryptoEncryptionZones, dict):

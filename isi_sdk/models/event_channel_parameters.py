...
class EventChannelParameters(object):
    ...
    def __init__(self, address=None, batch=None, batch_period=None, custom_template=None, send_as=None, smtp_host=None, smtp_password=None, smtp_port=None, smtp_security=None, smtp_use_auth=None, smtp_username=None, subject=None, _configuration=None):  # noqa: E501
    ...
    def batch_period(self, batch_period):
        ...
        """
        if (self._configuration.client_side_validation and
                batch_period is not None and batch_period > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `batch_period`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                batch_period is not None and batch_period < 1):  # noqa: E501
    ...
    def custom_template(self, custom_template):
        ...
        """
        if (self._configuration.client_side_validation and
                custom_template is not None and len(custom_template) > 4096):
            raise ValueError("Invalid value for `custom_template`, length must be less than or equal to `4096`")  # noqa: E501
        if (self._configuration.client_side_validation and
                custom_template is not None and len(custom_template) < 0):
            raise ValueError("Invalid value for `custom_template`, length must be greater than or equal to `0`")  # noqa: E501
        if (self._configuration.client_side_validation and
                custom_template is not None and not re.search(r'^((\/[^\/]+)(\/?))*$', custom_template)):  # noqa: E501
            raise ValueError(r"Invalid value for `custom_template`, must be a follow pattern or equal to `/^((\/[^\/]+)(\/?))*$/`")  # noqa: E501
    ...
    def smtp_password(self, smtp_password):
        ...
        """
        if (self._configuration.client_side_validation and
                smtp_password is not None and len(smtp_password) > 255):
            raise ValueError("Invalid value for `smtp_password`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                smtp_password is not None and len(smtp_password) < 0):
    ...
    def smtp_security(self, smtp_security):
        ...
        if (self._configuration.client_side_validation and
                smtp_security not in allowed_values):
            raise ValueError(
    ...
    def smtp_username(self, smtp_username):
        ...
        if (self._configuration.client_side_validation and
                smtp_username is not None and len(smtp_username) < 0):

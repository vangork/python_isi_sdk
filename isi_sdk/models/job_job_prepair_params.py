...
class JobJobPrepairParams(object):
    ...
    def __init__(self, mapping_type=None, mode=None, template=None, zone=None, _configuration=None):  # noqa: E501
    ...
    def mapping_type(self, mapping_type):
        ...
        if (self._configuration.client_side_validation and
                mapping_type not in allowed_values):
            raise ValueError(
    ...
    def template(self, template):
        ...
        if (self._configuration.client_side_validation and
                template is not None and len(template) < 4):
            raise ValueError("Invalid value for `template`, length must be greater than or equal to `4`")  # noqa: E501
        if (self._configuration.client_side_validation and
                template is not None and not re.search(r'^\/ifs$|^\/ifs\/', template)):  # noqa: E501
    ...
    def zone(self, zone):
        ...
        """
        if (self._configuration.client_side_validation and
                zone is not None and len(zone) > 2147483647):

...
class CloudJobExtended(object):
    ...
    def __init__(self, completion_time=None, create_time=None, description=None, effective_state=None, files=None, id=None, job_engine_job=None, job_state=None, operation_state=None, state_change_time=None, type=None, _configuration=None):  # noqa: E501
    ...
    def effective_state(self, effective_state):
        ...
        if (self._configuration.client_side_validation and
                effective_state not in allowed_values):
            raise ValueError(
    ...
    def operation_state(self, operation_state):
        ...
        if (self._configuration.client_side_validation and
                operation_state not in allowed_values):
            raise ValueError(
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudJobExtended, dict):

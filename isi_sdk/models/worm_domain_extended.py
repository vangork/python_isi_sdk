...
class WormDomainExtended(object):
    ...
    def __init__(self, exclusions=None, id=None, incomplete=None, lin=None, max_modifies=None, path=None, privileged_delete=None, set_pending_delete=None, total_modifies=None, type=None, _configuration=None):  # noqa: E501
    ...
    def exclusions(self, exclusions):
        ...
        """
        if self._configuration.client_side_validation and exclusions is None:
    ...
    def incomplete(self, incomplete):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and incomplete is None:
    ...
    def max_modifies(self, max_modifies):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and max_modifies is None:
            raise ValueError("Invalid value for `max_modifies`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                max_modifies is not None and max_modifies > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `max_modifies`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                max_modifies is not None and max_modifies < 0):  # noqa: E501
    ...
    def set_pending_delete(self, set_pending_delete):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and set_pending_delete is None:
    ...
    def total_modifies(self, total_modifies):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and total_modifies is None:
            raise ValueError("Invalid value for `total_modifies`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                total_modifies is not None and total_modifies > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `total_modifies`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                total_modifies is not None and total_modifies < 0):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WormDomainExtended, dict):

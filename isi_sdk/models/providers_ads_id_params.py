...
class ProvidersAdsIdParams(object):
    ...
    def domain_controller(self, domain_controller):
        ...
        """
        if (self._configuration.client_side_validation and
                domain_controller is not None and len(domain_controller) > 255):
            raise ValueError("Invalid value for `domain_controller`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                domain_controller is not None and len(domain_controller) < 0):
    ...
    def machine_account(self):
        """Gets the machine_account of this ProvidersAdsIdParams.  # noqa: E501

        Specifies the machine account name when creating a SAM account with Active Directory.  # noqa: E501

        :return: The machine_account of this ProvidersAdsIdParams.  # noqa: E501
        :rtype: str
        """
    ...
    def machine_account(self, machine_account):
        """Sets the machine_account of this ProvidersAdsIdParams.

        Specifies the machine account name when creating a SAM account with Active Directory.  # noqa: E501

        :param machine_account: The machine_account of this ProvidersAdsIdParams.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def rpc_call_timeout(self):
        """Gets the rpc_call_timeout of this ProvidersAdsIdParams.  # noqa: E501

        The maximum amount of time (in seconds) an RPC call to Active Directory is allowed to take.  # noqa: E501

        :return: The rpc_call_timeout of this ProvidersAdsIdParams.  # noqa: E501
        :rtype: int
        """
    ...
    def rpc_call_timeout(self, rpc_call_timeout):
        """Sets the rpc_call_timeout of this ProvidersAdsIdParams.

        The maximum amount of time (in seconds) an RPC call to Active Directory is allowed to take.  # noqa: E501

        :param rpc_call_timeout: The rpc_call_timeout of this ProvidersAdsIdParams.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def server_retry_limit(self):
        """Gets the server_retry_limit of this ProvidersAdsIdParams.  # noqa: E501

        The number of retries attempted when a call to Active Directory fails due to network error.  # noqa: E501

        :return: The server_retry_limit of this ProvidersAdsIdParams.  # noqa: E501
        :rtype: int
        """
    ...
    def server_retry_limit(self, server_retry_limit):
        """Sets the server_retry_limit of this ProvidersAdsIdParams.

        The number of retries attempted when a call to Active Directory fails due to network error.  # noqa: E501

        :param server_retry_limit: The server_retry_limit of this ProvidersAdsIdParams.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def user(self, user):
        ...
        """
        if (self._configuration.client_side_validation and
                user is not None and len(user) > 256):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProvidersAdsIdParams, dict):

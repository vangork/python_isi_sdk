...
class StoragepoolNodepoolExtended(object):
    ...
    swagger_types = {
        ...
        'usage': 'StoragepoolStoragepoolUsage'
    }
    ...
    def __init__(self, can_disable_l3=None, can_enable_l3=None, health_flags=None, id=None, l3=None, l3_status=None, lnns=None, manual=None, name=None, node_type_ids=None, protection_policy=None, sjm_enabled=None, tier=None, transfer_limit_pct=None, transfer_limit_state=None, usage=None, _configuration=None):  # noqa: E501
    ...
    def can_disable_l3(self, can_disable_l3):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and can_disable_l3 is None:
    ...
    def can_enable_l3(self, can_enable_l3):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and can_enable_l3 is None:
    ...
    def health_flags(self, health_flags):
        ...
        if (self._configuration.client_side_validation and
                not set(health_flags).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
    ...
    def lnns(self, lnns):
        ...
        :type: list[int]
        """
        if self._configuration.client_side_validation and lnns is None:
    ...
    def node_type_ids(self, node_type_ids):
        ...
        :type: list[int]
        """
        if self._configuration.client_side_validation and node_type_ids is None:
    ...
    def sjm_enabled(self):
        """Gets the sjm_enabled of this StoragepoolNodepoolExtended.  # noqa: E501

        Indicates if SJM is currently enabled on this node pool  # noqa: E501

        :return: The sjm_enabled of this StoragepoolNodepoolExtended.  # noqa: E501
        :rtype: bool
        """
    ...
    def sjm_enabled(self, sjm_enabled):
        """Sets the sjm_enabled of this StoragepoolNodepoolExtended.

        Indicates if SJM is currently enabled on this node pool  # noqa: E501

        :param sjm_enabled: The sjm_enabled of this StoragepoolNodepoolExtended.  # noqa: E501
        :type: bool
        """
        if self._configuration.client_side_validation and sjm_enabled is None:
            raise ValueError("Invalid value for `sjm_enabled`, must not be `None`")  # noqa: E501
    ...
    def usage(self):
        ...
        :rtype: StoragepoolStoragepoolUsage
        """
        return self._usage
    ...
    def usage(self, usage):
        ...
        :type: StoragepoolStoragepoolUsage
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StoragepoolNodepoolExtended, dict):

...
class ReportsThreatsReport(object):
    ...
    def __init__(self, file=None, id=None, policy_id=None, remediation=None, scan_id=None, threat=None, time=None, _configuration=None):  # noqa: E501
    ...
    def time(self, time):
        ...
        """
        if (self._configuration.client_side_validation and
                time is not None and time > 4294967295):  # noqa: E501

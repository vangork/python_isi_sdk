...
class ConfigNode(object):
    ...
    def __init__(self, devid=None, ip_addr=None, lnn=None, remote_ipmi_capable=None, status=None, _configuration=None):  # noqa: E501
    ...
    @property
    def devid(self):
        """Gets the devid of this ConfigNode.  # noqa: E501

        Node ID (Device Number) of a node.  # noqa: E501

        :return: The devid of this ConfigNode.  # noqa: E501
        :rtype: int
        """
        return self._devid
    ...
    def devid(self, devid):
        """Sets the devid of this ConfigNode.

        Node ID (Device Number) of a node.  # noqa: E501

        :param devid: The devid of this ConfigNode.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                devid is not None and devid > 2147483647):  # noqa: E501
    ...
    def ip_addr(self, ip_addr):
        ...
        """
        if (self._configuration.client_side_validation and
                ip_addr is not None and len(ip_addr) > 45):
            raise ValueError("Invalid value for `ip_addr`, length must be less than or equal to `45`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ip_addr is not None and len(ip_addr) < 2):
            raise ValueError("Invalid value for `ip_addr`, length must be greater than or equal to `2`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ip_addr is not None and not re.search(r'^([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])(\\.([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])){3}$', ip_addr)):  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this ConfigNode.  # noqa: E501

        This field indicates if BMC version is good and if the feature is supported.  # noqa: E501

        :return: The status of this ConfigNode.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ConfigNode.

        This field indicates if BMC version is good and if the feature is supported.  # noqa: E501

        :param status: The status of this ConfigNode.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and

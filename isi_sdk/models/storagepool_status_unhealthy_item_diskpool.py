...
class StoragepoolStatusUnhealthyItemDiskpool(object):
    ...
    def __init__(self, drives=None, id=None, name=None, nodepool_id=None, protection_policy=None, ssd_drives=None, _configuration=None):  # noqa: E501
    ...
    def protection_policy(self, protection_policy):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and protection_policy is None:
    ...
    def ssd_drives(self, ssd_drives):
        ...
        :type: list[StoragepoolStatusUnhealthyItemAffectedItemDevice]
        """
        if self._configuration.client_side_validation and ssd_drives is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StoragepoolStatusUnhealthyItemDiskpool, dict):

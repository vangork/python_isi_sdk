...
class JobStatisticsJobNode(object):
    ...
    def __init__(self, cpu=None, io=None, memory=None, node=None, pid=None, total_workers=None, workers=None, _configuration=None):  # noqa: E501
    ...
    def io(self, io):
        ...
        """
        if self._configuration.client_side_validation and io is None:
    ...
    def pid(self, pid):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and pid is None:
    ...
    def total_workers(self, total_workers):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and total_workers is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(JobStatisticsJobNode, dict):

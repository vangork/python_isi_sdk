...
class ProvidersLocalIdParams(object):
    ...
    def __init__(self, authentication=None, create_home_directory=None, delete_password_hashes=None, delete_password_history=None, home_directory_template=None, lockout_duration=None, lockout_threshold=None, lockout_window=None, login_shell=None, machine_name=None, max_inactivity_days=None, max_password_age=None, min_password_age=None, min_password_length=None, name=None, password_chars_changed=None, password_complexity=None, password_hash_type=None, password_history_length=None, password_percent_changed=None, password_prompt_time=None, _configuration=None):  # noqa: E501

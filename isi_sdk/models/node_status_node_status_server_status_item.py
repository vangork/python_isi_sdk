...
class NodeStatusNodeStatusServerStatusItem(object):
    ...
    def __init__(self, connections=None, good_heartbeats=None, heartbeat_rtt=None, scan_requests=None, scan_rtt=None, server_name=None, server_state=None, _configuration=None):  # noqa: E501
    ...
    def connections(self, connections):
        ...
        if (self._configuration.client_side_validation and
                connections is not None and connections > 100):  # noqa: E501
            raise ValueError("Invalid value for `connections`, must be a value less than or equal to `100`")  # noqa: E501
        if (self._configuration.client_side_validation and
                connections is not None and connections < 0):  # noqa: E501
    ...
    def good_heartbeats(self, good_heartbeats):
        ...
        """
        if (self._configuration.client_side_validation and
                good_heartbeats is not None and good_heartbeats > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `good_heartbeats`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                good_heartbeats is not None and good_heartbeats < 0):  # noqa: E501
    ...
    def heartbeat_rtt(self, heartbeat_rtt):
        ...
        """
        if (self._configuration.client_side_validation and
                heartbeat_rtt is not None and heartbeat_rtt > 3600000):  # noqa: E501
            raise ValueError("Invalid value for `heartbeat_rtt`, must be a value less than or equal to `3600000`")  # noqa: E501
        if (self._configuration.client_side_validation and
                heartbeat_rtt is not None and heartbeat_rtt < 0):  # noqa: E501
    ...
    def scan_requests(self, scan_requests):
        ...
        """
        if (self._configuration.client_side_validation and
                scan_requests is not None and scan_requests > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `scan_requests`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                scan_requests is not None and scan_requests < 0):  # noqa: E501
    ...
    def server_name(self, server_name):
        ...
        """
        if (self._configuration.client_side_validation and
                server_name is not None and len(server_name) > 255):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NodeStatusNodeStatusServerStatusItem, dict):

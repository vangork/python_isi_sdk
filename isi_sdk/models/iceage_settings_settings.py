...
class IceageSettingsSettings(object):
    ...
    def __init__(self, core_queue_size=None, retention=None, _configuration=None):  # noqa: E501
    ...
    def core_queue_size(self, core_queue_size):
        ...
        if (self._configuration.client_side_validation and
                core_queue_size is not None and core_queue_size > 255):  # noqa: E501
            raise ValueError("Invalid value for `core_queue_size`, must be a value less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                core_queue_size is not None and core_queue_size < 0):  # noqa: E501
    ...
    def retention(self, retention):
        ...
        """
        if (self._configuration.client_side_validation and
                retention is not None and retention > 36500):  # noqa: E501
            raise ValueError("Invalid value for `retention`, must be a value less than or equal to `36500`")  # noqa: E501
        if (self._configuration.client_side_validation and
                retention is not None and retention < 0):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IceageSettingsSettings, dict):

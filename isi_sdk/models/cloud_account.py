...
class CloudAccount(object):
    ...
    def __init__(self, account_id=None, account_username=None, birth_cluster_id=None, credential_provider=None, enable_ocsp=None, enabled=None, key=None, maximum_capacity=None, name=None, ocsp_responder_url_required=None, proxy=None, skip_account_check=None, skip_ssl_validation=None, storage_region=None, telemetry_bucket=None, uri=None, _configuration=None):  # noqa: E501
    ...
    def maximum_capacity(self):
        """Gets the maximum_capacity of this CloudAccount.  # noqa: E501
        ...
        :return: The maximum_capacity of this CloudAccount.  # noqa: E501
        :rtype: int
        """
    ...
    def maximum_capacity(self, maximum_capacity):
        """Sets the maximum_capacity of this CloudAccount.

        The maximum capacity of this account in bytes (value is not used to limit capacity, if not user defined, it is set to 1099511627776 in case of MS Azure cloud provider and to 0 in case of other cloud providers)  # noqa: E501

        :param maximum_capacity: The maximum_capacity of this CloudAccount.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and

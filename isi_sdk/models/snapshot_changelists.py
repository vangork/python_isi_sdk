...
class SnapshotChangelists(object):
    ...
    def __init__(self, id=None, job_id=None, num_entries=None, root_path=None, snap1=None, snap2=None, status=None, _configuration=None):  # noqa: E501
    ...
    def root_path(self, root_path):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and root_path is None:
    ...
    def snap1(self, snap1):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and snap1 is None:
    ...
    def snap2(self, snap2):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and snap2 is None:

...
class JobJobChangelistcreateParams(object):
    ...
    attribute_map = {
        ...
        'track_data_location': 'track_data_location'
    }

    def __init__(self, create_diffs=None, newer_snapid=None, older_snapid=None, retain_repstate=None, track_data_location=None, _configuration=None):  # noqa: E501
        ...
        self._track_data_location = None
        ...
        if track_data_location is not None:
            self.track_data_location = track_data_location
    ...
    def older_snapid(self, older_snapid):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and older_snapid is None:
            raise ValueError("Invalid value for `older_snapid`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                older_snapid is not None and older_snapid > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `older_snapid`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                older_snapid is not None and older_snapid < 0):  # noqa: E501
            raise ValueError("Invalid value for `older_snapid`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    @property
    def track_data_location(self):
        """Gets the track_data_location of this JobJobChangelistcreateParams.  # noqa: E501

        Whether to track data location.   # noqa: E501

        :return: The track_data_location of this JobJobChangelistcreateParams.  # noqa: E501
        :rtype: bool
        """
        return self._track_data_location

    @track_data_location.setter
    def track_data_location(self, track_data_location):
        """Sets the track_data_location of this JobJobChangelistcreateParams.

        Whether to track data location.   # noqa: E501

        :param track_data_location: The track_data_location of this JobJobChangelistcreateParams.  # noqa: E501
        :type: bool
        """

        self._track_data_location = track_data_location

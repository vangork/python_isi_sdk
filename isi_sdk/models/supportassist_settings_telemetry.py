...
class SupportassistSettingsTelemetry(object):
    ...
    def offline_collection_period(self):
        ...
        Offline collection period in seconds when connectivity is down.  # noqa: E501
    ...
    def offline_collection_period(self, offline_collection_period):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and offline_collection_period is None:
    ...
    def telemetry_enabled(self, telemetry_enabled):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and telemetry_enabled is None:
    ...
    def telemetry_persist(self, telemetry_persist):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and telemetry_persist is None:
    ...
    def telemetry_threads(self, telemetry_threads):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and telemetry_threads is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SupportassistSettingsTelemetry, dict):

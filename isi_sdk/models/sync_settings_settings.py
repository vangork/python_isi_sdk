...
class SyncSettingsSettings(object):
    ...
    def elliptic_curve_list(self):
        """Gets the elliptic_curve_list of this SyncSettingsSettings.  # noqa: E501
        ...
        :return: The elliptic_curve_list of this SyncSettingsSettings.  # noqa: E501
        :rtype: str
        """
    ...
    def elliptic_curve_list(self, elliptic_curve_list):
        """Sets the elliptic_curve_list of this SyncSettingsSettings.

        The elliptic curve list being used with encryption. For SyncIQ targets, this list serves as a list of supported elliptic curves. For SyncIQ sources, the list of elliptic curves will be attempted to be used in order.  # noqa: E501

        :param elliptic_curve_list: The elliptic_curve_list of this SyncSettingsSettings.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def max_concurrent_jobs(self, max_concurrent_jobs):
        ...
        """
        if (self._configuration.client_side_validation and
                max_concurrent_jobs is not None and max_concurrent_jobs > 1000):  # noqa: E501
            raise ValueError("Invalid value for `max_concurrent_jobs`, must be a value less than or equal to `1000`")  # noqa: E501
        if (self._configuration.client_side_validation and
                max_concurrent_jobs is not None and max_concurrent_jobs < 0):  # noqa: E501
    ...
    def renegotiation_bytes(self):
        """Gets the renegotiation_bytes of this SyncSettingsSettings.  # noqa: E501
        ...
        :return: The renegotiation_bytes of this SyncSettingsSettings.  # noqa: E501
        :rtype: int
        """
    ...
    def renegotiation_bytes(self, renegotiation_bytes):
        """Sets the renegotiation_bytes of this SyncSettingsSettings.

        Default for the number of bytes that are passed before a new TLS connection is 1TB. Setting to 0 will disable renegotiations based on bytes.  # noqa: E501

        :param renegotiation_bytes: The renegotiation_bytes of this SyncSettingsSettings.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SyncSettingsSettings, dict):

...
class ResultDirPoolsUsage(object):
    ...
    def __init__(self, begin_time=None, dir_depth=None, dir_usage=None, storage_pool_type=None, usage_data=None, _configuration=None):  # noqa: E501
    ...
    def begin_time(self, begin_time):
        ...
        if (self._configuration.client_side_validation and
                begin_time is not None and begin_time > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `begin_time`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                begin_time is not None and begin_time < -9223372036854775808):  # noqa: E501
    ...
    def dir_usage(self, dir_usage):
        ...
        """
        if self._configuration.client_side_validation and dir_usage is None:
    ...
    def storage_pool_type(self, storage_pool_type):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and storage_pool_type is None:
            raise ValueError("Invalid value for `storage_pool_type`, must not be `None`")  # noqa: E501
        allowed_values = ["node_pool"]  # noqa: E501
        if (self._configuration.client_side_validation and
                storage_pool_type not in allowed_values):
            raise ValueError(
    ...
    def usage_data(self, usage_data):
        ...
        """
        if self._configuration.client_side_validation and usage_data is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResultDirPoolsUsage, dict):

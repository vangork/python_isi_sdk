...
class JobReport(object):
    ...
    def __init__(self, flags=None, fmt_type=None, id=None, job_id=None, job_type=None, key=None, phase=None, status=None, time=None, value=None, _configuration=None):  # noqa: E501
    ...
    def job_id(self, job_id):
        ...
        if (self._configuration.client_side_validation and
                job_id is not None and job_id < 1):  # noqa: E501
    ...
    def job_type(self, job_type):
        ...
        if (self._configuration.client_side_validation and
                job_type is not None and len(job_type) > 100):

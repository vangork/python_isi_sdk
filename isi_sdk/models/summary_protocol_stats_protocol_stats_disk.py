...
class SummaryProtocolStatsProtocolStatsDisk(object):
    ...
    def __init__(self, iops=None, read=None, write=None, _configuration=None):  # noqa: E501
    ...
    def iops(self, iops):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and iops is None:
    ...
    def read(self, read):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and read is None:
    ...
    def write(self, write):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and write is None:

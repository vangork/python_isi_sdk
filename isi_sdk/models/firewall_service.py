...
class FirewallService(object):
    ...
    def __init__(self, aliases=None, port=None, protocol=None, service_name=None, _configuration=None):  # noqa: E501
    ...
    def aliases(self, aliases):
        ...
        :type: list[str]
        """
        if self._configuration.client_side_validation and aliases is None:
    ...
    def protocol(self, protocol):
        ...
        if (self._configuration.client_side_validation and
                not set(protocol).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(

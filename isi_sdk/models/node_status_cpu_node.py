...
class NodeStatusCpuNode(object):
    ...
    def __init__(self, error=None, id=None, lnn=None, model=None, overtemp=None, proc=None, speed_limit=None, status=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NodeStatusCpuNode, dict):

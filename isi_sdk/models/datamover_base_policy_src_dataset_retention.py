...
class DatamoverBasePolicySrcDatasetRetention(object):
    ...
    def __init__(self, dataset_expiry_action=None, dataset_reserve=None, dataset_retention_period=None, _configuration=None):  # noqa: E501
    ...
    def dataset_reserve(self, dataset_reserve):
        ...
        """
        if (self._configuration.client_side_validation and
                dataset_reserve is not None and dataset_reserve > 65535):  # noqa: E501
            raise ValueError("Invalid value for `dataset_reserve`, must be a value less than or equal to `65535`")  # noqa: E501
        if (self._configuration.client_side_validation and
                dataset_reserve is not None and dataset_reserve < 0):  # noqa: E501
    ...
    def dataset_retention_period(self, dataset_retention_period):
        ...
        if (self._configuration.client_side_validation and
                dataset_retention_period is not None and dataset_retention_period < 0):  # noqa: E501

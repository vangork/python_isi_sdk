...
class SecurityCheckItem(object):
    ...
    def __init__(self, action=None, exclude_list=None, mode=None, name=None, node_lnn=None, _configuration=None):  # noqa: E501
    ...
    def exclude_list(self, exclude_list):
        ...
        if (self._configuration.client_side_validation and
                not set(exclude_list).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SecurityCheckItem, dict):

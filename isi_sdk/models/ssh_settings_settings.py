...
class SshSettingsSettings(object):
    ...
    def __init__(self, auth_settings_template=None, authentication_methods=None, banner=None, ca_signature_algorithms=None, challenge_response_authentication=None, ciphers=None, client_alive_count_max=None, client_alive_interval=None, host_key_algorithms=None, ignore_rhosts=None, kex_algorithms=None, keyboard_interactive_authentication=None, log_level=None, login_grace_time=None, macs=None, match=None, max_auth_tries=None, max_sessions=None, max_startups=None, password_authentication=None, permit_empty_passwords=None, permit_root_login=None, port=None, print_motd=None, pubkey_accepted_key_types=None, pubkey_authentication=None, strict_modes=None, subsystem=None, syslog_facility=None, tcp_keep_alive=None, use_dns=None, use_pam=None, _configuration=None):  # noqa: E501
        ...
        self._ciphers = None
        self._client_alive_count_max = None
        self._client_alive_interval = None
        ...
        if client_alive_count_max is not None:
            self.client_alive_count_max = client_alive_count_max
        if client_alive_interval is not None:
            self.client_alive_interval = client_alive_interval
    ...
    def auth_settings_template(self, auth_settings_template):
        ...
        if (self._configuration.client_side_validation and
                auth_settings_template not in allowed_values):
            raise ValueError(
    ...
    def authentication_methods(self, authentication_methods):
        ...
        """
        if (self._configuration.client_side_validation and
                authentication_methods is not None and len(authentication_methods) > 1024):
            raise ValueError("Invalid value for `authentication_methods`, length must be less than or equal to `1024`")  # noqa: E501
        if (self._configuration.client_side_validation and
                authentication_methods is not None and len(authentication_methods) < 0):
            raise ValueError("Invalid value for `authentication_methods`, length must be greater than or equal to `0`")  # noqa: E501
        if (self._configuration.client_side_validation and
                authentication_methods is not None and not re.search(r'^[^ ]*$', authentication_methods)):  # noqa: E501
    ...
    def ciphers(self, ciphers):
        ...
        """
        if (self._configuration.client_side_validation and
                ciphers is not None and len(ciphers) > 4096):
            raise ValueError("Invalid value for `ciphers`, length must be less than or equal to `4096`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ciphers is not None and len(ciphers) < 7):
            raise ValueError("Invalid value for `ciphers`, length must be greater than or equal to `7`")  # noqa: E501
        if (self._configuration.client_side_validation and
                ciphers is not None and not re.search(r'^(\\+?)(aes128-cbc|aes192-cbc|aes256-cbc|aes128-ctr|aes192-ctr|aes256-ctr|aes128-gcm@openssh\\.com|aes256-gcm@openssh\\.com|chacha20-poly1305@openssh\\.com)(,(aes128-cbc|aes192-cbc|aes256-cbc|aes128-ctr|aes192-ctr|aes256-ctr|aes128-gcm@openssh\\.com|aes256-gcm@openssh\\.com|chacha20-poly1305@openssh\\.com))*$', ciphers)):  # noqa: E501
            raise ValueError(r"Invalid value for `ciphers`, must be a follow pattern or equal to `/^(\\+?)(aes128-cbc|aes192-cbc|aes256-cbc|aes128-ctr|aes192-ctr|aes256-ctr|aes128-gcm@openssh\\.com|aes256-gcm@openssh\\.com|chacha20-poly1305@openssh\\.com)(,(aes128-cbc|aes192-cbc|aes256-cbc|aes128-ctr|aes192-ctr|aes256-ctr|aes128-gcm@openssh\\.com|aes256-gcm@openssh\\.com|chacha20-poly1305@openssh\\.com))*$/`")  # noqa: E501

        self._ciphers = ciphers

    @property
    def client_alive_count_max(self):
        """Gets the client_alive_count_max of this SshSettingsSettings.  # noqa: E501

        Specifies the number of client alive messages which may be sent without sshd receiving any messages back from the client. If this threshold is reached, sshd will disconnect the client, terminating the session. Setting this to zero disables connection termination.  # noqa: E501

        :return: The client_alive_count_max of this SshSettingsSettings.  # noqa: E501
        :rtype: int
        """
        return self._client_alive_count_max

    @client_alive_count_max.setter
    def client_alive_count_max(self, client_alive_count_max):
        """Sets the client_alive_count_max of this SshSettingsSettings.

        Specifies the number of client alive messages which may be sent without sshd receiving any messages back from the client. If this threshold is reached, sshd will disconnect the client, terminating the session. Setting this to zero disables connection termination.  # noqa: E501

        :param client_alive_count_max: The client_alive_count_max of this SshSettingsSettings.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                client_alive_count_max is not None and client_alive_count_max > 1000):  # noqa: E501
            raise ValueError("Invalid value for `client_alive_count_max`, must be a value less than or equal to `1000`")  # noqa: E501
        if (self._configuration.client_side_validation and
                client_alive_count_max is not None and client_alive_count_max < 0):  # noqa: E501
            raise ValueError("Invalid value for `client_alive_count_max`, must be a value greater than or equal to `0`")  # noqa: E501

        self._client_alive_count_max = client_alive_count_max

    @property
    def client_alive_interval(self):
        """Gets the client_alive_interval of this SshSettingsSettings.  # noqa: E501

        Specifies a timeout interval in seconds after which if no data has been received from the client, sshd will  request a response from the client. Setting this to zero means that these messages will not be sent.  # noqa: E501

        :return: The client_alive_interval of this SshSettingsSettings.  # noqa: E501
        :rtype: int
        """
        return self._client_alive_interval

    @client_alive_interval.setter
    def client_alive_interval(self, client_alive_interval):
        """Sets the client_alive_interval of this SshSettingsSettings.

        Specifies a timeout interval in seconds after which if no data has been received from the client, sshd will  request a response from the client. Setting this to zero means that these messages will not be sent.  # noqa: E501

        :param client_alive_interval: The client_alive_interval of this SshSettingsSettings.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                client_alive_interval is not None and client_alive_interval > 3600):  # noqa: E501
            raise ValueError("Invalid value for `client_alive_interval`, must be a value less than or equal to `3600`")  # noqa: E501
        if (self._configuration.client_side_validation and
                client_alive_interval is not None and client_alive_interval < 0):  # noqa: E501
            raise ValueError("Invalid value for `client_alive_interval`, must be a value greater than or equal to `0`")  # noqa: E501

        self._client_alive_interval = client_alive_interval
    ...
    def login_grace_time(self, login_grace_time):
        ...
        """
        if (self._configuration.client_side_validation and
                login_grace_time is not None and login_grace_time > 600):  # noqa: E501
            raise ValueError("Invalid value for `login_grace_time`, must be a value less than or equal to `600`")  # noqa: E501
        if (self._configuration.client_side_validation and
                login_grace_time is not None and login_grace_time < 0):  # noqa: E501
    ...
    def macs(self, macs):
        ...
        """
        if (self._configuration.client_side_validation and
                macs is not None and len(macs) > 4096):
            raise ValueError("Invalid value for `macs`, length must be less than or equal to `4096`")  # noqa: E501
        if (self._configuration.client_side_validation and
                macs is not None and len(macs) < 8):
            raise ValueError("Invalid value for `macs`, length must be greater than or equal to `8`")  # noqa: E501
        if (self._configuration.client_side_validation and
                macs is not None and not re.search(r'^(\\+?)(hmac-sha1|hmac-sha2-256|hmac-sha2-512|umac-128@openssh\\.com|hmac-sha1-etm@openssh\\.com|hmac-sha2-256-etm@openssh\\.com|hmac-sha2-512-etm@openssh\\.com|umac-64-etm@openssh\\.com|umac-128-etm@openssh\\.com)(,(hmac-sha1|hmac-sha2-256|hmac-sha2-512|umac-128@openssh\\.com|hmac-sha1-etm@openssh\\.com|hmac-sha2-256-etm@openssh\\.com|hmac-sha2-512-etm@openssh\\.com|umac-64-etm@openssh\\.com|umac-128-etm@openssh\\.com))*$', macs)):  # noqa: E501
            raise ValueError(r"Invalid value for `macs`, must be a follow pattern or equal to `/^(\\+?)(hmac-sha1|hmac-sha2-256|hmac-sha2-512|umac-128@openssh\\.com|hmac-sha1-etm@openssh\\.com|hmac-sha2-256-etm@openssh\\.com|hmac-sha2-512-etm@openssh\\.com|umac-64-etm@openssh\\.com|umac-128-etm@openssh\\.com)(,(hmac-sha1|hmac-sha2-256|hmac-sha2-512|umac-128@openssh\\.com|hmac-sha1-etm@openssh\\.com|hmac-sha2-256-etm@openssh\\.com|hmac-sha2-512-etm@openssh\\.com|umac-64-etm@openssh\\.com|umac-128-etm@openssh\\.com))*$/`")  # noqa: E501
    ...
    def max_auth_tries(self, max_auth_tries):
        ...
        """
        if (self._configuration.client_side_validation and
                max_auth_tries is not None and max_auth_tries > 1024):  # noqa: E501
            raise ValueError("Invalid value for `max_auth_tries`, must be a value less than or equal to `1024`")  # noqa: E501
        if (self._configuration.client_side_validation and
                max_auth_tries is not None and max_auth_tries < 0):  # noqa: E501
    ...
    def max_sessions(self, max_sessions):
        ...
        """
        if (self._configuration.client_side_validation and
                max_sessions is not None and max_sessions > 1024):  # noqa: E501
            raise ValueError("Invalid value for `max_sessions`, must be a value less than or equal to `1024`")  # noqa: E501
        if (self._configuration.client_side_validation and
                max_sessions is not None and max_sessions < 0):  # noqa: E501
    ...
    def max_startups(self, max_startups):
        ...
        """
        if (self._configuration.client_side_validation and
                max_startups is not None and len(max_startups) > 11):
            raise ValueError("Invalid value for `max_startups`, length must be less than or equal to `11`")  # noqa: E501
        if (self._configuration.client_side_validation and
                max_startups is not None and len(max_startups) < 0):
            raise ValueError("Invalid value for `max_startups`, length must be greater than or equal to `0`")  # noqa: E501
        if (self._configuration.client_side_validation and
                max_startups is not None and not re.search(r'^$|^([0-9]|[0-9][0-9]|[0-9][0-9][0-9]):([0-9]|[0-9][0-9]|[0-9][0-9][0-9]):([0-9]|[0-9][0-9]|[0-9][0-9][0-9])$', max_startups)):  # noqa: E501
    ...
    def pubkey_accepted_key_types(self, pubkey_accepted_key_types):
        ...
        """
        if (self._configuration.client_side_validation and
                pubkey_accepted_key_types is not None and len(pubkey_accepted_key_types) > 4096):
            raise ValueError("Invalid value for `pubkey_accepted_key_types`, length must be less than or equal to `4096`")  # noqa: E501
        if (self._configuration.client_side_validation and
                pubkey_accepted_key_types is not None and len(pubkey_accepted_key_types) < 7):
            raise ValueError("Invalid value for `pubkey_accepted_key_types`, length must be greater than or equal to `7`")  # noqa: E501
        if (self._configuration.client_side_validation and
                pubkey_accepted_key_types is not None and not re.search(r'^(\\+?)(ssh-ed25519|ssh-ed25519-cert-v01@openssh\\.com|ssh-rsa|ssh-dss|ecdsa-sha2-nistp256|ecdsa-sha2-nistp384|ecdsa-sha2-nistp521|ssh-rsa-cert-v01@openssh\\.com|ssh-dss-cert-v01@openssh\\.com|ecdsa-sha2-nistp256-cert-v01@openssh\\.com|ecdsa-sha2-nistp384-cert-v01@openssh\\.com|ecdsa-sha2-nistp521-cert-v01@openssh\\.com|rsa-sha2-256|rsa-sha2-256-cert-v01@openssh\\.com|rsa-sha2-512|rsa-sha2-512-cert-v01@openssh\\.com)(,(ssh-ed25519|ssh-ed25519-cert-v01@openssh\\.com|ssh-rsa|ssh-dss|ecdsa-sha2-nistp256|ecdsa-sha2-nistp384|ecdsa-sha2-nistp521|ssh-rsa-cert-v01@openssh\\.com|ssh-dss-cert-v01@openssh\\.com|ecdsa-sha2-nistp256-cert-v01@openssh\\.com|ecdsa-sha2-nistp384-cert-v01@openssh\\.com|ecdsa-sha2-nistp521-cert-v01@openssh\\.com|rsa-sha2-256|rsa-sha2-256-cert-v01@openssh\\.com|rsa-sha2-512|rsa-sha2-512-cert-v01@openssh\\.com))*$', pubkey_accepted_key_types)):  # noqa: E501
    ...
    def syslog_facility(self, syslog_facility):
        ...
        if (self._configuration.client_side_validation and
                syslog_facility not in allowed_values):
            raise ValueError(

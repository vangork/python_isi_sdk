...
class SupportassistSettingsConnectionGatewayEndpoint(object):
    ...
    def __init__(self, enabled=True, host=None, port=None, priority=None, use_proxy=False, validate_ssl=False, _configuration=None):  # noqa: E501
    ...
    def enabled(self):
        ...
        Whether this secure connect gateway is enabled.  # noqa: E501
    ...
    def host(self):
        ...
        Hostname, IPv4 address, or IPv6 address for the secure connect gateway.  # noqa: E501
    ...
    def host(self, host):
        ...
        if (self._configuration.client_side_validation and
                host is not None and len(host) > 255):
        ...
        if (self._configuration.client_side_validation and
                host is not None and not re.search(r'(^$|^((([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])(\\.([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])*)$|^([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])(\\.([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])){3}$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5}::([0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5})?$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){7}$)', host)):  # noqa: E501
    ...
    def port(self):
        ...
        Port for the secure connect gateway.  # noqa: E501
    ...
    def priority(self):
        ...
        Priority for using the secure connect gateway.  # noqa: E501
    ...
    def priority(self, priority):
        ...
        """
        if (self._configuration.client_side_validation and
                priority is not None and priority > 4):  # noqa: E501
    ...
    def use_proxy(self):
        ...
        Whether to use Proxy for this secure connect gateway.  # noqa: E501
    ...
    def validate_ssl(self):
        ...
        Whether to validate SSL for this secure connect gateway.  # noqa: E501

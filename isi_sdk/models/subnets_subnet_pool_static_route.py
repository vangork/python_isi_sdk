...
class SubnetsSubnetPoolStaticRoute(object):
    ...
    def __init__(self, gateway=None, prefixlen=None, subnet=None, _configuration=None):  # noqa: E501
    ...
    def gateway(self, gateway):
        ...
        if (self._configuration.client_side_validation and
                gateway is not None and not re.search(r'(^([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])(\\.([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])){3}$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5}::([0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5})?$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){7}$)', gateway)):  # noqa: E501
    ...
    def subnet(self, subnet):
        ...
        if (self._configuration.client_side_validation and
                subnet is not None and len(subnet) > 40):
        ...
        if (self._configuration.client_side_validation and
                subnet is not None and not re.search(r'(^([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])(\\.([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])){3}$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5}::([0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5})?$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){7}$)', subnet)):  # noqa: E501

...
class ProvidersSamlServicesSpSigningKeySettingsSettingsCertificate(object):
    ...
    def __init__(self, expiration=None, key=None, subject=None, _configuration=None):  # noqa: E501
    ...
    def expiration(self, expiration):
        ...
        if (self._configuration.client_side_validation and
                expiration is not None and expiration > 3122064000):  # noqa: E501
            raise ValueError("Invalid value for `expiration`, must be a value less than or equal to `3122064000`")  # noqa: E501
        if (self._configuration.client_side_validation and
                expiration is not None and expiration < 1800):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProvidersSamlServicesSpSigningKeySettingsSettingsCertificate, dict):

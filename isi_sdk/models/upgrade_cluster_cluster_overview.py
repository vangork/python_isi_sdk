...
class UpgradeClusterClusterOverview(object):
    ...
    def __init__(self, nodes_current=None, nodes_total=None, nodes_transitioning=None, nodes_upgraded=None, _configuration=None):  # noqa: E501
    ...
    def nodes_current(self, nodes_current):
        ...
        if (self._configuration.client_side_validation and
                nodes_current is not None and nodes_current > 576):  # noqa: E501
            raise ValueError("Invalid value for `nodes_current`, must be a value less than or equal to `576`")  # noqa: E501
        if (self._configuration.client_side_validation and
                nodes_current is not None and nodes_current < 1):  # noqa: E501
    ...
    def nodes_total(self, nodes_total):
        ...
        """
        if (self._configuration.client_side_validation and
                nodes_total is not None and nodes_total > 576):  # noqa: E501
            raise ValueError("Invalid value for `nodes_total`, must be a value less than or equal to `576`")  # noqa: E501
        if (self._configuration.client_side_validation and
                nodes_total is not None and nodes_total < 1):  # noqa: E501
    ...
    def nodes_transitioning(self, nodes_transitioning):
        ...
        """
        if (self._configuration.client_side_validation and
                nodes_transitioning is not None and nodes_transitioning > 576):  # noqa: E501
            raise ValueError("Invalid value for `nodes_transitioning`, must be a value less than or equal to `576`")  # noqa: E501
        if (self._configuration.client_side_validation and
                nodes_transitioning is not None and nodes_transitioning < 0):  # noqa: E501
    ...
    def nodes_upgraded(self, nodes_upgraded):
        ...
        """
        if (self._configuration.client_side_validation and
                nodes_upgraded is not None and nodes_upgraded > 576):  # noqa: E501
            raise ValueError("Invalid value for `nodes_upgraded`, must be a value less than or equal to `576`")  # noqa: E501
        if (self._configuration.client_side_validation and
                nodes_upgraded is not None and nodes_upgraded < 0):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpgradeClusterClusterOverview, dict):

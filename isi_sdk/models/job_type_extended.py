...
class JobTypeExtended(object):
    ...
    def __init__(self, allow_multiple_instances=None, description=None, enabled=None, exclusion_set=None, hidden=None, id=None, policy=None, priority=None, _configuration=None):  # noqa: E501
    ...
    def allow_multiple_instances(self, allow_multiple_instances):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and allow_multiple_instances is None:
    ...
    def exclusion_set(self, exclusion_set):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and exclusion_set is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(JobTypeExtended, dict):

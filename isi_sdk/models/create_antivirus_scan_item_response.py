...
class CreateAntivirusScanItemResponse(object):
    ...
    def __init__(self, report_id=None, result=None, _configuration=None):  # noqa: E501
    ...
    def report_id(self, report_id):
        ...
        if (self._configuration.client_side_validation and
                report_id is not None and len(report_id) < 0):
    ...
    def result(self, result):
        ...
        """
        if (self._configuration.client_side_validation and
                result is not None and len(result) > 255):

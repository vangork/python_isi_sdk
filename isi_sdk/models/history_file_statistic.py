...
class HistoryFileStatistic(object):
    ...
    def __init__(self, allocated=None, id=None, limit=None, name=None, timestamp=None, total=None, _configuration=None):  # noqa: E501
    ...
    def limit(self, limit):
        ...
        if (self._configuration.client_side_validation and
                limit is not None and limit > 2147483647):  # noqa: E501
    ...
    def timestamp(self, timestamp):
        ...
        if (self._configuration.client_side_validation and
                timestamp is not None and timestamp > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `timestamp`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                timestamp is not None and timestamp < 1000000000):  # noqa: E501

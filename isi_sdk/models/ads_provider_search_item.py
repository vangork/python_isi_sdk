...
class AdsProviderSearchItem(object):
    ...
    def __init__(self, description=None, domain=None, filter=None, limit=None, password=None, resume=None, search_groups=None, search_users=None, user=None, _configuration=None):  # noqa: E501
    ...
    def filter(self, filter):
        ...
        """
        if (self._configuration.client_side_validation and
                filter is not None and len(filter) > 255):
    ...
    def limit(self, limit):
        ...
        """
        if (self._configuration.client_side_validation and
                limit is not None and limit > 4294967295):  # noqa: E501

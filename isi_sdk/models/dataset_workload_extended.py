...
class DatasetWorkloadExtended(object):
    ...
    def __init__(self, creation_time=None, dataset_id=None, error=None, id=None, metric_values=None, _configuration=None):  # noqa: E501
    ...
    def dataset_id(self, dataset_id):
        ...
        """
        if (self._configuration.client_side_validation and
                dataset_id is not None and dataset_id > 4294967295):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DatasetWorkloadExtended, dict):

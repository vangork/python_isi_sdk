...
class PapiSettingsPapiSettingsChildSettings(object):
    ...
    def __init__(self, child_limit=None, child_limit_ceiling=None, child_limit_extension=None, child_limit_floor=None, _configuration=None):  # noqa: E501
    ...
    def child_limit_extension(self, child_limit_extension):
        ...
        """
        if (self._configuration.client_side_validation and
                child_limit_extension is not None and child_limit_extension > 65535):  # noqa: E501
            raise ValueError("Invalid value for `child_limit_extension`, must be a value less than or equal to `65535`")  # noqa: E501
        if (self._configuration.client_side_validation and
                child_limit_extension is not None and child_limit_extension < 0):  # noqa: E501

...
class ProvidersDuoSettings(object):
    ...
    def __init__(self, autopush=None, enabled=None, failmode=None, fallback_local_ip=None, groups=None, host=None, http_proxy=None, https_timeout=None, ikey=None, prompts=None, pushinfo=None, _configuration=None):  # noqa: E501
    ...
    def autopush(self, autopush):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and autopush is None:
    ...
    def fallback_local_ip(self, fallback_local_ip):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and fallback_local_ip is None:
    ...
    def groups(self, groups):
        ...
        if (self._configuration.client_side_validation and
                groups is not None and len(groups) > 1024):
    ...
    def https_timeout(self, https_timeout):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and https_timeout is None:
            raise ValueError("Invalid value for `https_timeout`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                https_timeout is not None and https_timeout > 600):  # noqa: E501
            raise ValueError("Invalid value for `https_timeout`, must be a value less than or equal to `600`")  # noqa: E501
        if (self._configuration.client_side_validation and
                https_timeout is not None and https_timeout < 0):  # noqa: E501
    ...
    def pushinfo(self, pushinfo):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and pushinfo is None:

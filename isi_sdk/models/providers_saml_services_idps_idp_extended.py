...
class ProvidersSamlServicesIdpsIdpExtended(object):
    ...
    def __init__(self, entity_id=None, id=None, login_url=None, logout_url=None, _configuration=None):  # noqa: E501
    ...
    def login_url(self, login_url):
        ...
        if (self._configuration.client_side_validation and
                login_url is not None and len(login_url) < 1):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProvidersSamlServicesIdpsIdpExtended, dict):

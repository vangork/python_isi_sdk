...
class PoolsPoolStatusStatus(object):
    ...
    def __init__(self, id=None, nodes=None, sc_dns_overview=None, total_configured_nodes=None, _configuration=None):  # noqa: E501
    ...
    def sc_dns_overview(self, sc_dns_overview):
        ...
        """
        if self._configuration.client_side_validation and sc_dns_overview is None:
    ...
    def total_configured_nodes(self, total_configured_nodes):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and total_configured_nodes is None:
            raise ValueError("Invalid value for `total_configured_nodes`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                total_configured_nodes is not None and total_configured_nodes > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `total_configured_nodes`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                total_configured_nodes is not None and total_configured_nodes < 0):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PoolsPoolStatusStatus, dict):

...
class DiagnosticsNetloggerSettingsSettings(object):
    ...
    def __init__(self, clients=None, count=None, duration=None, interfaces=None, nodelist=None, ports=None, protocols=None, snaplength=None, _configuration=None):  # noqa: E501
    ...
    def clients(self, clients):
        ...
        if (self._configuration.client_side_validation and
                clients is not None and not re.search(r'^$|^(((([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])(\\.([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])*)|([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])(\\.([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])){3}|[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5}::([0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5})?|[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){7})(,(((([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])(\\.([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])*)|([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])(\\.([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])){3}|[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5}::([0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5})?|[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){7}))*$', clients)):  # noqa: E501
    ...
    def count(self, count):
        ...
        """
        if (self._configuration.client_side_validation and
                count is not None and count > 1024):  # noqa: E501
    ...
    def duration(self, duration):
        ...
        """
        if (self._configuration.client_side_validation and
                duration is not None and duration > 255):  # noqa: E501
    ...
    def interfaces(self, interfaces):
        ...
        """
        if (self._configuration.client_side_validation and
                interfaces is not None and not re.search(r'^[a-z0-9]*(,[a-z0-9]*)*$', interfaces)):  # noqa: E501
    ...
    def nodelist(self, nodelist):
        ...
        """
        if (self._configuration.client_side_validation and
                nodelist is not None and not re.search(r'^$|^([0-9]{1,3}(,[0-9]{1,3})*)$', nodelist)):  # noqa: E501
    ...
    def ports(self, ports):
        ...
        """
        if (self._configuration.client_side_validation and
                ports is not None and not re.search(r'^$|^([0-9]{1,5}(,[0-9]{1,5})*)$', ports)):  # noqa: E501
    ...
    def protocols(self, protocols):
        ...
        """
        if (self._configuration.client_side_validation and
                protocols is not None and not re.search(r'^(ip6|ip|arp|tcp|udp|vlan)(,(ip6|ip|arp|tcp|udp|vlan))*$', protocols)):  # noqa: E501
            raise ValueError(r"Invalid value for `protocols`, must be a follow pattern or equal to `/^(ip6|ip|arp|tcp|udp|vlan)(,(ip6|ip|arp|tcp|udp|vlan))*$/`")  # noqa: E501
    ...
    def snaplength(self, snaplength):
        ...
        """
        if (self._configuration.client_side_validation and
                snaplength is not None and snaplength > 9100):  # noqa: E501
            raise ValueError("Invalid value for `snaplength`, must be a value less than or equal to `9100`")  # noqa: E501
        if (self._configuration.client_side_validation and
                snaplength is not None and snaplength < 64):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DiagnosticsNetloggerSettingsSettings, dict):

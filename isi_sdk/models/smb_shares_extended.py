...
class SmbSharesExtended(object):
    ...
    def __init__(self, digest=None, resume=None, total=None, _configuration=None):  # noqa: E501
    ...
    def digest(self):
        ...
        An identifier for a set of shares.  # noqa: E501
    ...
    def digest(self, digest):
        ...
        if (self._configuration.client_side_validation and
                digest is not None and len(digest) > 256):
            raise ValueError("Invalid value for `digest`, length must be less than or equal to `256`")  # noqa: E501
        if (self._configuration.client_side_validation and
                digest is not None and len(digest) < 0):
            raise ValueError("Invalid value for `digest`, length must be greater than or equal to `0`")  # noqa: E501

        self._digest = digest

    @property
    def resume(self):
        """Gets the resume of this SmbSharesExtended.  # noqa: E501

        Provide this token as the 'resume' query argument to continue listing results.  # noqa: E501

        :return: The resume of this SmbSharesExtended.  # noqa: E501
        :rtype: str
        """
        return self._resume
    ...
    def resume(self, resume):
        ...
        :param resume: The resume of this SmbSharesExtended.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def total(self):
        """Gets the total of this SmbSharesExtended.  # noqa: E501

        Total number of items available.  # noqa: E501

        :return: The total of this SmbSharesExtended.  # noqa: E501
        :rtype: int
        """
        return self._total
    ...
    def total(self, total):
        ...
        :param total: The total of this SmbSharesExtended.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SmbSharesExtended, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SmbSharesExtended):
            return False

...
class CreateQuotaReportResponse(object):
    ...
    def __init__(self, id=None, _configuration=None):  # noqa: E501
        """CreateQuotaReportResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this CreateQuotaReportResponse.  # noqa: E501

        ID of created item that can be used to refer to item in the collection-item resource path.  # noqa: E501

        :return: The id of this CreateQuotaReportResponse.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CreateQuotaReportResponse.

        ID of created item that can be used to refer to item in the collection-item resource path.  # noqa: E501

        :param id: The id of this CreateQuotaReportResponse.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateQuotaReportResponse):
            return False

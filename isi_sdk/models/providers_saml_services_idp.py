...
class ProvidersSamlServicesIdp(object):
    ...
    def __init__(self, entity_id=None, id=None, login=None, logout=None, metadata=None, metadata_location=None, signing_certificate=None, signing_certificate_path=None, _configuration=None):  # noqa: E501
    ...
    def metadata(self, metadata):
        ...
        """
        if (self._configuration.client_side_validation and
                metadata is not None and len(metadata) > 8000000):
    ...
    def signing_certificate(self, signing_certificate):
        ...
        """
        if (self._configuration.client_side_validation and
                signing_certificate is not None and len(signing_certificate) > 32768):
            raise ValueError("Invalid value for `signing_certificate`, length must be less than or equal to `32768`")  # noqa: E501
        if (self._configuration.client_side_validation and
                signing_certificate is not None and len(signing_certificate) < 0):
    ...
    def signing_certificate_path(self, signing_certificate_path):
        ...
        """
        if (self._configuration.client_side_validation and
                signing_certificate_path is not None and len(signing_certificate_path) > 4096):
            raise ValueError("Invalid value for `signing_certificate_path`, length must be less than or equal to `4096`")  # noqa: E501
        if (self._configuration.client_side_validation and
                signing_certificate_path is not None and len(signing_certificate_path) < 0):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProvidersSamlServicesIdp, dict):

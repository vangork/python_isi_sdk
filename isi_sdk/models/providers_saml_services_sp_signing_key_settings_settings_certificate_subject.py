...
class ProvidersSamlServicesSpSigningKeySettingsSettingsCertificateSubject(object):
    ...
    def __init__(self, common_name=None, country=None, locality=None, organization_units=None, organizations=None, state_or_province=None, _configuration=None):  # noqa: E501
    ...
    def locality(self, locality):
        ...
        if (self._configuration.client_side_validation and
                locality is not None and len(locality) < 1):
    ...
    def state_or_province(self, state_or_province):
        ...
        """
        if (self._configuration.client_side_validation and
                state_or_province is not None and len(state_or_province) > 128):
            raise ValueError("Invalid value for `state_or_province`, length must be less than or equal to `128`")  # noqa: E501
        if (self._configuration.client_side_validation and
                state_or_province is not None and len(state_or_province) < 1):

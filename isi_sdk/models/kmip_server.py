...
class KmipServer(object):
    ...
    def tls_ciphers(self):
        """Gets the tls_ciphers of this KmipServer.  # noqa: E501

        TLS cipher suite to use for communication with the KMIP server.  # noqa: E501

        :return: The tls_ciphers of this KmipServer.  # noqa: E501
        :rtype: str
        """
    ...
    def tls_ciphers(self, tls_ciphers):
        """Sets the tls_ciphers of this KmipServer.

        TLS cipher suite to use for communication with the KMIP server.  # noqa: E501

        :param tls_ciphers: The tls_ciphers of this KmipServer.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and

...
class FsaSettingsSettings(object):
    ...
    def __init__(self, default_template=None, disk_usage_depth=None, max_age=None, max_count=None, squash_depth=None, top_n_max=None, use_snapshot=None, _configuration=None):  # noqa: E501

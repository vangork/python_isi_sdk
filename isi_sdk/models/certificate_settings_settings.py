...
class CertificateSettingsSettings(object):
    ...
    def __init__(self, certificate_monitor_enabled=None, certificate_pre_expiration_threshold=None, default_https_certificate=None, _configuration=None):  # noqa: E501
    ...
    def certificate_monitor_enabled(self, certificate_monitor_enabled):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and certificate_monitor_enabled is None:
    ...
    def certificate_pre_expiration_threshold(self, certificate_pre_expiration_threshold):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and certificate_pre_expiration_threshold is None:
            raise ValueError("Invalid value for `certificate_pre_expiration_threshold`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                certificate_pre_expiration_threshold is not None and certificate_pre_expiration_threshold > 4294967295):  # noqa: E501
        ...
        if (self._configuration.client_side_validation and
                certificate_pre_expiration_threshold is not None and certificate_pre_expiration_threshold < 0):  # noqa: E501
    ...
    def default_https_certificate(self, default_https_certificate):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and default_https_certificate is None:
            raise ValueError("Invalid value for `default_https_certificate`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                default_https_certificate is not None and len(default_https_certificate) > 512):
            raise ValueError("Invalid value for `default_https_certificate`, length must be less than or equal to `512`")  # noqa: E501
        if (self._configuration.client_side_validation and
                default_https_certificate is not None and len(default_https_certificate) < 1):

...
class QuotaLicense(object):
    ...
    def __init__(self, days_since_expiry=None, days_to_expiry=None, expiration=None, expired_alert=None, expiring_alert=None, id=None, name=None, status=None, tiers=None, _configuration=None):  # noqa: E501
        """QuotaLicense - a model defined in Swagger"""  # noqa: E501
    ...
    def days_since_expiry(self):
        """Gets the days_since_expiry of this QuotaLicense.  # noqa: E501

        Number of days since a license expired.  # noqa: E501

        :return: The days_since_expiry of this QuotaLicense.  # noqa: E501
        :rtype: int
        """
    ...
    def days_since_expiry(self, days_since_expiry):
        """Sets the days_since_expiry of this QuotaLicense.

        Number of days since a license expired.  # noqa: E501

        :param days_since_expiry: The days_since_expiry of this QuotaLicense.  # noqa: E501
        :type: int
        """
    ...
    def days_to_expiry(self):
        """Gets the days_to_expiry of this QuotaLicense.  # noqa: E501

        Number of days before a license expires.  # noqa: E501

        :return: The days_to_expiry of this QuotaLicense.  # noqa: E501
        :rtype: int
        """
    ...
    def days_to_expiry(self, days_to_expiry):
        """Sets the days_to_expiry of this QuotaLicense.

        Number of days before a license expires.  # noqa: E501

        :param days_to_expiry: The days_to_expiry of this QuotaLicense.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def expiration(self):
        """Gets the expiration of this QuotaLicense.  # noqa: E501
        ...
        :return: The expiration of this QuotaLicense.  # noqa: E501
        :rtype: str
        """
    ...
    def expiration(self, expiration):
        """Sets the expiration of this QuotaLicense.

        Date of license expiry. Format is YYYY-MM-DD. It is not included if there is no expiration. Feature is considered expired at end of this day. The cluster time is used to determine expiry.  # noqa: E501

        :param expiration: The expiration of this QuotaLicense.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def expired_alert(self):
        """Gets the expired_alert of this QuotaLicense.  # noqa: E501

        True when we are generating an alert that this feature has expired.  # noqa: E501

        :return: The expired_alert of this QuotaLicense.  # noqa: E501
        :rtype: bool
        """
    ...
    def expired_alert(self, expired_alert):
        """Sets the expired_alert of this QuotaLicense.

        True when we are generating an alert that this feature has expired.  # noqa: E501

        :param expired_alert: The expired_alert of this QuotaLicense.  # noqa: E501
        :type: bool
        """
    ...
    def expiring_alert(self):
        """Gets the expiring_alert of this QuotaLicense.  # noqa: E501

        True when we are generating an alert that this feature is expiring.  # noqa: E501

        :return: The expiring_alert of this QuotaLicense.  # noqa: E501
        :rtype: bool
        """
    ...
    def expiring_alert(self, expiring_alert):
        """Sets the expiring_alert of this QuotaLicense.

        True when we are generating an alert that this feature is expiring.  # noqa: E501

        :param expiring_alert: The expiring_alert of this QuotaLicense.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def id(self):
        """Gets the id of this QuotaLicense.  # noqa: E501

        Name of the licensed feature.  # noqa: E501

        :return: The id of this QuotaLicense.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this QuotaLicense.

        Name of the licensed feature.  # noqa: E501

        :param id: The id of this QuotaLicense.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this QuotaLicense.  # noqa: E501

        Name of the licensed feature.  # noqa: E501

        :return: The name of this QuotaLicense.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this QuotaLicense.

        Name of the licensed feature.  # noqa: E501

        :param name: The name of this QuotaLicense.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this QuotaLicense.  # noqa: E501

        Current status of the license.  # noqa: E501

        :return: The status of this QuotaLicense.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this QuotaLicense.

        Current status of the license.  # noqa: E501

        :param status: The status of this QuotaLicense.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tiers(self):
        """Gets the tiers of this QuotaLicense.  # noqa: E501

        Tiered License details.  # noqa: E501

        :return: The tiers of this QuotaLicense.  # noqa: E501
        :rtype: list[QuotaLicenseTier]
        """
        return self._tiers

    @tiers.setter
    def tiers(self, tiers):
        """Sets the tiers of this QuotaLicense.

        Tiered License details.  # noqa: E501

        :param tiers: The tiers of this QuotaLicense.  # noqa: E501
        :type: list[QuotaLicenseTier]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(QuotaLicense, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QuotaLicense):
            return False

...
class EventAlertCondition(object):
    ...
    swagger_types = {
        ...
        'exclude_eventgroup_ids': 'list[str]',
        'interval': 'int',
        'limit': 'int',
        'severities': 'list[str]',
        'transient': 'int'
    ...
    attribute_map = {
        ...
        'exclude_eventgroup_ids': 'exclude_eventgroup_ids',
        'interval': 'interval',
        'limit': 'limit',
    ...
    def __init__(self, categories=None, channels=None, condition=None, eventgroup_ids=None, exclude_eventgroup_ids=None, interval=None, limit=None, severities=None, transient=None, _configuration=None):  # noqa: E501
        ...
        self._exclude_eventgroup_ids = None
        self._interval = None
        self._limit = None
        ...
        if exclude_eventgroup_ids is not None:
            self.exclude_eventgroup_ids = exclude_eventgroup_ids
    ...
    def categories(self, categories):
        ...
        :type: list[str]
        """
        allowed_values = ["all", "SYS_DISK_EVENTS", "100000000", "NODE_STATUS_EVENTS", "200000000", "REBOOT_EVENTS", "300000000", "SW_EVENTS", "400000000", "QUOTA_EVENTS", "500000000", "SNAP_EVENTS", "600000000", "WINNET_EVENTS", "700000000", "FILESYS_EVENTS", "800000000", "HW_EVENTS", "900000000", "CPOOL_EVENTS", "1100000000", "SYSTEM_ADMIN", "9800000000", "DELL_SUPPORT", "9900000000"]  # noqa: E501
    ...
    @property
    def channels(self):
        """Gets the channels of this EventAlertCondition.  # noqa: E501

        Channels for alert.  # noqa: E501

        :return: The channels of this EventAlertCondition.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def channels(self, channels):
        """Sets the channels of this EventAlertCondition.

        Channels for alert.  # noqa: E501

        :param channels: The channels of this EventAlertCondition.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def exclude_eventgroup_ids(self):
        """Gets the exclude_eventgroup_ids of this EventAlertCondition.  # noqa: E501

        Event Group categories to be excluded from alerts.  # noqa: E501

        :return: The exclude_eventgroup_ids of this EventAlertCondition.  # noqa: E501
        :rtype: list[str]
        """
        return self._exclude_eventgroup_ids

    @exclude_eventgroup_ids.setter
    def exclude_eventgroup_ids(self, exclude_eventgroup_ids):
        """Sets the exclude_eventgroup_ids of this EventAlertCondition.

        Event Group categories to be excluded from alerts.  # noqa: E501

        :param exclude_eventgroup_ids: The exclude_eventgroup_ids of this EventAlertCondition.  # noqa: E501
        :type: list[str]
        """

        self._exclude_eventgroup_ids = exclude_eventgroup_ids
    ...
    def interval(self, interval):
        ...
        """
        if (self._configuration.client_side_validation and
                interval is not None and interval > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `interval`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
    ...
    def limit(self, limit):
        ...
        """
        if (self._configuration.client_side_validation and
                limit is not None and limit > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `limit`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
    ...
    def severities(self, severities):
        ...
        if (self._configuration.client_side_validation and
                not set(severities).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
    ...
    def transient(self, transient):
        ...
        """
        if (self._configuration.client_side_validation and
                transient is not None and transient > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `transient`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                transient is not None and transient < 0):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EventAlertCondition, dict):

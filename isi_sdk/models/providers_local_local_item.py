...
class ProvidersLocalLocalItem(object):
    ...
    def lockout_duration(self, lockout_duration):
        ...
        """
        if (self._configuration.client_side_validation and
                lockout_duration is not None and lockout_duration > 5999940):  # noqa: E501
            raise ValueError("Invalid value for `lockout_duration`, must be a value less than or equal to `5999940`")  # noqa: E501
        if (self._configuration.client_side_validation and
                lockout_duration is not None and lockout_duration < 0):  # noqa: E501
    ...
    def lockout_threshold(self, lockout_threshold):
        ...
        """
        if (self._configuration.client_side_validation and
                lockout_threshold is not None and lockout_threshold > 999):  # noqa: E501
            raise ValueError("Invalid value for `lockout_threshold`, must be a value less than or equal to `999`")  # noqa: E501
        if (self._configuration.client_side_validation and
                lockout_threshold is not None and lockout_threshold < 0):  # noqa: E501
    ...
    def lockout_window(self, lockout_window):
        ...
        """
        if (self._configuration.client_side_validation and
                lockout_window is not None and lockout_window > 5999940):  # noqa: E501
            raise ValueError("Invalid value for `lockout_window`, must be a value less than or equal to `5999940`")  # noqa: E501
        if (self._configuration.client_side_validation and
                lockout_window is not None and lockout_window < 0):  # noqa: E501
    ...
    def machine_name(self, machine_name):
        ...
        """
        if (self._configuration.client_side_validation and
                machine_name is not None and len(machine_name) > 255):
    ...
    def max_inactivity_days(self):
        """Gets the max_inactivity_days of this ProvidersLocalLocalItem.  # noqa: E501

        Specifies the maximum number of days a user account can be inactive before it will be disabled.  # noqa: E501

        :return: The max_inactivity_days of this ProvidersLocalLocalItem.  # noqa: E501
        :rtype: int
        """
    ...
    def max_inactivity_days(self, max_inactivity_days):
        """Sets the max_inactivity_days of this ProvidersLocalLocalItem.

        Specifies the maximum number of days a user account can be inactive before it will be disabled.  # noqa: E501

        :param max_inactivity_days: The max_inactivity_days of this ProvidersLocalLocalItem.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                max_inactivity_days is not None and max_inactivity_days > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `max_inactivity_days`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                max_inactivity_days is not None and max_inactivity_days < 0):  # noqa: E501
    ...
    def max_password_age(self, max_password_age):
        ...
        """
        if (self._configuration.client_side_validation and
                max_password_age is not None and max_password_age > 86313600):  # noqa: E501
            raise ValueError("Invalid value for `max_password_age`, must be a value less than or equal to `86313600`")  # noqa: E501
        if (self._configuration.client_side_validation and
                max_password_age is not None and max_password_age < 0):  # noqa: E501
    ...
    def min_password_age(self, min_password_age):
        ...
        """
        if (self._configuration.client_side_validation and
                min_password_age is not None and min_password_age > 86313600):  # noqa: E501
            raise ValueError("Invalid value for `min_password_age`, must be a value less than or equal to `86313600`")  # noqa: E501
        if (self._configuration.client_side_validation and
                min_password_age is not None and min_password_age < 0):  # noqa: E501
    ...
    def min_password_length(self, min_password_length):
        ...
        """
        if (self._configuration.client_side_validation and
                min_password_length is not None and min_password_length > 256):  # noqa: E501
            raise ValueError("Invalid value for `min_password_length`, must be a value less than or equal to `256`")  # noqa: E501
        if (self._configuration.client_side_validation and
                min_password_length is not None and min_password_length < 0):  # noqa: E501
    ...
    def password_chars_changed(self):
        """Gets the password_chars_changed of this ProvidersLocalLocalItem.  # noqa: E501

        Specifies the minimum number of characters changed when a password is updated.  # noqa: E501

        :return: The password_chars_changed of this ProvidersLocalLocalItem.  # noqa: E501
        :rtype: int
        """
    ...
    def password_chars_changed(self, password_chars_changed):
        """Sets the password_chars_changed of this ProvidersLocalLocalItem.

        Specifies the minimum number of characters changed when a password is updated.  # noqa: E501

        :param password_chars_changed: The password_chars_changed of this ProvidersLocalLocalItem.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                password_chars_changed is not None and password_chars_changed > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `password_chars_changed`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                password_chars_changed is not None and password_chars_changed < 0):  # noqa: E501
    ...
    def password_complexity(self, password_complexity):
        ...
        if (self._configuration.client_side_validation and
                not set(password_complexity).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
    ...
    def password_hash_type(self):
        """Gets the password_hash_type of this ProvidersLocalLocalItem.  # noqa: E501

        Specifies the password hash algorithm to use.  # noqa: E501

        :return: The password_hash_type of this ProvidersLocalLocalItem.  # noqa: E501
        :rtype: str
        """
    ...
    def password_hash_type(self, password_hash_type):
        """Sets the password_hash_type of this ProvidersLocalLocalItem.

        Specifies the password hash algorithm to use.  # noqa: E501

        :param password_hash_type: The password_hash_type of this ProvidersLocalLocalItem.  # noqa: E501
        :type: str
        """
        allowed_values = ["NTHash", "SHA256", "SHA512"]  # noqa: E501
        if (self._configuration.client_side_validation and
                password_hash_type not in allowed_values):
            raise ValueError(
                "Invalid value for `password_hash_type` ({0}), must be one of {1}"  # noqa: E501
                .format(password_hash_type, allowed_values)
            )
    ...
    def password_history_length(self, password_history_length):
        ...
        """
        if (self._configuration.client_side_validation and
                password_history_length is not None and password_history_length > 24):  # noqa: E501
            raise ValueError("Invalid value for `password_history_length`, must be a value less than or equal to `24`")  # noqa: E501
        if (self._configuration.client_side_validation and
                password_history_length is not None and password_history_length < 0):  # noqa: E501
    ...
    def password_percent_changed(self):
        """Gets the password_percent_changed of this ProvidersLocalLocalItem.  # noqa: E501

        Specifies the minimum percent of characters changed when a password is updated.  # noqa: E501

        :return: The password_percent_changed of this ProvidersLocalLocalItem.  # noqa: E501
        :rtype: int
        """
    ...
    def password_percent_changed(self, password_percent_changed):
        """Sets the password_percent_changed of this ProvidersLocalLocalItem.

        Specifies the minimum percent of characters changed when a password is updated.  # noqa: E501

        :param password_percent_changed: The password_percent_changed of this ProvidersLocalLocalItem.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                password_percent_changed is not None and password_percent_changed > 100):  # noqa: E501
            raise ValueError("Invalid value for `password_percent_changed`, must be a value less than or equal to `100`")  # noqa: E501
        if (self._configuration.client_side_validation and
                password_percent_changed is not None and password_percent_changed < 0):  # noqa: E501
    ...
    def password_prompt_time(self, password_prompt_time):
        ...
        """
        if (self._configuration.client_side_validation and
                password_prompt_time is not None and password_prompt_time > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `password_prompt_time`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                password_prompt_time is not None and password_prompt_time < 0):  # noqa: E501

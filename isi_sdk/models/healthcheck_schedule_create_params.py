...
class HealthcheckScheduleCreateParams(object):
    ...
    def __init__(self, checklist=None, id=None, name=None, schedule=None, _configuration=None):  # noqa: E501
    ...
    def checklist(self, checklist):
        ...
        :type: list[str]
        """
        if self._configuration.client_side_validation and checklist is None:

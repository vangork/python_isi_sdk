...
class InternalNetworksPreferredNetwork(object):
    ...
    def __init__(self, high_lnn=None, low_lnn=None, preferred_network=None, _configuration=None):  # noqa: E501

...
class DatamoverPolicyPolicySpecificAttrCopyPolicyDatasetCopyPolicyBase(object):
    ...
    def __init__(self, base_account_id=None, copy_retention=None, new_tasks_account=None, source_account_id=None, target_account_id=None, target_base_path=None, target_dataset_type=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DatamoverPolicyPolicySpecificAttrCopyPolicyDatasetCopyPolicyBase, dict):

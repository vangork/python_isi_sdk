...
class DatamoverPolicyPolicySpecificAttrCopyPolicyExtended(object):
    ...
    def __init__(self, create_dataset_on_target=None, dataset_copy_policy_base=None, dataset_id=None, source_base_path=None, source_subpaths=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DatamoverPolicyPolicySpecificAttrCopyPolicyExtended, dict):

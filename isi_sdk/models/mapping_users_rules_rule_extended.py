...
class MappingUsersRulesRuleExtended(object):
    ...
    def __init__(self, operator=None, options=None, user1=None, user2=None, _configuration=None):  # noqa: E501
    ...
    def user1(self, user1):
        ...
        """
        if self._configuration.client_side_validation and user1 is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MappingUsersRulesRuleExtended, dict):

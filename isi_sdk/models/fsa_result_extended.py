...
class FsaResultExtended(object):
    ...
    def __init__(self, begin_time=None, content_path=None, delete_link=None, end_time=None, fsa_state=None, id=None, job_state=None, properties_link=None, size=None, version=None, _configuration=None):  # noqa: E501
    ...
    def fsa_state(self, fsa_state):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and fsa_state is None:
        ...
        if (self._configuration.client_side_validation and
                fsa_state not in allowed_values):
            raise ValueError(
    ...
    def job_state(self, job_state):
        ...
        :type: list[str]
        """
        if self._configuration.client_side_validation and job_state is None:
    ...
    def properties_link(self, properties_link):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and properties_link is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FsaResultExtended, dict):

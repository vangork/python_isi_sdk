...
class NfsNlmSessionsSession(object):
    ...
    def __init__(self, cluster_ip=None, delegates=None, host_type=None, hostname=None, id=None, is_active=None, last_modified=None, notify_attempts_remaining=None, notify_error=None, notify_last_attempt=None, zone=None, _configuration=None):  # noqa: E501
    ...
    def host_type(self, host_type):
        ...
        if (self._configuration.client_side_validation and
                host_type not in allowed_values):
            raise ValueError(

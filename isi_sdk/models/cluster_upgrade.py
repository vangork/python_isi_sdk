...
class ClusterUpgrade(object):
    ...
    def __init__(self, nodes_to_rolling_upgrade=None, _configuration=None):  # noqa: E501
        """ClusterUpgrade - a model defined in Swagger"""  # noqa: E501
    ...
    def nodes_to_rolling_upgrade(self):
        """Gets the nodes_to_rolling_upgrade of this ClusterUpgrade.  # noqa: E501

        The nodes (to be) scheduled for an existing upgrade ordered by queue position number: [<lnn-1>, <lnn-2>, ... ]  # noqa: E501

        :return: The nodes_to_rolling_upgrade of this ClusterUpgrade.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def nodes_to_rolling_upgrade(self, nodes_to_rolling_upgrade):
        ...
        :param nodes_to_rolling_upgrade: The nodes_to_rolling_upgrade of this ClusterUpgrade.  # noqa: E501
        :type: list[int]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterUpgrade):
            return False

...
class AuthGroupExtended(object):
    ...
    def __init__(self, dn=None, dns_domain=None, domain=None, generated_gid=None, gid=None, id=None, member_of=None, name=None, object_history=None, provider=None, sam_account_name=None, sid=None, type=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AuthGroupExtended, dict):

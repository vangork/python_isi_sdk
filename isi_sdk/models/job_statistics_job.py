...
class JobStatisticsJob(object):
    ...
    def __init__(self, job_id=None, nodes=None, phase=None, total_nodes=None, _configuration=None):  # noqa: E501
    ...
    def total_nodes(self, total_nodes):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and total_nodes is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(JobStatisticsJob, dict):

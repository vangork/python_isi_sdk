...
class EventSettingsSettings(object):
    ...
    def __init__(self, heartbeat_interval=None, retention_days=None, storage_limit=None, _configuration=None):  # noqa: E501
    ...
    def heartbeat_interval(self, heartbeat_interval):
        ...
        if (self._configuration.client_side_validation and
                heartbeat_interval is not None and len(heartbeat_interval) > 255):
            raise ValueError("Invalid value for `heartbeat_interval`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                heartbeat_interval is not None and len(heartbeat_interval) < 1):
    ...
    def retention_days(self, retention_days):
        ...
        """
        if (self._configuration.client_side_validation and
                retention_days is not None and retention_days > 9007199254740991):  # noqa: E501
    ...
    def storage_limit(self, storage_limit):
        ...
        """
        if (self._configuration.client_side_validation and
                storage_limit is not None and storage_limit > 100):  # noqa: E501
            raise ValueError("Invalid value for `storage_limit`, must be a value less than or equal to `100`")  # noqa: E501
        if (self._configuration.client_side_validation and
                storage_limit is not None and storage_limit < 1):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EventSettingsSettings, dict):

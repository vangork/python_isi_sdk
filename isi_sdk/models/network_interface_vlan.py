...
class NetworkInterfaceVlan(object):
    ...
    def __init__(self, flags=None, id=None, ip_addrs=None, ipv4_gateway=None, ipv6_gateway=None, lnn=None, mtu=None, name=None, nic_name=None, status=None, type=None, vlan_id=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NetworkInterfaceVlan, dict):

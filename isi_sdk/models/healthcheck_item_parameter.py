...
class HealthcheckItemParameter(object):
    ...
    def __init__(self, default=None, description=None, mandatory=None, name=None, _configuration=None):  # noqa: E501
    ...
    def default(self, default):
        ...
        if (self._configuration.client_side_validation and
                default is not None and len(default) > 255):
            raise ValueError("Invalid value for `default`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                default is not None and len(default) < 0):
            raise ValueError("Invalid value for `default`, length must be greater than or equal to `0`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HealthcheckItemParameter, dict):

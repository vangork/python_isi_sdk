...
class QuotaQuotaExtended(object):
    ...
    def __init__(self, container=None, description=None, efficiency_ratio=None, enforced=None, id=None, include_snapshots=None, labels=None, linked=None, notifications=None, path=None, persona=None, ready=None, reduction_ratio=None, thresholds=None, thresholds_on=None, type=None, usage=None, _configuration=None):  # noqa: E501
    ...
    def description(self):
        """Gets the description of this QuotaQuotaExtended.  # noqa: E501

        User settable free form text description of the quota.  # noqa: E501

        :return: The description of this QuotaQuotaExtended.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this QuotaQuotaExtended.
    ...
    def efficiency_ratio(self, efficiency_ratio):
        ...
        """
        if (self._configuration.client_side_validation and
                efficiency_ratio is not None and efficiency_ratio > 1.79769E+308):  # noqa: E501
            raise ValueError("Invalid value for `efficiency_ratio`, must be a value less than or equal to `1.79769E+308`")  # noqa: E501
        if (self._configuration.client_side_validation and
                efficiency_ratio is not None and efficiency_ratio < 0.0):  # noqa: E501
    ...
    def enforced(self, enforced):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and enforced is None:
    ...
    def include_snapshots(self, include_snapshots):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and include_snapshots is None:
    ...
    @property
    def labels(self):
        """Gets the labels of this QuotaQuotaExtended.  # noqa: E501

        Tags to identify a quota domain.  # noqa: E501

        :return: The labels of this QuotaQuotaExtended.  # noqa: E501
        :rtype: str
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this QuotaQuotaExtended.
        ...
        """
        if (self._configuration.client_side_validation and
                labels is not None and len(labels) > 1024):
    ...
    def notifications(self, notifications):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and notifications is None:
        ...
        if (self._configuration.client_side_validation and
                notifications not in allowed_values):
            raise ValueError(
    ...
    def reduction_ratio(self, reduction_ratio):
        ...
        """
        if (self._configuration.client_side_validation and
                reduction_ratio is not None and reduction_ratio > 1.79769E+308):  # noqa: E501
            raise ValueError("Invalid value for `reduction_ratio`, must be a value less than or equal to `1.79769E+308`")  # noqa: E501
        if (self._configuration.client_side_validation and
                reduction_ratio is not None and reduction_ratio < 0.0):  # noqa: E501
    ...
    def thresholds_on(self, thresholds_on):
        ...
        if (self._configuration.client_side_validation and
                thresholds_on not in allowed_values):
            raise ValueError(
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(QuotaQuotaExtended, dict):

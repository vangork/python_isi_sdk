...
class SnapshotWritableItem(object):
    ...
    def __init__(self, dst_path=None, src_snap=None, _configuration=None):  # noqa: E501
    ...
    def src_snap(self, src_snap):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and src_snap is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SnapshotWritableItem, dict):

...
class NdmpContextsBackupContext(object):
    ...
    def __init__(self, context_expiration_time=None, context_id=None, id=None, lead_session_id=None, multistream=None, path=None, sessions=None, snapid=None, start_time=None, status=None, total_sessions=None, type=None, _configuration=None):  # noqa: E501

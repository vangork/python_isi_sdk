...
class AuditLogsDeletionItem(object):
    ...
    def __init__(self, deleted_files=None, lnn=None, space_freed=None, _configuration=None):  # noqa: E501
    ...
    def deleted_files(self, deleted_files):
        ...
        if (self._configuration.client_side_validation and
                deleted_files is not None and deleted_files > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `deleted_files`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                deleted_files is not None and deleted_files < 0):  # noqa: E501

...
class ClusterEmailSettings(object):
    ...
    def __init__(self, batch_mode=None, mail_relay=None, mail_sender=None, mail_subject=None, smtp_auth_passwd_set=None, smtp_auth_security=None, smtp_auth_username=None, smtp_port=None, use_smtp_auth=None, user_template=None, _configuration=None):  # noqa: E501
    ...
    def batch_mode(self, batch_mode):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and batch_mode is None:
        ...
        if (self._configuration.client_side_validation and
                batch_mode not in allowed_values):
            raise ValueError(
    ...
    def mail_relay(self, mail_relay):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and mail_relay is None:
            raise ValueError("Invalid value for `mail_relay`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                mail_relay is not None and not re.search(r'(^$|^((([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])(\\.([a-zA-Z0-9_][a-zA-Z0-9-]{0,61})?[a-zA-Z0-9])*)$|^([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])(\\.([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])){3}$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5}::([0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){0,5})?$|^[0-9A-Fa-f]{1,4}(:[0-9A-Fa-f]{1,4}){7}$)', mail_relay)):  # noqa: E501
    ...
    def mail_sender(self, mail_sender):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and mail_sender is None:
            raise ValueError("Invalid value for `mail_sender`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                mail_sender is not None and len(mail_sender) > 254):
    ...
    def smtp_auth_passwd_set(self, smtp_auth_passwd_set):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and smtp_auth_passwd_set is None:
    ...
    def smtp_auth_security(self, smtp_auth_security):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and smtp_auth_security is None:
            raise ValueError("Invalid value for `smtp_auth_security`, must not be `None`")  # noqa: E501
        allowed_values = ["none", "starttls", "smtps"]  # noqa: E501
        if (self._configuration.client_side_validation and
                smtp_auth_security not in allowed_values):
            raise ValueError(
    ...
    def smtp_auth_username(self, smtp_auth_username):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and smtp_auth_username is None:
            raise ValueError("Invalid value for `smtp_auth_username`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                smtp_auth_username is not None and len(smtp_auth_username) > 256):
    ...
    def smtp_port(self, smtp_port):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and smtp_port is None:
        ...
        if (self._configuration.client_side_validation and
                smtp_port is not None and smtp_port < 0):  # noqa: E501
    ...
    def use_smtp_auth(self, use_smtp_auth):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and use_smtp_auth is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClusterEmailSettings, dict):

...
class QuotaLicenseTier(object):
    ...
    def __init__(self, entitlements_exceeded_alerts=None, licensed_drive_capacity=None, licensed_node_count=None, licensed_nodes_with_seds_count=None, tier=None, used_drive_capacity=None, used_node_count=None, used_nodes_with_seds_count=None, _configuration=None):  # noqa: E501
        """QuotaLicenseTier - a model defined in Swagger"""  # noqa: E501
    ...
    def entitlements_exceeded_alerts(self):
        """Gets the entitlements_exceeded_alerts of this QuotaLicenseTier.  # noqa: E501
        ...
        :return: The entitlements_exceeded_alerts of this QuotaLicenseTier.  # noqa: E501
    ...
    def entitlements_exceeded_alerts(self, entitlements_exceeded_alerts):
        """Sets the entitlements_exceeded_alerts of this QuotaLicenseTier.

        List of alerts about exceeded entitlements: The following alerts appear when usage of a resource such as a node, an encryption node, or storage capacity exceeds the quantity licensed for that resource.  # noqa: E501

        :param entitlements_exceeded_alerts: The entitlements_exceeded_alerts of this QuotaLicenseTier.  # noqa: E501
    ...
    def licensed_drive_capacity(self):
        """Gets the licensed_drive_capacity of this QuotaLicenseTier.  # noqa: E501
        ...
        :return: The licensed_drive_capacity of this QuotaLicenseTier.  # noqa: E501
        :rtype: int
        """
    ...
    def licensed_drive_capacity(self, licensed_drive_capacity):
        """Sets the licensed_drive_capacity of this QuotaLicenseTier.

        Licensed terabyte (TB, 10^12 bytes) drive capacity allocated as storage associated with tier. Included if tier is not NONINF and license is not a base only license.  # noqa: E501

        :param licensed_drive_capacity: The licensed_drive_capacity of this QuotaLicenseTier.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                licensed_drive_capacity is not None and licensed_drive_capacity > 2147483647):  # noqa: E501
            raise ValueError("Invalid value for `licensed_drive_capacity`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self._configuration.client_side_validation and
                licensed_drive_capacity is not None and licensed_drive_capacity < 0):  # noqa: E501
    ...
    def licensed_node_count(self):
        """Gets the licensed_node_count of this QuotaLicenseTier.  # noqa: E501

        Licensed number of nodes in this tier.  # noqa: E501

        :return: The licensed_node_count of this QuotaLicenseTier.  # noqa: E501
        :rtype: int
        """
    ...
    def licensed_node_count(self, licensed_node_count):
        """Sets the licensed_node_count of this QuotaLicenseTier.

        Licensed number of nodes in this tier.  # noqa: E501

        :param licensed_node_count: The licensed_node_count of this QuotaLicenseTier.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                licensed_node_count is not None and licensed_node_count > 2147483647):  # noqa: E501
            raise ValueError("Invalid value for `licensed_node_count`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self._configuration.client_side_validation and
                licensed_node_count is not None and licensed_node_count < 0):  # noqa: E501
    ...
    def licensed_nodes_with_seds_count(self):
        """Gets the licensed_nodes_with_seds_count of this QuotaLicenseTier.  # noqa: E501
        ...
        :return: The licensed_nodes_with_seds_count of this QuotaLicenseTier.  # noqa: E501
        :rtype: int
        """
    ...
    def licensed_nodes_with_seds_count(self, licensed_nodes_with_seds_count):
        """Sets the licensed_nodes_with_seds_count of this QuotaLicenseTier.

        Licensed number of nodes of this tier that contain self-encrypting drives. Included only if license is ONEFS and tier is not NONINF.  # noqa: E501

        :param licensed_nodes_with_seds_count: The licensed_nodes_with_seds_count of this QuotaLicenseTier.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                licensed_nodes_with_seds_count is not None and licensed_nodes_with_seds_count > 2147483647):  # noqa: E501
        ...
        if (self._configuration.client_side_validation and
                licensed_nodes_with_seds_count is not None and licensed_nodes_with_seds_count < 0):  # noqa: E501
    ...
    @property
    def tier(self):
        """Gets the tier of this QuotaLicenseTier.  # noqa: E501
        ...
        :return: The tier of this QuotaLicenseTier.  # noqa: E501
        :rtype: str
        """
        return self._tier
    ...
    @tier.setter
    def tier(self, tier):
        """Sets the tier of this QuotaLicenseTier.

        OneFS hardware tier. Tier is a number, NONINF, or NO_TIER. NONINF indicates a non infinity tier. NO_TIER indicates a license that is not tier based.  # noqa: E501

        :param tier: The tier of this QuotaLicenseTier.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                tier is not None and len(tier) > 50):
            raise ValueError("Invalid value for `tier`, length must be less than or equal to `50`")  # noqa: E501
        if (self._configuration.client_side_validation and
                tier is not None and len(tier) < 1):
            raise ValueError("Invalid value for `tier`, length must be greater than or equal to `1`")  # noqa: E501
        if (self._configuration.client_side_validation and
                tier is not None and not re.search(r'^NONINF$|^NO_TIER$|^[0-9]+$', tier)):  # noqa: E501
            raise ValueError(r"Invalid value for `tier`, must be a follow pattern or equal to `/^NONINF$|^NO_TIER$|^[0-9]+$/`")  # noqa: E501

        self._tier = tier

    @property
    def used_drive_capacity(self):
        """Gets the used_drive_capacity of this QuotaLicenseTier.  # noqa: E501
        ...
        :return: The used_drive_capacity of this QuotaLicenseTier.  # noqa: E501
        :rtype: int
        """
    ...
    def used_drive_capacity(self, used_drive_capacity):
        """Sets the used_drive_capacity of this QuotaLicenseTier.

        Actual terabyte (TB, 10^12 bytes) drive capacity allocated as storage space associated with tier. Included if tier is not NONINF and license is not a base only license.  # noqa: E501

        :param used_drive_capacity: The used_drive_capacity of this QuotaLicenseTier.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                used_drive_capacity is not None and used_drive_capacity > 2147483647):  # noqa: E501
            raise ValueError("Invalid value for `used_drive_capacity`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self._configuration.client_side_validation and
                used_drive_capacity is not None and used_drive_capacity < 0):  # noqa: E501
    ...
    def used_node_count(self):
        """Gets the used_node_count of this QuotaLicenseTier.  # noqa: E501

        Actual number of nodes in this tier.  # noqa: E501

        :return: The used_node_count of this QuotaLicenseTier.  # noqa: E501
        :rtype: int
        """
    ...
    def used_node_count(self, used_node_count):
        """Sets the used_node_count of this QuotaLicenseTier.

        Actual number of nodes in this tier.  # noqa: E501

        :param used_node_count: The used_node_count of this QuotaLicenseTier.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                used_node_count is not None and used_node_count > 2147483647):  # noqa: E501
            raise ValueError("Invalid value for `used_node_count`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self._configuration.client_side_validation and
                used_node_count is not None and used_node_count < 0):  # noqa: E501
    ...
    def used_nodes_with_seds_count(self):
        """Gets the used_nodes_with_seds_count of this QuotaLicenseTier.  # noqa: E501
        ...
        :return: The used_nodes_with_seds_count of this QuotaLicenseTier.  # noqa: E501
        :rtype: int
        """
    ...
    def used_nodes_with_seds_count(self, used_nodes_with_seds_count):
        """Sets the used_nodes_with_seds_count of this QuotaLicenseTier.

        Actual number of nodes of this tier that contain self-encrypting drives. Included only if license is ONEFS and if tier is not NONINF.  # noqa: E501

        :param used_nodes_with_seds_count: The used_nodes_with_seds_count of this QuotaLicenseTier.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                used_nodes_with_seds_count is not None and used_nodes_with_seds_count > 2147483647):  # noqa: E501
            raise ValueError("Invalid value for `used_nodes_with_seds_count`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self._configuration.client_side_validation and
                used_nodes_with_seds_count is not None and used_nodes_with_seds_count < 0):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(QuotaLicenseTier, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QuotaLicenseTier):
            return False

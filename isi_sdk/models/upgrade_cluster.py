...
class UpgradeCluster(object):
    ...
    def __init__(self, assessment_progress=None, assessment_status=None, cluster_overview=None, cluster_state=None, committed_features=None, current_process=None, finish_time=None, fw_pkg=None, fw_pkg_id=None, install_image_path=None, node_median_time=None, onefs_version_current=None, onefs_version_upgrade=None, patch_action=None, patch_name=None, start_time=None, upgrade_is_committed=None, upgrade_process_state=None, upgrade_settings=None, upgrade_triggered_time=None, _configuration=None):  # noqa: E501
        """UpgradeCluster - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._assessment_progress = None
    ...
    def assessment_progress(self):
        """Gets the assessment_progress of this UpgradeCluster.  # noqa: E501

        Progress of active upgrade assessment.  # noqa: E501

        :return: The assessment_progress of this UpgradeCluster.  # noqa: E501
        :rtype: int
        """
        return self._assessment_progress

    @assessment_progress.setter
    def assessment_progress(self, assessment_progress):
        """Sets the assessment_progress of this UpgradeCluster.

        Progress of active upgrade assessment.  # noqa: E501

        :param assessment_progress: The assessment_progress of this UpgradeCluster.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                assessment_progress is not None and assessment_progress > 100):  # noqa: E501
            raise ValueError("Invalid value for `assessment_progress`, must be a value less than or equal to `100`")  # noqa: E501
        if (self._configuration.client_side_validation and
                assessment_progress is not None and assessment_progress < 0):  # noqa: E501
            raise ValueError("Invalid value for `assessment_progress`, must be a value greater than or equal to `0`")  # noqa: E501

        self._assessment_progress = assessment_progress

    @property
    def assessment_status(self):
        """Gets the assessment_status of this UpgradeCluster.  # noqa: E501

        Status of active upgrade assessment.  # noqa: E501

        :return: The assessment_status of this UpgradeCluster.  # noqa: E501
        :rtype: str
        """
    ...
    def assessment_status(self, assessment_status):
        """Sets the assessment_status of this UpgradeCluster.

        Status of active upgrade assessment.  # noqa: E501

        :param assessment_status: The assessment_status of this UpgradeCluster.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                assessment_status is not None and len(assessment_status) > 128):
            raise ValueError("Invalid value for `assessment_status`, length must be less than or equal to `128`")  # noqa: E501
        if (self._configuration.client_side_validation and
                assessment_status is not None and len(assessment_status) < 0):
            raise ValueError("Invalid value for `assessment_status`, length must be greater than or equal to `0`")  # noqa: E501
    ...
    def cluster_state(self, cluster_state):
        ...
        """
        if (self._configuration.client_side_validation and
                cluster_state is not None and len(cluster_state) > 128):
            raise ValueError("Invalid value for `cluster_state`, length must be less than or equal to `128`")  # noqa: E501
        if (self._configuration.client_side_validation and
                cluster_state is not None and len(cluster_state) < 3):
    ...
    def current_process(self, current_process):
        ...
        """
        if (self._configuration.client_side_validation and
                current_process is not None and len(current_process) > 128):
            raise ValueError("Invalid value for `current_process`, length must be less than or equal to `128`")  # noqa: E501
        if (self._configuration.client_side_validation and
                current_process is not None and len(current_process) < 3):
    ...
    @property
    def fw_pkg(self):
        """Gets the fw_pkg of this UpgradeCluster.  # noqa: E501

        The location (path) of the firmware package which must be within /ifs.  # noqa: E501

        :return: The fw_pkg of this UpgradeCluster.  # noqa: E501
        :rtype: str
        """
        return self._fw_pkg
    ...
    def fw_pkg(self, fw_pkg):
        """Sets the fw_pkg of this UpgradeCluster.

        The location (path) of the firmware package which must be within /ifs.  # noqa: E501

        :param fw_pkg: The fw_pkg of this UpgradeCluster.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                fw_pkg is not None and len(fw_pkg) > 4096):
            raise ValueError("Invalid value for `fw_pkg`, length must be less than or equal to `4096`")  # noqa: E501
        if (self._configuration.client_side_validation and
                fw_pkg is not None and len(fw_pkg) < 3):
    ...
    @property
    def fw_pkg_id(self):
        """Gets the fw_pkg_id of this UpgradeCluster.  # noqa: E501

        The ID of the signed artifact stored in the catalog.  # noqa: E501

        :return: The fw_pkg_id of this UpgradeCluster.  # noqa: E501
        :rtype: str
        """
    ...
    def fw_pkg_id(self, fw_pkg_id):
        """Sets the fw_pkg_id of this UpgradeCluster.

        The ID of the signed artifact stored in the catalog.  # noqa: E501

        :param fw_pkg_id: The fw_pkg_id of this UpgradeCluster.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                fw_pkg_id is not None and len(fw_pkg_id) > 128):
            raise ValueError("Invalid value for `fw_pkg_id`, length must be less than or equal to `128`")  # noqa: E501
        if (self._configuration.client_side_validation and
                fw_pkg_id is not None and len(fw_pkg_id) < 1):
    ...
    def install_image_path(self, install_image_path):
        ...
        """
        if (self._configuration.client_side_validation and
                install_image_path is not None and len(install_image_path) > 4096):
            raise ValueError("Invalid value for `install_image_path`, length must be less than or equal to `4096`")  # noqa: E501
        if (self._configuration.client_side_validation and
                install_image_path is not None and len(install_image_path) < 5):
    ...
    def upgrade_process_state(self, upgrade_process_state):
        ...
        """
        if (self._configuration.client_side_validation and
                upgrade_process_state is not None and len(upgrade_process_state) > 128):
            raise ValueError("Invalid value for `upgrade_process_state`, length must be less than or equal to `128`")  # noqa: E501
        if (self._configuration.client_side_validation and
                upgrade_process_state is not None and len(upgrade_process_state) < 1):
    ...
    def upgrade_triggered_time(self, upgrade_triggered_time):
        ...
        """
        if (self._configuration.client_side_validation and
                upgrade_triggered_time is not None and len(upgrade_triggered_time) > 128):
            raise ValueError("Invalid value for `upgrade_triggered_time`, length must be less than or equal to `128`")  # noqa: E501
        if (self._configuration.client_side_validation and
                upgrade_triggered_time is not None and len(upgrade_triggered_time) < 4):
            raise ValueError("Invalid value for `upgrade_triggered_time`, length must be greater than or equal to `4`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpgradeCluster, dict):

...
class SnmpSettingsSettings(object):
    ...
    def __init__(self, read_only_community=None, service=None, snmp_v1_v2c_access=None, snmp_v3_access=None, snmp_v3_auth_protocol=None, snmp_v3_priv_protocol=None, snmp_v3_read_only_user=None, snmp_v3_security_level=None, system_contact=None, system_location=None, _configuration=None):  # noqa: E501
        """SnmpSettingsSettings - a model defined in Swagger"""  # noqa: E501
    ...
    def read_only_community(self):
        """Gets the read_only_community of this SnmpSettingsSettings.  # noqa: E501

        The read-only community name.  @DEFAULT reverts this field to its default value.  # noqa: E501

        :return: The read_only_community of this SnmpSettingsSettings.  # noqa: E501
        :rtype: str
        """
    ...
    def read_only_community(self, read_only_community):
        ...
        :param read_only_community: The read_only_community of this SnmpSettingsSettings.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                read_only_community is not None and len(read_only_community) < 1):
    ...
    @property
    def service(self):
        """Gets the service of this SnmpSettingsSettings.  # noqa: E501

        Whether the SNMP service is enabled.  # noqa: E501

        :return: The service of this SnmpSettingsSettings.  # noqa: E501
        :rtype: bool
        """
    ...
    def service(self, service):
        ...
        :param service: The service of this SnmpSettingsSettings.  # noqa: E501
        :type: bool
        """
    ...
    def snmp_v1_v2c_access(self):
        """Gets the snmp_v1_v2c_access of this SnmpSettingsSettings.  # noqa: E501

        Whether SNMP v1 and v2c protocols are enabled.  @DEFAULT reverts this field to its default value.  # noqa: E501

        :return: The snmp_v1_v2c_access of this SnmpSettingsSettings.  # noqa: E501
        :rtype: bool
        """
    ...
    def snmp_v1_v2c_access(self, snmp_v1_v2c_access):
        ...
        :param snmp_v1_v2c_access: The snmp_v1_v2c_access of this SnmpSettingsSettings.  # noqa: E501
        :type: bool
        """
    ...
    def snmp_v3_access(self):
        """Gets the snmp_v3_access of this SnmpSettingsSettings.  # noqa: E501

        Whether SNMP v3 is enabled.  @DEFAULT reverts this field to its default value.  # noqa: E501

        :return: The snmp_v3_access of this SnmpSettingsSettings.  # noqa: E501
        :rtype: bool
        """
    ...
    def snmp_v3_access(self, snmp_v3_access):
        ...
        :param snmp_v3_access: The snmp_v3_access of this SnmpSettingsSettings.  # noqa: E501
        :type: bool
        """
    ...
    def snmp_v3_auth_protocol(self):
        """Gets the snmp_v3_auth_protocol of this SnmpSettingsSettings.  # noqa: E501

        SNMPv3 authentication protocol. May only be SHA or MD5.  @DEFAULT reverts this field to its default value.  # noqa: E501

        :return: The snmp_v3_auth_protocol of this SnmpSettingsSettings.  # noqa: E501
        :rtype: str
        """
    ...
    def snmp_v3_auth_protocol(self, snmp_v3_auth_protocol):
        """Sets the snmp_v3_auth_protocol of this SnmpSettingsSettings.

        SNMPv3 authentication protocol. May only be SHA or MD5.  @DEFAULT reverts this field to its default value.  # noqa: E501

        :param snmp_v3_auth_protocol: The snmp_v3_auth_protocol of this SnmpSettingsSettings.  # noqa: E501
        :type: str
        """
        allowed_values = ["SHA", "MD5"]  # noqa: E501
        if (self._configuration.client_side_validation and
                snmp_v3_auth_protocol not in allowed_values):
            raise ValueError(
    ...
    def snmp_v3_priv_protocol(self):
        """Gets the snmp_v3_priv_protocol of this SnmpSettingsSettings.  # noqa: E501

        SNMPv3 privacy protocol. May only be AES or DES. @DEFAULT reverts this field to its default value.  # noqa: E501

        :return: The snmp_v3_priv_protocol of this SnmpSettingsSettings.  # noqa: E501
        :rtype: str
        """
    ...
    def snmp_v3_priv_protocol(self, snmp_v3_priv_protocol):
        """Sets the snmp_v3_priv_protocol of this SnmpSettingsSettings.

        SNMPv3 privacy protocol. May only be AES or DES. @DEFAULT reverts this field to its default value.  # noqa: E501

        :param snmp_v3_priv_protocol: The snmp_v3_priv_protocol of this SnmpSettingsSettings.  # noqa: E501
        :type: str
        """
        allowed_values = ["AES", "DES"]  # noqa: E501
        if (self._configuration.client_side_validation and
                snmp_v3_priv_protocol not in allowed_values):
            raise ValueError(
    ...
    def snmp_v3_read_only_user(self):
        """Gets the snmp_v3_read_only_user of this SnmpSettingsSettings.  # noqa: E501

        The read-only user for SNMP v3 read requests.  @DEFAULT reverts this field to its default value.  # noqa: E501

        :return: The snmp_v3_read_only_user of this SnmpSettingsSettings.  # noqa: E501
        :rtype: str
        """
    ...
    def snmp_v3_read_only_user(self, snmp_v3_read_only_user):
        ...
        :param snmp_v3_read_only_user: The snmp_v3_read_only_user of this SnmpSettingsSettings.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                snmp_v3_read_only_user is not None and len(snmp_v3_read_only_user) < 1):
    ...
    def snmp_v3_security_level(self):
        """Gets the snmp_v3_security_level of this SnmpSettingsSettings.  # noqa: E501

        SNMPv3 privacy protocol. May only be AES or DES. @DEFAULT reverts this field to its default value.  # noqa: E501

        :return: The snmp_v3_security_level of this SnmpSettingsSettings.  # noqa: E501
        :rtype: str
        """
    ...
    def snmp_v3_security_level(self, snmp_v3_security_level):
        """Sets the snmp_v3_security_level of this SnmpSettingsSettings.

        SNMPv3 privacy protocol. May only be AES or DES. @DEFAULT reverts this field to its default value.  # noqa: E501

        :param snmp_v3_security_level: The snmp_v3_security_level of this SnmpSettingsSettings.  # noqa: E501
        :type: str
        """
        allowed_values = ["noAuthNoPriv", "authNoPriv", "authPriv"]  # noqa: E501
        if (self._configuration.client_side_validation and
                snmp_v3_security_level not in allowed_values):
            raise ValueError(
    ...
    def system_contact(self):
        """Gets the system_contact of this SnmpSettingsSettings.  # noqa: E501
        ...
        :return: The system_contact of this SnmpSettingsSettings.  # noqa: E501
        :rtype: str
        """
    ...
    def system_contact(self, system_contact):
        ...
        :param system_contact: The system_contact of this SnmpSettingsSettings.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                system_contact is not None and len(system_contact) > 254):
            raise ValueError("Invalid value for `system_contact`, length must be less than or equal to `254`")  # noqa: E501
        if (self._configuration.client_side_validation and
                system_contact is not None and len(system_contact) < 3):
            raise ValueError("Invalid value for `system_contact`, length must be greater than or equal to `3`")  # noqa: E501
        if (self._configuration.client_side_validation and
                system_contact is not None and not re.search(r'[a-zA-Z0-9!#%&\'*+= ^_`{|}~\/?$.-]{1,64}@[a-zA-Z0-9.-]+\.[a-zA-Z]{2,63}', system_contact)):  # noqa: E501
    ...
    def system_location(self):
        """Gets the system_location of this SnmpSettingsSettings.  # noqa: E501

        A location name for the SNMP system.  @DEFAULT reverts this field to its default value.  # noqa: E501

        :return: The system_location of this SnmpSettingsSettings.  # noqa: E501
        :rtype: str
        """
    ...
    def system_location(self, system_location):
        ...
        :param system_location: The system_location of this SnmpSettingsSettings.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                system_location is not None and len(system_location) < 1):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SnmpSettingsSettings, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SnmpSettingsSettings):
            return False

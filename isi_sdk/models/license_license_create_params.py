...
class LicenseLicenseCreateParams(object):
    ...
    def __init__(self, evaluation=None, license_file_content=None, license_file_path=None, _configuration=None):  # noqa: E501

...
class CertificatesSettingsSettings(object):
    ...
    def __init__(self, enable_encryption=None, ocsp_uri=None, revocation_setting=None, strict_hostname_check=None, _configuration=None):  # noqa: E501
    ...
    def revocation_setting(self, revocation_setting):
        ...
        if (self._configuration.client_side_validation and
                revocation_setting not in allowed_values):
            raise ValueError(
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CertificatesSettingsSettings, dict):

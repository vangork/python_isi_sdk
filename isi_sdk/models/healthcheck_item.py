...
class HealthcheckItem(object):
    ...
    def __init__(self, description=None, freshness=None, id=None, node=None, parameters=None, reference=None, resolution=None, summary=None, _configuration=None):  # noqa: E501
    ...
    def freshness(self, freshness):
        ...
        """
        if (self._configuration.client_side_validation and
                freshness is not None and freshness > 9223372036854775807):  # noqa: E501
    ...
    def summary(self, summary):
        ...
        """
        if (self._configuration.client_side_validation and
                summary is not None and len(summary) > 8192):

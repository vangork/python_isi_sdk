...
class S3Key(object):
    ...
    def __init__(self, existing_key_expiry_time=None, _configuration=None):  # noqa: E501
    ...
    def existing_key_expiry_time(self, existing_key_expiry_time):
        ...
        if (self._configuration.client_side_validation and
                existing_key_expiry_time is not None and existing_key_expiry_time > 1440):  # noqa: E501
            raise ValueError("Invalid value for `existing_key_expiry_time`, must be a value less than or equal to `1440`")  # noqa: E501
        if (self._configuration.client_side_validation and
                existing_key_expiry_time is not None and existing_key_expiry_time < 0):  # noqa: E501

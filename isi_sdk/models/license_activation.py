...
class LicenseActivation(object):
    ...
    def __init__(self, elms_errors=None, last_action_time=None, status=None, transaction_id=None, _configuration=None):  # noqa: E501
    ...
    def last_action_time(self, last_action_time):
        ...
        if (self._configuration.client_side_validation and
                last_action_time is not None and last_action_time > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `last_action_time`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                last_action_time is not None and last_action_time < 0):  # noqa: E501
    ...
    def transaction_id(self, transaction_id):
        ...
        """
        if (self._configuration.client_side_validation and
                transaction_id is not None and len(transaction_id) > 64):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LicenseActivation, dict):

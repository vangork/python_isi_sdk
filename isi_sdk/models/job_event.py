...
class JobEvent(object):
    ...
    def __init__(self, flags=None, fmt_type=None, id=None, job_id=None, job_type=None, key=None, phase=None, raw_type=None, time=None, value=None, _configuration=None):  # noqa: E501
    ...
    def raw_type(self, raw_type):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and raw_type is None:

...
class StoragepoolStatusUnhealthyItem(object):
    ...
    def __init__(self, affected=None, diskpool=None, health_flags=None, _configuration=None):  # noqa: E501
    ...
    def affected(self, affected):
        ...
        """
        if self._configuration.client_side_validation and affected is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StoragepoolStatusUnhealthyItem, dict):

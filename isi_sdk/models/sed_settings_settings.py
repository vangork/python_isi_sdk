...
class SedSettingsSettings(object):
    ...
    def __init__(self, kmip_enabled=None, kmip_server=None, supported=None, _configuration=None):  # noqa: E501
    ...
    def kmip_enabled(self, kmip_enabled):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and kmip_enabled is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SedSettingsSettings, dict):

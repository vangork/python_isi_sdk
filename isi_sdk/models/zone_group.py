...
class ZoneGroup(object):
    ...
    def __init__(self, gid=None, groupname=None, gsid=None, _configuration=None):  # noqa: E501
    ...
    def groupname(self, groupname):
        ...
        if (self._configuration.client_side_validation and
                groupname is not None and len(groupname) < 0):

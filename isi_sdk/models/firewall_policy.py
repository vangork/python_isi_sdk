...
class FirewallPolicy(object):
    ...
    def __init__(self, default_action=None, description=None, max_rules=None, name=None, pools=None, subnets=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FirewallPolicy, dict):

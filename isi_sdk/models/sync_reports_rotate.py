...
class SyncReportsRotate(object):
    ...
    def __init__(self, message=None, running=None, _configuration=None):  # noqa: E501
    ...
    def running(self, running):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and running is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SyncReportsRotate, dict):

...
class DatamoverHistoricalJobsJobJobTypeSpecificAttrsDatasetCreationJob(object):
    ...
    def __init__(self, account_id=None, base_path=None, retention=None, statistics=None, subpaths=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DatamoverHistoricalJobsJobJobTypeSpecificAttrsDatasetCreationJob, dict):

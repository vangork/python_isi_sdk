...
class SyncRuleExtendedExtended(object):
    ...
    def __init__(self, description=None, enabled=None, id=None, limit=None, schedule=None, type=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SyncRuleExtendedExtended, dict):

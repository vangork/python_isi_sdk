...
class AvscanFilterExtended(object):
    ...
    def __init__(self, file_extension_action=None, file_extensions=None, filter_enabled=None, id=None, open_on_fail=None, paths_to_exclude=None, scan_cloudpool_files=None, scan_if_no_extension=None, scan_on_close=None, scan_on_read=None, scan_on_rename=None, scan_profile=None, zone_name=None, _configuration=None):  # noqa: E501
    ...
    def scan_profile(self, scan_profile):
        ...
        if (self._configuration.client_side_validation and
                scan_profile not in allowed_values):
            raise ValueError(
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AvscanFilterExtended, dict):

...
class ProvidersAdsAdsItemExtended(object):
    ...
    def __init__(self, allocate_gids=None, allocate_uids=None, assume_default_domain=None, authentication=None, check_online_interval=None, controller_time=None, create_home_directory=None, domain_offline_alerts=None, dup_spns=None, extra_expected_spns=None, findable_groups=None, findable_users=None, forest=None, groupnet=None, home_directory_template=None, hostname=None, id=None, ignore_all_trusts=None, ignored_trusted_domains=None, include_trusted_domains=None, instance=None, ldap_sign_and_seal=None, login_shell=None, lookup_domains=None, lookup_groups=None, lookup_normalize_groups=None, lookup_normalize_users=None, lookup_users=None, machine_account=None, machine_password_changes=None, machine_password_lifespan=None, name=None, netbios_domain=None, node_dc_affinity=None, node_dc_affinity_timeout=None, nss_enumeration=None, primary_domain=None, restrict_findable=None, rpc_call_timeout=None, server_retry_limit=None, sfu_support=None, site=None, status=None, store_sfu_mappings=None, system=None, unfindable_groups=None, unfindable_users=None, zone_name=None, _configuration=None):  # noqa: E501
        ...
        if dup_spns is not None:
            self.dup_spns = dup_spns
    ...
    def check_online_interval(self, check_online_interval):
        ...
        if (self._configuration.client_side_validation and
                check_online_interval is not None and check_online_interval > 86400):  # noqa: E501
            raise ValueError("Invalid value for `check_online_interval`, must be a value less than or equal to `86400`")  # noqa: E501
        if (self._configuration.client_side_validation and
                check_online_interval is not None and check_online_interval < 30):  # noqa: E501
    ...
    def controller_time(self, controller_time):
        ...
        """
        if (self._configuration.client_side_validation and
                controller_time is not None and controller_time > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `controller_time`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                controller_time is not None and controller_time < 0):  # noqa: E501
    ...
    @property
    def dup_spns(self):
        """Gets the dup_spns of this ProvidersAdsAdsItemExtended.  # noqa: E501


        :return: The dup_spns of this ProvidersAdsAdsItemExtended.  # noqa: E501
        :rtype: list[str]
        """
        return self._dup_spns

    @dup_spns.setter
    def dup_spns(self, dup_spns):
        """Sets the dup_spns of this ProvidersAdsAdsItemExtended.


        :param dup_spns: The dup_spns of this ProvidersAdsAdsItemExtended.  # noqa: E501
        :type: list[str]
        """

        self._dup_spns = dup_spns
    ...
    def machine_account(self, machine_account):
        ...
        """
        if (self._configuration.client_side_validation and
                machine_account is not None and len(machine_account) > 255):
            raise ValueError("Invalid value for `machine_account`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                machine_account is not None and len(machine_account) < 0):
    ...
    def machine_password_lifespan(self, machine_password_lifespan):
        ...
        """
        if (self._configuration.client_side_validation and
                machine_password_lifespan is not None and machine_password_lifespan > 31536000):  # noqa: E501
            raise ValueError("Invalid value for `machine_password_lifespan`, must be a value less than or equal to `31536000`")  # noqa: E501
        if (self._configuration.client_side_validation and
                machine_password_lifespan is not None and machine_password_lifespan < 3600):  # noqa: E501
    ...
    def netbios_domain(self, netbios_domain):
        ...
        """
        if (self._configuration.client_side_validation and
                netbios_domain is not None and len(netbios_domain) > 15):
            raise ValueError("Invalid value for `netbios_domain`, length must be less than or equal to `15`")  # noqa: E501
        if (self._configuration.client_side_validation and
                netbios_domain is not None and len(netbios_domain) < 1):
    ...
    def node_dc_affinity(self, node_dc_affinity):
        ...
        """
        if (self._configuration.client_side_validation and
                node_dc_affinity is not None and len(node_dc_affinity) > 255):
            raise ValueError("Invalid value for `node_dc_affinity`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                node_dc_affinity is not None and len(node_dc_affinity) < 0):
    ...
    def node_dc_affinity_timeout(self, node_dc_affinity_timeout):
        ...
        """
        if (self._configuration.client_side_validation and
                node_dc_affinity_timeout is not None and node_dc_affinity_timeout > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `node_dc_affinity_timeout`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                node_dc_affinity_timeout is not None and node_dc_affinity_timeout < 0):  # noqa: E501
    ...
    def primary_domain(self, primary_domain):
        ...
        """
        if (self._configuration.client_side_validation and
                primary_domain is not None and len(primary_domain) > 255):
            raise ValueError("Invalid value for `primary_domain`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                primary_domain is not None and len(primary_domain) < 2):
    ...
    def rpc_call_timeout(self):
        """Gets the rpc_call_timeout of this ProvidersAdsAdsItemExtended.  # noqa: E501

        The maximum amount of time (in seconds) an RPC call to Active Directory is allowed to take.  # noqa: E501

        :return: The rpc_call_timeout of this ProvidersAdsAdsItemExtended.  # noqa: E501
        :rtype: int
        """
    ...
    def rpc_call_timeout(self, rpc_call_timeout):
        """Sets the rpc_call_timeout of this ProvidersAdsAdsItemExtended.

        The maximum amount of time (in seconds) an RPC call to Active Directory is allowed to take.  # noqa: E501

        :param rpc_call_timeout: The rpc_call_timeout of this ProvidersAdsAdsItemExtended.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                rpc_call_timeout is not None and rpc_call_timeout > 3600):  # noqa: E501
            raise ValueError("Invalid value for `rpc_call_timeout`, must be a value less than or equal to `3600`")  # noqa: E501
        if (self._configuration.client_side_validation and
                rpc_call_timeout is not None and rpc_call_timeout < 0):  # noqa: E501
    ...
    def server_retry_limit(self):
        """Gets the server_retry_limit of this ProvidersAdsAdsItemExtended.  # noqa: E501

        The number of retries attempted when a call to Active Directory fails due to network error.  # noqa: E501

        :return: The server_retry_limit of this ProvidersAdsAdsItemExtended.  # noqa: E501
        :rtype: int
        """
    ...
    def server_retry_limit(self, server_retry_limit):
        """Sets the server_retry_limit of this ProvidersAdsAdsItemExtended.

        The number of retries attempted when a call to Active Directory fails due to network error.  # noqa: E501

        :param server_retry_limit: The server_retry_limit of this ProvidersAdsAdsItemExtended.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                server_retry_limit is not None and server_retry_limit > 65535):  # noqa: E501
            raise ValueError("Invalid value for `server_retry_limit`, must be a value less than or equal to `65535`")  # noqa: E501
        if (self._configuration.client_side_validation and
                server_retry_limit is not None and server_retry_limit < 0):  # noqa: E501
    ...
    def sfu_support(self, sfu_support):
        ...
        if (self._configuration.client_side_validation and
                sfu_support not in allowed_values):
            raise ValueError(

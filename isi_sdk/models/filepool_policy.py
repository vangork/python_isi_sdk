...
class FilepoolPolicy(object):
    ...
    def __init__(self, actions=None, apply_order=None, description=None, file_matching_pattern=None, name=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FilepoolPolicy, dict):

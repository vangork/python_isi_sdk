...
class HdfsCryptoEncryptionZonesEncryptionZone(object):
    ...
    def __init__(self, id=None, key_name=None, path=None, _configuration=None):  # noqa: E501
    ...
    def id(self, id):
        ...
        if (self._configuration.client_side_validation and
                id is not None and len(id) > 4096):
        ...
        if (self._configuration.client_side_validation and
                id is not None and not re.search(r'^\/ifs$|^\/ifs\/', id)):  # noqa: E501
            raise ValueError(r"Invalid value for `id`, must be a follow pattern or equal to `/^\/ifs$|^\/ifs\//`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HdfsCryptoEncryptionZonesEncryptionZone, dict):

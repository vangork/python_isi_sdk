...
class SnapshotWritableSnapshotSummarySummary(object):
    ...
    def __init__(self, active_count=None, active_phys_size=None, count=None, deleting_count=None, deleting_phys_size=None, phys_size=None, _configuration=None):  # noqa: E501
    ...
    def active_count(self, active_count):
        ...
        if (self._configuration.client_side_validation and
                active_count is not None and active_count > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `active_count`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                active_count is not None and active_count < 0):  # noqa: E501
    ...
    def active_phys_size(self, active_phys_size):
        ...
        """
        if (self._configuration.client_side_validation and
                active_phys_size is not None and active_phys_size > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `active_phys_size`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                active_phys_size is not None and active_phys_size < 0):  # noqa: E501
    ...
    def count(self, count):
        ...
        """
        if (self._configuration.client_side_validation and
                count is not None and count > 9223372036854775807):  # noqa: E501
    ...
    def deleting_count(self, deleting_count):
        ...
        """
        if (self._configuration.client_side_validation and
                deleting_count is not None and deleting_count > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `deleting_count`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                deleting_count is not None and deleting_count < 0):  # noqa: E501
    ...
    def deleting_phys_size(self, deleting_phys_size):
        ...
        """
        if (self._configuration.client_side_validation and
                deleting_phys_size is not None and deleting_phys_size > 9223372036854775807):  # noqa: E501
        ...
        if (self._configuration.client_side_validation and
                deleting_phys_size is not None and deleting_phys_size < 0):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SnapshotWritableSnapshotSummarySummary, dict):

...
class QuotaQuotaCreateParams(object):
    ...
    def __init__(self, container=None, description=None, enforced=None, force=None, ignore_limit_checks=None, include_snapshots=None, labels=None, path=None, persona=None, thresholds=None, thresholds_include_overhead=None, thresholds_on='fslogicalsize', type=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(QuotaQuotaCreateParams, dict):

...
class SummaryProtocolStatsProtocolStats(object):
    ...
    def __init__(self, cpu=None, disk=None, network=None, onefs=None, protocol=None, time=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SummaryProtocolStatsProtocolStats, dict):

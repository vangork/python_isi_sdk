...
class AuthAccessAccessItemFileFilePermissions(object):
    ...
    def __init__(self, delete_child=None, expected=None, mode=None, ownership=None, relevant_aces=None, relevant_mode=None, sticky=None, _configuration=None):  # noqa: E501
    ...
    def relevant_mode(self, relevant_mode):
        ...
        """
        if (self._configuration.client_side_validation and
                relevant_mode is not None and len(relevant_mode) > 255):
            raise ValueError("Invalid value for `relevant_mode`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                relevant_mode is not None and len(relevant_mode) < 0):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AuthAccessAccessItemFileFilePermissions, dict):

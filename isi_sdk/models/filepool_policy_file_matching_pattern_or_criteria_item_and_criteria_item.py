...
class FilepoolPolicyFileMatchingPatternOrCriteriaItemAndCriteriaItem(object):
    ...
    def __init__(self, attribute_exists=None, begins_with=None, case_sensitive=None, field=None, operator=None, type=None, units=None, use_relative_time=None, value=None, _configuration=None):  # noqa: E501
    ...
    def units(self, units):
        ...
        """
        if (self._configuration.client_side_validation and
                units is not None and len(units) > 2):

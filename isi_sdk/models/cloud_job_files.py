...
class CloudJobFiles(object):
    ...
    def __init__(self, file_matching_pattern=None, names=None, total=None, total_canceled=None, total_failed=None, total_pending=None, total_processing=None, total_succeeded=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudJobFiles, dict):

...
class AuthLdapTemplatesLdapConfigurationTemplateExtended(object):
    ...
    def email_attribute(self, email_attribute):
        ...
        """
        if (self._configuration.client_side_validation and
                email_attribute is not None and len(email_attribute) > 255):
            raise ValueError("Invalid value for `email_attribute`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                email_attribute is not None and len(email_attribute) < 0):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AuthLdapTemplatesLdapConfigurationTemplateExtended, dict):

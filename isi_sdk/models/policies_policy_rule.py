...
class PoliciesPolicyRule(object):
    ...
    def __init__(self, action=None, description=None, dst_ports=None, index=None, name=None, protocol=None, src_networks=None, src_ports=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PoliciesPolicyRule, dict):

...
class SettingsAclsExtended(object):
    ...
    def calcmode(self, calcmode):
        ...
        if (self._configuration.client_side_validation and
                calcmode not in allowed_values):
            raise ValueError(
    ...
    def calcmode_group(self, calcmode_group):
        ...
        if (self._configuration.client_side_validation and
                calcmode_group not in allowed_values):
            raise ValueError(
    ...
    def calcmode_owner(self, calcmode_owner):
        ...
        if (self._configuration.client_side_validation and
                calcmode_owner not in allowed_values):
            raise ValueError(
    ...
    def calcmode_traverse(self, calcmode_traverse):
        ...
        if (self._configuration.client_side_validation and
                calcmode_traverse not in allowed_values):
            raise ValueError(
    ...
    def chmod(self, chmod):
        ...
        :type: str
        """
        allowed_values = ["remove", "replace", "replace_users_and_groups", "merge_with_ugo_priority", "merge", "deny", "ignore"]  # noqa: E501
        if (self._configuration.client_side_validation and
                chmod not in allowed_values):
            raise ValueError(
    ...
    def chmod_007(self, chmod_007):
        ...
        if (self._configuration.client_side_validation and
                chmod_007 not in allowed_values):
            raise ValueError(
    ...
    def chmod_inheritable(self, chmod_inheritable):
        ...
        if (self._configuration.client_side_validation and
                chmod_inheritable not in allowed_values):
            raise ValueError(
    ...
    def create_over_smb(self, create_over_smb):
        ...
        if (self._configuration.client_side_validation and
                create_over_smb not in allowed_values):
            raise ValueError(
    ...
    def dos_attr(self, dos_attr):
        ...
        if (self._configuration.client_side_validation and
                dos_attr not in allowed_values):
            raise ValueError(
    ...
    def group_owner_inheritance(self, group_owner_inheritance):
        ...
        if (self._configuration.client_side_validation and
                group_owner_inheritance not in allowed_values):
            raise ValueError(
    ...
    def read_attributes(self):
        """Gets the read_attributes of this SettingsAclsExtended.  # noqa: E501

        Require read attribute permissions on files with existing ACLs.  # noqa: E501

        :return: The read_attributes of this SettingsAclsExtended.  # noqa: E501
        :rtype: str
        """
    ...
    def read_attributes(self, read_attributes):
        """Sets the read_attributes of this SettingsAclsExtended.

        Require read attribute permissions on files with existing ACLs.  # noqa: E501

        :param read_attributes: The read_attributes of this SettingsAclsExtended.  # noqa: E501
        :type: str
        """
        allowed_values = ["ignore", "require"]  # noqa: E501
        if (self._configuration.client_side_validation and
                read_attributes not in allowed_values):
            raise ValueError(
                "Invalid value for `read_attributes` ({0}), must be one of {1}"  # noqa: E501
                .format(read_attributes, allowed_values)
            )
    ...
    def synthetic_denies(self, synthetic_denies):
        ...
        if (self._configuration.client_side_validation and
                synthetic_denies not in allowed_values):
            raise ValueError(

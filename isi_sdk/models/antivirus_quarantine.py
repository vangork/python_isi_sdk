...
class AntivirusQuarantine(object):
    ...
    def __init__(self, file=None, last_istag=None, last_scan=None, quarantined=None, scan_result=None, scan_status=None, _configuration=None):  # noqa: E501
    ...
    def file(self, file):
        ...
        if (self._configuration.client_side_validation and
                file is not None and len(file) > 4096):
    ...
    def last_scan(self, last_scan):
        ...
        """
        if (self._configuration.client_side_validation and
                last_scan is not None and last_scan > 4294967295):  # noqa: E501
            raise ValueError("Invalid value for `last_scan`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if (self._configuration.client_side_validation and
                last_scan is not None and last_scan < 0):  # noqa: E501
    ...
    def quarantined(self, quarantined):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and quarantined is None:

...
class ProvidersSummaryProviderInstance(object):
    ...
    def __init__(self, active_server=None, client_site=None, connections=None, dc_site=None, forest=None, groupnet=None, id=None, name=None, status=None, type=None, zone_name=None, _configuration=None):  # noqa: E501
    ...
    def active_server(self, active_server):
        ...
        if (self._configuration.client_side_validation and
                active_server is not None and len(active_server) > 255):
            raise ValueError("Invalid value for `active_server`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                active_server is not None and len(active_server) < 0):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProvidersSummaryProviderInstance, dict):

...
class DatamoverBasePolicy(object):
    ...
    def base_account_id(self):
        """Gets the base_account_id of this DatamoverBasePolicy.  # noqa: E501

        Account ID (local or remote DM system) where the policy should be created.  # noqa: E501

        :return: The base_account_id of this DatamoverBasePolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def base_account_id(self, base_account_id):
        """Sets the base_account_id of this DatamoverBasePolicy.

        Account ID (local or remote DM system) where the policy should be created.  # noqa: E501

        :param base_account_id: The base_account_id of this DatamoverBasePolicy.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                base_account_id is not None and len(base_account_id) > 48):
            raise ValueError("Invalid value for `base_account_id`, length must be less than or equal to `48`")  # noqa: E501
        if (self._configuration.client_side_validation and
                base_account_id is not None and len(base_account_id) < 2):
    ...
    @property
    def briefcase(self):
        """Gets the briefcase of this DatamoverBasePolicy.  # noqa: E501

        An opaque container for storing additional data in this object, e.g. key-value pairs  # noqa: E501

        :return: The briefcase of this DatamoverBasePolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def briefcase(self, briefcase):
        """Sets the briefcase of this DatamoverBasePolicy.

        An opaque container for storing additional data in this object, e.g. key-value pairs  # noqa: E501

        :param briefcase: The briefcase of this DatamoverBasePolicy.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def enabled(self):
        """Gets the enabled of this DatamoverBasePolicy.  # noqa: E501

        True: policy is enabled, False: otherwise.  # noqa: E501

        :return: The enabled of this DatamoverBasePolicy.  # noqa: E501
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this DatamoverBasePolicy.

        True: policy is enabled, False: otherwise.  # noqa: E501

        :param enabled: The enabled of this DatamoverBasePolicy.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this DatamoverBasePolicy.  # noqa: E501

        A user provided base policy name.  # noqa: E501

        :return: The name of this DatamoverBasePolicy.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DatamoverBasePolicy.

        A user provided base policy name.  # noqa: E501

        :param name: The name of this DatamoverBasePolicy.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def new_tasks_account(self):
        """Gets the new_tasks_account of this DatamoverBasePolicy.  # noqa: E501

        Account of the system to create tasks on. This overrides the default task affinity.  # noqa: E501

        :return: The new_tasks_account of this DatamoverBasePolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def new_tasks_account(self, new_tasks_account):
        """Sets the new_tasks_account of this DatamoverBasePolicy.

        Account of the system to create tasks on. This overrides the default task affinity.  # noqa: E501

        :param new_tasks_account: The new_tasks_account of this DatamoverBasePolicy.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def override_list(self):
        """Gets the override_list of this DatamoverBasePolicy.  # noqa: E501

        The list of fields which will override a concrete policy.  # noqa: E501

        :return: The override_list of this DatamoverBasePolicy.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def override_list(self, override_list):
        """Sets the override_list of this DatamoverBasePolicy.

        The list of fields which will override a concrete policy.  # noqa: E501

        :param override_list: The override_list of this DatamoverBasePolicy.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def priority(self):
        """Gets the priority of this DatamoverBasePolicy.  # noqa: E501

        The relative priority of the policy.  # noqa: E501

        :return: The priority of this DatamoverBasePolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def priority(self, priority):
        """Sets the priority of this DatamoverBasePolicy.

        The relative priority of the policy.  # noqa: E501

        :param priority: The priority of this DatamoverBasePolicy.  # noqa: E501
        :type: str
        """
    ...
    @property
    def schedule(self):
        """Gets the schedule of this DatamoverBasePolicy.  # noqa: E501

        The schedule of the policy- start time, recurrence, specific date-times.  # noqa: E501

        :return: The schedule of this DatamoverBasePolicy.  # noqa: E501
    ...
    def schedule(self, schedule):
        """Sets the schedule of this DatamoverBasePolicy.

        The schedule of the policy- start time, recurrence, specific date-times.  # noqa: E501

        :param schedule: The schedule of this DatamoverBasePolicy.  # noqa: E501
    ...
    def source_account_id(self):
        """Gets the source_account_id of this DatamoverBasePolicy.  # noqa: E501

        Account ID of the source data storage.  # noqa: E501

        :return: The source_account_id of this DatamoverBasePolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def source_account_id(self, source_account_id):
        """Sets the source_account_id of this DatamoverBasePolicy.

        Account ID of the source data storage.  # noqa: E501

        :param source_account_id: The source_account_id of this DatamoverBasePolicy.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def source_base_path(self):
        """Gets the source_base_path of this DatamoverBasePolicy.  # noqa: E501

        Filesystem base path on source DM system which has the directories/files for which dataset has to be created.  # noqa: E501

        :return: The source_base_path of this DatamoverBasePolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def source_base_path(self, source_base_path):
        """Sets the source_base_path of this DatamoverBasePolicy.

        Filesystem base path on source DM system which has the directories/files for which dataset has to be created.  # noqa: E501

        :param source_base_path: The source_base_path of this DatamoverBasePolicy.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def source_subpaths(self):
        """Gets the source_subpaths of this DatamoverBasePolicy.  # noqa: E501

        Set of filesystem paths relative to base path.  # noqa: E501

        :return: The source_subpaths of this DatamoverBasePolicy.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def source_subpaths(self, source_subpaths):
        """Sets the source_subpaths of this DatamoverBasePolicy.

        Set of filesystem paths relative to base path.  # noqa: E501

        :param source_subpaths: The source_subpaths of this DatamoverBasePolicy.  # noqa: E501
        :type: list[str]
        """
    ...
    def src_dataset_retention(self):
        """Gets the src_dataset_retention of this DatamoverBasePolicy.  # noqa: E501

          # noqa: E501

        :return: The src_dataset_retention of this DatamoverBasePolicy.  # noqa: E501
    ...
    def src_dataset_retention(self, src_dataset_retention):
        """Sets the src_dataset_retention of this DatamoverBasePolicy.

          # noqa: E501

        :param src_dataset_retention: The src_dataset_retention of this DatamoverBasePolicy.  # noqa: E501
    ...
    def target_account_id(self):
        """Gets the target_account_id of this DatamoverBasePolicy.  # noqa: E501

        Account ID of the target data storage.  # noqa: E501

        :return: The target_account_id of this DatamoverBasePolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def target_account_id(self, target_account_id):
        """Sets the target_account_id of this DatamoverBasePolicy.

        Account ID of the target data storage.  # noqa: E501

        :param target_account_id: The target_account_id of this DatamoverBasePolicy.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def target_base_path(self):
        """Gets the target_base_path of this DatamoverBasePolicy.  # noqa: E501

        Filesystem base path on target DM syestem which has the directories/files for which dataset has to be created.  # noqa: E501

        :return: The target_base_path of this DatamoverBasePolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def target_base_path(self, target_base_path):
        """Sets the target_base_path of this DatamoverBasePolicy.

        Filesystem base path on target DM syestem which has the directories/files for which dataset has to be created.  # noqa: E501

        :param target_base_path: The target_base_path of this DatamoverBasePolicy.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def tgt_dataset_retention(self):
        """Gets the tgt_dataset_retention of this DatamoverBasePolicy.  # noqa: E501

          # noqa: E501

        :return: The tgt_dataset_retention of this DatamoverBasePolicy.  # noqa: E501
        :rtype: DatamoverBasePolicySrcDatasetRetention
        """
    ...
    def tgt_dataset_retention(self, tgt_dataset_retention):
        """Sets the tgt_dataset_retention of this DatamoverBasePolicy.

          # noqa: E501

        :param tgt_dataset_retention: The tgt_dataset_retention of this DatamoverBasePolicy.  # noqa: E501
        :type: DatamoverBasePolicySrcDatasetRetention
        """
    ...
    @property
    def version(self):
        """Gets the version of this DatamoverBasePolicy.  # noqa: E501

        Version number of the config store when this object was edited.  # noqa: E501

        :return: The version of this DatamoverBasePolicy.  # noqa: E501
        :rtype: int
        """
    ...
    def version(self, version):
        """Sets the version of this DatamoverBasePolicy.

        Version number of the config store when this object was edited.  # noqa: E501

        :param version: The version of this DatamoverBasePolicy.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DatamoverBasePolicy, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DatamoverBasePolicy):
            return False

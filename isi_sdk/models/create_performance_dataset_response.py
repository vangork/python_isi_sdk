...
class CreatePerformanceDatasetResponse(object):
    ...
    def __init__(self, id=None, name=None, note=None, statkey=None, stats_summary_uri=None, _configuration=None):  # noqa: E501
    ...
    def stats_summary_uri(self, stats_summary_uri):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and stats_summary_uri is None:
            raise ValueError("Invalid value for `stats_summary_uri`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                stats_summary_uri is not None and len(stats_summary_uri) > 255):
            raise ValueError("Invalid value for `stats_summary_uri`, length must be less than or equal to `255`")  # noqa: E501
        if (self._configuration.client_side_validation and
                stats_summary_uri is not None and len(stats_summary_uri) < 1):

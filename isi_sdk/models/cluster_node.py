...
class ClusterNode(object):
    ...
    def __init__(self, drive_d_config=None, drives=None, hardware=None, id=None, internal_ip_address=None, lnn=None, partitions=None, sensors=None, sleds=None, state=None, status=None, _configuration=None):  # noqa: E501
    ...
    def drive_d_config(self):
        """Gets the drive_d_config of this ClusterNode.  # noqa: E501

        An object containing a node's drive subsystem XML configuration file.  # noqa: E501

        :return: The drive_d_config of this ClusterNode.  # noqa: E501
    ...
    def drive_d_config(self, drive_d_config):
        """Sets the drive_d_config of this ClusterNode.

        An object containing a node's drive subsystem XML configuration file.  # noqa: E501

        :param drive_d_config: The drive_d_config of this ClusterNode.  # noqa: E501
    ...
    def internal_ip_address(self):
        """Gets the internal_ip_address of this ClusterNode.  # noqa: E501

        IPv4 address in the format: xxx.xxx.xxx.xxx  # noqa: E501

        :return: The internal_ip_address of this ClusterNode.  # noqa: E501
        :rtype: str
        """
    ...
    def internal_ip_address(self, internal_ip_address):
        """Sets the internal_ip_address of this ClusterNode.

        IPv4 address in the format: xxx.xxx.xxx.xxx  # noqa: E501

        :param internal_ip_address: The internal_ip_address of this ClusterNode.  # noqa: E501
        :type: str
        """
        ...
        if (self._configuration.client_side_validation and
                internal_ip_address is not None and len(internal_ip_address) > 45):
            raise ValueError("Invalid value for `internal_ip_address`, length must be less than or equal to `45`")  # noqa: E501
        if (self._configuration.client_side_validation and
                internal_ip_address is not None and len(internal_ip_address) < 2):
            raise ValueError("Invalid value for `internal_ip_address`, length must be greater than or equal to `2`")  # noqa: E501
        if (self._configuration.client_side_validation and
                internal_ip_address is not None and not re.search(r'^([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])(\\.([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])){3}$', internal_ip_address)):  # noqa: E501
    ...
    @property
    def sleds(self):
        """Gets the sleds of this ClusterNode.  # noqa: E501

        List of the sleds in this node.  # noqa: E501

        :return: The sleds of this ClusterNode.  # noqa: E501
    ...
    def sleds(self, sleds):
        """Sets the sleds of this ClusterNode.

        List of the sleds in this node.  # noqa: E501

        :param sleds: The sleds of this ClusterNode.  # noqa: E501

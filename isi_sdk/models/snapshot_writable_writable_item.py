...
class SnapshotWritableWritableItem(object):
    ...
    def __init__(self, created=None, dst_path=None, id=None, log_size=None, phys_size=None, src_id=None, src_path=None, src_snap=None, state=None, _configuration=None):  # noqa: E501
    ...
    def phys_size(self, phys_size):
        ...
        if (self._configuration.client_side_validation and
                phys_size is not None and phys_size > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `phys_size`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                phys_size is not None and phys_size < 0):  # noqa: E501
    ...
    def src_snap(self, src_snap):
        ...
        """
        if (self._configuration.client_side_validation and
                src_snap is not None and len(src_snap) < 0):

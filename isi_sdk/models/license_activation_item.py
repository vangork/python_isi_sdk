...
class LicenseActivationItem(object):
    ...
    def __init__(self, lacs=None, licenses_to_exclude=None, licenses_to_include=None, only_these_licenses=None, _configuration=None):  # noqa: E501

...
class ClusterInternalNetworksExtended(object):
    ...
    def __init__(self, failover_ip_addresses=None, failover_status=None, int_a_ip_addresses=None, int_a_prefix_length=None, int_b_ip_addresses=None, int_b_prefix_length=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClusterInternalNetworksExtended, dict):

...
class ClusterNodeSled(object):
    ...
    def __init__(self, is_removeable=None, sled_letter=None, sled_state=None, _configuration=None):  # noqa: E501
    ...
    def is_removeable(self, is_removeable):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and is_removeable is None:
    ...
    def sled_letter(self, sled_letter):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and sled_letter is None:
            raise ValueError("Invalid value for `sled_letter`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                sled_letter is not None and len(sled_letter) > 1):
        ...
        if (self._configuration.client_side_validation and
                sled_letter is not None and not re.search(r'^[a-eA-E]$', sled_letter)):  # noqa: E501

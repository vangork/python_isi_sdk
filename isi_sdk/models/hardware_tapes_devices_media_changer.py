...
class HardwareTapesDevicesMediaChanger(object):
    ...
    def __init__(self, id=None, name=None, opencount=None, paths=None, product=None, serial=None, state=None, wwnn=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HardwareTapesDevicesMediaChanger, dict):

...
class CloudSettingsSettingsCloudPolicyDefaults(object):
    ...
    def __init__(self, archive_snapshot_files=None, cache=None, compression=None, data_retention=None, encryption=None, full_backup_retention=None, incremental_backup_retention=None, writeback_frequency=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CloudSettingsSettingsCloudPolicyDefaults, dict):

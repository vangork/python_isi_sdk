...
class WormDomain(object):
    ...
    def __init__(self, autocommit_offset=None, default_retention=None, exclusions=None, max_retention=None, min_retention=None, override_date=None, privileged_delete=None, set_pending_delete=None, type=None, _configuration=None):  # noqa: E501
    ...
    def autocommit_offset(self, autocommit_offset):
        ...
        if (self._configuration.client_side_validation and
                autocommit_offset is not None and autocommit_offset > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `autocommit_offset`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                autocommit_offset is not None and autocommit_offset < 0):  # noqa: E501
    ...
    @property
    def exclusions(self):
        """Gets the exclusions of this WormDomain.  # noqa: E501
        ...
        :return: The exclusions of this WormDomain.  # noqa: E501
    ...
    def exclusions(self, exclusions):
        """Sets the exclusions of this WormDomain.

        A list of directories excluded from WORM protection. In a POST/PUT request this collection specifies the directories that the user wishes to create SmartLock exclusion directories on underneath this SmartLock directory. In a GET request this collection specifies all of the exclusion directories that exist underneath this SmartLock directory.  # noqa: E501

        :param exclusions: The exclusions of this WormDomain.  # noqa: E501
    ...
    def override_date(self, override_date):
        ...
        """
        if (self._configuration.client_side_validation and
                override_date is not None and override_date > 9223372036854775807):  # noqa: E501
            raise ValueError("Invalid value for `override_date`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if (self._configuration.client_side_validation and
                override_date is not None and override_date < 0):  # noqa: E501
    ...
    def set_pending_delete(self):
        """Gets the set_pending_delete of this WormDomain.  # noqa: E501
        ...
        :return: The set_pending_delete of this WormDomain.  # noqa: E501
        :rtype: bool
        """
    ...
    def set_pending_delete(self, set_pending_delete):
        """Sets the set_pending_delete of this WormDomain.

        If true, the domain is irreversibly marked for deletion. This is used for compliance domains and allows compliance store directories to be deleted, while disallowing the creation or committing of new/existing files.  # noqa: E501

        :param set_pending_delete: The set_pending_delete of this WormDomain.  # noqa: E501
        :type: bool
        """

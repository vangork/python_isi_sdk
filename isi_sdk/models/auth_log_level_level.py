...
class AuthLogLevelLevel(object):
    ...
    def __init__(self, lsass_level=None, netlogon_level=None, _configuration=None):  # noqa: E501
    ...
    def lsass_level(self, lsass_level):
        ...
        if (self._configuration.client_side_validation and
                lsass_level not in allowed_values):
            raise ValueError(
    ...
    def netlogon_level(self, netlogon_level):
        ...
        allowed_values = ["always", "error", "warning", "info", "verbose", "debug", "trace", "unknown"]  # noqa: E501
        if (self._configuration.client_side_validation and
                netlogon_level not in allowed_values):
            raise ValueError(

...
class HealthcheckChecklistDeliveryItem(object):
    ...
    def __init__(self, address=None, email_host=None, email_pass=None, email_port=None, email_security=None, email_user=None, failonly=None, method=None, _configuration=None):  # noqa: E501
    ...
    def email_port(self, email_port):
        ...
        """
        if (self._configuration.client_side_validation and
                email_port is not None and email_port > 65535):  # noqa: E501
            raise ValueError("Invalid value for `email_port`, must be a value less than or equal to `65535`")  # noqa: E501
        if (self._configuration.client_side_validation and
                email_port is not None and email_port < 1):  # noqa: E501
    ...
    def email_security(self, email_security):
        ...
        if (self._configuration.client_side_validation and
                email_security not in allowed_values):
            raise ValueError(
    ...
    def failonly(self, failonly):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and failonly is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HealthcheckChecklistDeliveryItem, dict):

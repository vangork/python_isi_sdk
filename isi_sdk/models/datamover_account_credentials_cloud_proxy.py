...
class DatamoverAccountCredentialsCloudProxy(object):
    ...
    def __init__(self, proxy_password=None, proxy_port=None, proxy_type=None, proxy_uri=None, proxy_username=None, _configuration=None):  # noqa: E501
    ...
    def proxy_password(self, proxy_password):
        ...
        if (self._configuration.client_side_validation and
                proxy_password is not None and len(proxy_password) > 255):

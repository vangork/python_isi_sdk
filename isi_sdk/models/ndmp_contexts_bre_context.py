...
class NdmpContextsBreContext(object):
    ...
    def __init__(self, backup_type=None, bkp_context_id=None, bre_context_id=None, create_time=None, env_variables=None, id=None, results=None, snap_name=None, status=None, stream_id=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NdmpContextsBreContext, dict):

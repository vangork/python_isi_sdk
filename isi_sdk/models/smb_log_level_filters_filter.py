...
class SmbLogLevelFiltersFilter(object):
    ...
    def __init__(self, id=None, ip_addrs=None, level=None, ops=None, _configuration=None):  # noqa: E501
    ...
    def ops(self, ops):
        ...
        if (self._configuration.client_side_validation and
                not set(ops).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SmbLogLevelFiltersFilter, dict):

...
class DatamoverAccountCreateParams(object):
    ...
    def __init__(self, account_type=None, briefcase=None, credentials=None, enforce_sse=None, local_network_pool=None, max_sparks=None, name=None, remote_network_pool=None, storage_class=None, uri=None, _configuration=None):  # noqa: E501

...
class ClusterNodesApi(object):
    ...
    def get_node_drive_with_http_info(self, node_drive_id, lnn, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/16/cluster/nodes/{Lnn}/drives/{NodeDriveId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_node_driveconfig_with_http_info(self, lnn, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/14/cluster/nodes/{Lnn}/driveconfig', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_node_drives_with_http_info(self, lnn, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/16/cluster/nodes/{Lnn}/drives', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_node_hardware_with_http_info(self, lnn, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/cluster/nodes/{Lnn}/hardware', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_node_status_with_http_info(self, lnn, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/16/cluster/nodes/{Lnn}/status', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_node_status_drive_security_level(self, lnn, **kwargs):  # noqa: E501
        """get_node_status_drive_security_level  # noqa: E501

        Retrieve node's drive security level information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_node_status_drive_security_level(lnn, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int lnn: (required)
        :return: NodeStatusDriveSecurityLevel
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_node_status_drive_security_level_with_http_info(lnn, **kwargs)  # noqa: E501
        else:
            (data) = self.get_node_status_drive_security_level_with_http_info(lnn, **kwargs)  # noqa: E501
            return data

    def get_node_status_drive_security_level_with_http_info(self, lnn, **kwargs):  # noqa: E501
        """get_node_status_drive_security_level  # noqa: E501

        Retrieve node's drive security level information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_node_status_drive_security_level_with_http_info(lnn, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_node_status_drive_security_level" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'lnn' is set
        if ('lnn' not in params or
                params['lnn'] is None):
            raise ValueError("Missing the required parameter `lnn` when calling `get_node_status_drive_security_level`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/16/cluster/nodes/{Lnn}/status/drive_security_level', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='NodeStatusDriveSecurityLevel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_node_driveconfig_with_http_info(self, node_driveconfig, lnn, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/14/cluster/nodes/{Lnn}/driveconfig', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,

...
class NetworkGroupnetsSubnetsApi(object):
    ...
    def create_pools_pool_rule_with_http_info(self, pools_pool_rule, groupnet, subnet, pool, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/21/network/groupnets/{Groupnet}/subnets/{Subnet}/pools/{Pool}/rules', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_pools_pool_rule_with_http_info(self, pools_pool_rule_id, groupnet, subnet, pool, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/21/network/groupnets/{Groupnet}/subnets/{Subnet}/pools/{Pool}/rules/{PoolsPoolRuleId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_pools_pool_rule_with_http_info(self, pools_pool_rule_id, groupnet, subnet, pool, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/21/network/groupnets/{Groupnet}/subnets/{Subnet}/pools/{Pool}/rules/{PoolsPoolRuleId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_pools_pool_status(self, groupnet, subnet, pool, **kwargs):  # noqa: E501
        """get_pools_pool_status  # noqa: E501

        View the status of a single network pool.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_pools_pool_status(groupnet, subnet, pool, async_req=True)
        >>> result = thread.get()
        ...
        :param str subnet: (required)
        :param str pool: (required)
        :param bool show_all: Whether or not OneFS should return all nodes configured in the network pool, even if SmartConnect doesn't detect any problem with the nodes. Default: only return nodes that can't be resolved via DNS.
        :return: PoolsPoolStatus
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_pools_pool_status_with_http_info(groupnet, subnet, pool, **kwargs)  # noqa: E501
        else:
            (data) = self.get_pools_pool_status_with_http_info(groupnet, subnet, pool, **kwargs)  # noqa: E501
            return data

    def get_pools_pool_status_with_http_info(self, groupnet, subnet, pool, **kwargs):  # noqa: E501
        """get_pools_pool_status  # noqa: E501

        View the status of a single network pool.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_pools_pool_status_with_http_info(groupnet, subnet, pool, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['groupnet', 'subnet', 'pool', 'show_all']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_pools_pool_status" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'groupnet' is set
        if ('groupnet' not in params or
                params['groupnet'] is None):
            raise ValueError("Missing the required parameter `groupnet` when calling `get_pools_pool_status`")  # noqa: E501
        # verify the required parameter 'subnet' is set
        if ('subnet' not in params or
                params['subnet'] is None):
            raise ValueError("Missing the required parameter `subnet` when calling `get_pools_pool_status`")  # noqa: E501
        # verify the required parameter 'pool' is set
        if ('pool' not in params or
                params['pool'] is None):
            raise ValueError("Missing the required parameter `pool` when calling `get_pools_pool_status`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/15/network/groupnets/{Groupnet}/subnets/{Subnet}/pools/{Pool}/status', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PoolsPoolStatus',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_pools_pool_rules_with_http_info(self, groupnet, subnet, pool, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/21/network/groupnets/{Groupnet}/subnets/{Subnet}/pools/{Pool}/rules', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_pools_pool_rule_with_http_info(self, pools_pool_rule, pools_pool_rule_id, groupnet, subnet, pool, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/21/network/groupnets/{Groupnet}/subnets/{Subnet}/pools/{Pool}/rules/{PoolsPoolRuleId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,

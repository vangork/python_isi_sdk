...
class QuotaApi(object):
    ...
    def delete_quota_quota_with_http_info(self, quota_quota_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/quota/quotas/{QuotaQuotaId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_quota_quotas(self, **kwargs):  # noqa: E501
        ...
        Delete all or matching quotas. For any query argument not supplied, the default behavior is return all.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param bool recurse_path_children: If used with the path argument, delete all quotas at that path or any descendant sub-directory.
    ...
    def delete_quota_quotas_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/quota/quotas', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_quota_quota_with_http_info(self, quota_quota_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/quota/quotas/{QuotaQuotaId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_quota_quotas(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param bool enforced: Only list enforced quotas.
        ...
        :param bool recurse_path_children: If used with the path argument, match all quotas at that path or any descendant sub-directory.
    ...
    def list_settings_mappings(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :return: SettingsMappingsExtended
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def list_settings_mappings_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SettingsMappingsExtended',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_quota_quota_with_http_info(self, quota_quota, quota_quota_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/quota/quotas/{QuotaQuotaId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,

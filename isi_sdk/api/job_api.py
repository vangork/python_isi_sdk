...
class JobApi(object):
    ...
    def get_job_events(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int begin: Restrict the query to events at or after the given time. If positive, this represents seconds since the Epoch; if negative, this represents seconds before the current time.
        :param int end: Restrict the query to events before the given time. If positive, this represents seconds since the Epoch; if negative, this represents seconds before the current time.
    ...
    def get_job_job_with_http_info(self, job_job_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/21/job/jobs/{JobJobId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_job_job_summary_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/job/job-summary', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_job_reports(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int begin: Restrict the query to reports at or after the given time. If positive, this represents seconds since the Epoch; if negative, this represents seconds before the current time.
        :param int end: Restrict the query to reports before the given time. If positive, this represents seconds since the Epoch; if negative, this represents seconds before the current time; if zero, this represents no end time (no restriction).
        :param int job_id: Restrict the query to the given job ID.
        :param str job_type: Restrict the query to the given job type.
    ...
    def get_job_settings(self, **kwargs):  # noqa: E501
        """get_job_settings  # noqa: E501

        View a subset of Job Engine generic settings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_job_settings(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_job_settings_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_job_settings_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_job_settings_with_http_info(self, **kwargs):  # noqa: E501
        """get_job_settings  # noqa: E501

        View a subset of Job Engine generic settings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_job_settings_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_job_settings" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def update_job_job_with_http_info(self, job_job, job_job_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/21/job/jobs/{JobJobId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_job_settings(self, job_settings, **kwargs):  # noqa: E501
        """update_job_settings  # noqa: E501

        Modify a subset of Job Engine generic settings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_job_settings(job_settings, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param JobSettingsSettings job_settings: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_job_settings_with_http_info(job_settings, **kwargs)  # noqa: E501
        else:
            (data) = self.update_job_settings_with_http_info(job_settings, **kwargs)  # noqa: E501
            return data

    def update_job_settings_with_http_info(self, job_settings, **kwargs):  # noqa: E501
        """update_job_settings  # noqa: E501

        Modify a subset of Job Engine generic settings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_job_settings_with_http_info(job_settings, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['job_settings']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_job_settings" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'job_settings' is set
        if ('job_settings' not in params or
                params['job_settings'] is None):
            raise ValueError("Missing the required parameter `job_settings` when calling `update_job_settings`")  # noqa: E501
        ...
        if 'job_settings' in params:
            body_params = params['job_settings']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501

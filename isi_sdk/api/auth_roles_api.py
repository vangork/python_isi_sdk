...
class AuthRolesApi(object):
    ...
    def create_role_privilege_with_http_info(self, role_privilege, role, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/18/auth/roles/{Role}/privileges', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_role_privilege_with_http_info(self, role_privilege_id, role, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/18/auth/roles/{Role}/privileges/{RolePrivilegeId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_role_members_with_http_info(self, role, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='RoleMembers',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_role_privileges_with_http_info(self, role, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/18/auth/roles/{Role}/privileges', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,

...
class ConfigApi(object):
    ...
    def create_config_export_with_http_info(self, config_export, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/20/config/exports', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_config_import_with_http_info(self, config_import, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/20/config/imports', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_config_config_lock(self, **kwargs):  # noqa: E501
        """get_config_config_lock  # noqa: E501

        Get configuration lock status.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_config_config_lock(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: ConfigConfigLock
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_config_config_lock_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_config_config_lock_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_config_config_lock_with_http_info(self, **kwargs):  # noqa: E501
        """get_config_config_lock  # noqa: E501

        Get configuration lock status.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_config_config_lock_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_config_config_lock" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/platform/18/config/config-lock', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ConfigConfigLock',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_config_export_with_http_info(self, config_export_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/20/config/exports/{ConfigExportId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_config_import_with_http_info(self, config_import_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/20/config/imports/{ConfigImportId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_config_exports_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if ('dir' in params and
                len(params['dir']) < 0):
            raise ValueError("Invalid value for parameter `dir` when calling `list_config_exports`, length must be greater than or equal to `0`")  # noqa: E501
        if ('sort' in params and
                len(params['sort']) > 255):
            raise ValueError("Invalid value for parameter `sort` when calling `list_config_exports`, length must be less than or equal to `255`")  # noqa: E501
        if ('sort' in params and
                len(params['sort']) < 0):
            raise ValueError("Invalid value for parameter `sort` when calling `list_config_exports`, length must be greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/platform/20/config/exports', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_config_imports_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if ('dir' in params and
                len(params['dir']) < 0):
            raise ValueError("Invalid value for parameter `dir` when calling `list_config_imports`, length must be greater than or equal to `0`")  # noqa: E501
        if ('sort' in params and
                len(params['sort']) > 255):
            raise ValueError("Invalid value for parameter `sort` when calling `list_config_imports`, length must be less than or equal to `255`")  # noqa: E501
        if ('sort' in params and
                len(params['sort']) < 0):
            raise ValueError("Invalid value for parameter `sort` when calling `list_config_imports`, length must be greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/platform/20/config/imports', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_config_config_lock(self, action, config_config_lock, **kwargs):  # noqa: E501
        """update_config_config_lock  # noqa: E501

        Enable/Disable configuration lock.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_config_config_lock(action, config_config_lock, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str action: Enable/disable configuration lock (required)
        :param Empty config_config_lock: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_config_config_lock_with_http_info(action, config_config_lock, **kwargs)  # noqa: E501
        else:
            (data) = self.update_config_config_lock_with_http_info(action, config_config_lock, **kwargs)  # noqa: E501
            return data

    def update_config_config_lock_with_http_info(self, action, config_config_lock, **kwargs):  # noqa: E501
        """update_config_config_lock  # noqa: E501

        Enable/Disable configuration lock.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_config_config_lock_with_http_info(action, config_config_lock, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['action', 'config_config_lock']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_config_config_lock" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('action' not in params or
            ...
            raise ValueError("Missing the required parameter `action` when calling `update_config_config_lock`")  # noqa: E501
        # verify the required parameter 'config_config_lock' is set
        if ('config_config_lock' not in params or
                params['config_config_lock'] is None):
            raise ValueError("Missing the required parameter `config_config_lock` when calling `update_config_config_lock`")  # noqa: E501
        ...
        body_params = None
        if 'config_config_lock' in params:
            body_params = params['config_config_lock']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/18/config/config-lock', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,

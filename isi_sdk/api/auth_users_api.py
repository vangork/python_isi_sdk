...
class AuthUsersApi(object):
    ...
    def create_user_reset_password_item(self, user_reset_password_item, user, **kwargs):  # noqa: E501
        """create_user_reset_password_item  # noqa: E501

        Reset the user's password.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_user_reset_password_item(user_reset_password_item, user, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Empty user_reset_password_item: (required)
        :param str user: (required)
        :param str provider: Optional provider type.
        :param str zone: Specifies access zone containing user.
        :return: CreateUserResetPasswordItemResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_user_reset_password_item_with_http_info(user_reset_password_item, user, **kwargs)  # noqa: E501
        else:
            (data) = self.create_user_reset_password_item_with_http_info(user_reset_password_item, user, **kwargs)  # noqa: E501
            return data

    def create_user_reset_password_item_with_http_info(self, user_reset_password_item, user, **kwargs):  # noqa: E501
        """create_user_reset_password_item  # noqa: E501

        Reset the user's password.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_user_reset_password_item_with_http_info(user_reset_password_item, user, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['user_reset_password_item', 'user', 'provider', 'zone']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_user_reset_password_item" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user_reset_password_item' is set
        if ('user_reset_password_item' not in params or
                params['user_reset_password_item'] is None):
            raise ValueError("Missing the required parameter `user_reset_password_item` when calling `create_user_reset_password_item`")  # noqa: E501
        # verify the required parameter 'user' is set
        if ('user' not in params or
                params['user'] is None):
            raise ValueError("Missing the required parameter `user` when calling `create_user_reset_password_item`")  # noqa: E501
        ...
        body_params = None
        if 'user_reset_password_item' in params:
            body_params = params['user_reset_password_item']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/16/auth/users/{User}/reset-password', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='CreateUserResetPasswordItemResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),

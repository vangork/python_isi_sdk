...
class UpgradeApi(object):
    ...
    def create_cluster_assess_item_with_http_info(self, cluster_assess_item, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/20/upgrade/cluster/assess', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_cluster_patch_patch(self, cluster_patch_patch, **kwargs):  # noqa: E501
        ...
        :param int alert_timeout: The duration in seconds after drain begins that an alert will be raised. An alert timeout must be set to a smaller value than the drain timeout to be used. If not specified, an alert will not be raised (legacy behavior).
        :param int drain_timeout: The duration in seconds that upgrade waits for all SMB clients to disconnect from a node before rebooting it. A value of 0 means wait indefinitely. If not specified, upgrade proceeds with reboots regardless of SMB client connections (legacy behavior).
    ...
    def create_cluster_patch_patch_with_http_info(self, cluster_patch_patch, **kwargs):  # noqa: E501
        ...
        all_params = ['cluster_patch_patch', 'alert_timeout', 'drain_timeout', 'skip_conflict_check', 'skip_dependency_check', 'skip_restricted_check', 'skip_version_check']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'alert_timeout' in params and params['alert_timeout'] > 4294967295:  # noqa: E501
            raise ValueError("Invalid value for parameter `alert_timeout` when calling `create_cluster_patch_patch`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if 'alert_timeout' in params and params['alert_timeout'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `alert_timeout` when calling `create_cluster_patch_patch`, must be a value greater than or equal to `1`")  # noqa: E501
        if 'drain_timeout' in params and params['drain_timeout'] > 4294967295:  # noqa: E501
            raise ValueError("Invalid value for parameter `drain_timeout` when calling `create_cluster_patch_patch`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if 'drain_timeout' in params and params['drain_timeout'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `drain_timeout` when calling `create_cluster_patch_patch`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        if 'alert_timeout' in params:
            query_params.append(('alert_timeout', params['alert_timeout']))  # noqa: E501
        if 'drain_timeout' in params:
            query_params.append(('drain_timeout', params['drain_timeout']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/16/upgrade/cluster/patch/patches', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_cluster_patch_patch_with_http_info(self, cluster_patch_patch_id, **kwargs):  # noqa: E501
        ...
        all_params = ['cluster_patch_patch_id', 'alert_timeout', 'drain_timeout', 'process_type', 'skip_conflict_check', 'skip_dependency_check', 'skip_restricted_check', 'skip_version_check']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'alert_timeout' in params and params['alert_timeout'] > 4294967295:  # noqa: E501
            raise ValueError("Invalid value for parameter `alert_timeout` when calling `delete_cluster_patch_patch`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if 'alert_timeout' in params and params['alert_timeout'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `alert_timeout` when calling `delete_cluster_patch_patch`, must be a value greater than or equal to `1`")  # noqa: E501
        if 'drain_timeout' in params and params['drain_timeout'] > 4294967295:  # noqa: E501
            raise ValueError("Invalid value for parameter `drain_timeout` when calling `delete_cluster_patch_patch`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if 'drain_timeout' in params and params['drain_timeout'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `drain_timeout` when calling `delete_cluster_patch_patch`, must be a value greater than or equal to `0`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/16/upgrade/cluster/patch/patches/{ClusterPatchPatchId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_cluster_mixed_mode(self, **kwargs):  # noqa: E501
        """get_cluster_mixed_mode  # noqa: E501

        View mixed mode state.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_cluster_mixed_mode(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: ClusterMixedMode
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_cluster_mixed_mode_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_cluster_mixed_mode_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_cluster_mixed_mode_with_http_info(self, **kwargs):  # noqa: E501
        """get_cluster_mixed_mode  # noqa: E501

        View mixed mode state.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_cluster_mixed_mode_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_cluster_mixed_mode" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/platform/16/upgrade/cluster/mixed-mode', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ClusterMixedMode',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_cluster_patch_patch_with_http_info(self, cluster_patch_patch_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/16/upgrade/cluster/patch/patches/{ClusterPatchPatchId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_upgrade_cluster_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/20/upgrade/cluster', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_cluster_assess(self, **kwargs):  # noqa: E501
        """list_cluster_assess  # noqa: E501

        Assessment result.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_cluster_assess(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str latest: query for the latest report.
        :param str success: query for the passed/failed checks
        :return: Empty
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_cluster_assess_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_cluster_assess_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_cluster_assess_with_http_info(self, **kwargs):  # noqa: E501
        """list_cluster_assess  # noqa: E501

        Assessment result.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_cluster_assess_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['latest', 'success']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_cluster_assess" % key
                )
            params[key] = val
        del params['kwargs']

        if ('latest' in params and
                len(params['latest']) > 5):
            raise ValueError("Invalid value for parameter `latest` when calling `list_cluster_assess`, length must be less than or equal to `5`")  # noqa: E501
        if ('latest' in params and
                len(params['latest']) < 4):
            raise ValueError("Invalid value for parameter `latest` when calling `list_cluster_assess`, length must be greater than or equal to `4`")  # noqa: E501
        if ('success' in params and
                len(params['success']) > 5):
            raise ValueError("Invalid value for parameter `success` when calling `list_cluster_assess`, length must be less than or equal to `5`")  # noqa: E501
        if ('success' in params and
                len(params['success']) < 4):
            raise ValueError("Invalid value for parameter `success` when calling `list_cluster_assess`, length must be greater than or equal to `4`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/platform/20/upgrade/cluster/assess', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_cluster_patch_patches_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/16/upgrade/cluster/patch/patches', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_cluster_drain_timeout(self, cluster_drain_timeout, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param ClusterDrainTimeoutExtended cluster_drain_timeout: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_cluster_skip_optional(self, cluster_skip_optional, **kwargs):  # noqa: E501
        """update_cluster_skip_optional  # noqa: E501

            The option to indicate if the optional pre-upgrade checks should be skipped.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_cluster_skip_optional(cluster_skip_optional, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ClusterSkipOptional cluster_skip_optional: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_cluster_skip_optional_with_http_info(cluster_skip_optional, **kwargs)  # noqa: E501
        else:
            (data) = self.update_cluster_skip_optional_with_http_info(cluster_skip_optional, **kwargs)  # noqa: E501
            return data

    def update_cluster_skip_optional_with_http_info(self, cluster_skip_optional, **kwargs):  # noqa: E501
        """update_cluster_skip_optional  # noqa: E501

            The option to indicate if the optional pre-upgrade checks should be skipped.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_cluster_skip_optional_with_http_info(cluster_skip_optional, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['cluster_skip_optional']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_cluster_skip_optional" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_skip_optional' is set
        if ('cluster_skip_optional' not in params or
                params['cluster_skip_optional'] is None):
            raise ValueError("Missing the required parameter `cluster_skip_optional` when calling `update_cluster_skip_optional`")  # noqa: E501
        ...
        body_params = None
        if 'cluster_skip_optional' in params:
            body_params = params['cluster_skip_optional']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/20/upgrade/cluster/skip-optional', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_cluster_unblock_with_http_info(self, cluster_unblock, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/22/upgrade/cluster/unblock', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,

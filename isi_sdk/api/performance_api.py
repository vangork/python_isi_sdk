...
class PerformanceApi(object):
    ...
    def create_performance_dataset_with_http_info(self, performance_dataset, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/performance/datasets', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_datasets_dataset_workloads_workload_limit(self, datasets_dataset_workloads_workload_limit_id, dataset, workload, **kwargs):  # noqa: E501
        """delete_datasets_dataset_workloads_workload_limit  # noqa: E501

        Delete the workload limit.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_datasets_dataset_workloads_workload_limit(datasets_dataset_workloads_workload_limit_id, dataset, workload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str datasets_dataset_workloads_workload_limit_id: Delete the workload limit. (required)
        :param str dataset: (required)
        :param str workload: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_datasets_dataset_workloads_workload_limit_with_http_info(datasets_dataset_workloads_workload_limit_id, dataset, workload, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_datasets_dataset_workloads_workload_limit_with_http_info(datasets_dataset_workloads_workload_limit_id, dataset, workload, **kwargs)  # noqa: E501
            return data

    def delete_datasets_dataset_workloads_workload_limit_with_http_info(self, datasets_dataset_workloads_workload_limit_id, dataset, workload, **kwargs):  # noqa: E501
        """delete_datasets_dataset_workloads_workload_limit  # noqa: E501

        Delete the workload limit.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_datasets_dataset_workloads_workload_limit_with_http_info(datasets_dataset_workloads_workload_limit_id, dataset, workload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['datasets_dataset_workloads_workload_limit_id', 'dataset', 'workload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_datasets_dataset_workloads_workload_limit" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'datasets_dataset_workloads_workload_limit_id' is set
        if ('datasets_dataset_workloads_workload_limit_id' not in params or
                params['datasets_dataset_workloads_workload_limit_id'] is None):
            raise ValueError("Missing the required parameter `datasets_dataset_workloads_workload_limit_id` when calling `delete_datasets_dataset_workloads_workload_limit`")  # noqa: E501
        # verify the required parameter 'dataset' is set
        if ('dataset' not in params or
                params['dataset'] is None):
            raise ValueError("Missing the required parameter `dataset` when calling `delete_datasets_dataset_workloads_workload_limit`")  # noqa: E501
        # verify the required parameter 'workload' is set
        if ('workload' not in params or
                params['workload'] is None):
            raise ValueError("Missing the required parameter `workload` when calling `delete_datasets_dataset_workloads_workload_limit`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'datasets_dataset_workloads_workload_limit_id' in params:
            path_params['DatasetsDatasetWorkloadsWorkloadLimitId'] = params['datasets_dataset_workloads_workload_limit_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/16/performance/datasets/{Dataset}/workloads/{Workload}/limits/{DatasetsDatasetWorkloadsWorkloadLimitId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_performance_dataset_with_http_info(self, performance_dataset_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/performance/datasets/{PerformanceDatasetId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_performance_dataset_with_http_info(self, performance_dataset_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/performance/datasets/{PerformanceDatasetId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_performance_metric_with_http_info(self, performance_metric_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/performance/metrics/{PerformanceMetricId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_performance_metrics_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/performance/metrics', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_performance_settings_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/performance/settings', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_performance_datasets_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/performance/datasets', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_performance_dataset_with_http_info(self, performance_dataset, performance_dataset_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/performance/datasets/{PerformanceDatasetId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_performance_settings_with_http_info(self, performance_settings, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/performance/settings', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,

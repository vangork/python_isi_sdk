...
class StatisticsApi(object):
    ...
    def get_statistics_current(self, **kwargs):  # noqa: E501
        ...
        :param bool desc_info: Shows the description for the specified key(s).
    ...
    def get_statistics_current_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['degraded', 'desc_info', 'devid', 'key', 'keys', 'nodes', 'raw', 'show_nodes', 'stale', 'substr', 'timeout', 'type_info']  # noqa: E501
        ...
        if 'desc_info' in params:
            query_params.append(('desc_info', params['desc_info']))  # noqa: E501
        if 'devid' in params:
    ...
    def get_statistics_history_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['begin', 'degraded', 'desc_info', 'devid', 'end', 'interval', 'key', 'keys', 'memory_only', 'nodes', 'raw', 'resolution', 'show_nodes', 'stale', 'substr', 'timeout', 'type_info']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_summary_client(self, **kwargs):  # noqa: E501
        ...
        :param str protocols: A comma separated list. Default is all. (nfs3 | smb1 | nlm | ftp | http | siq | smb2 | nfs4 | nfsrdma | nfs4rdma | papi | jobd | irp | lsass_in | lsass_out | hdfs | s3 | internal | external)
    ...
    def get_summary_cloud(self, **kwargs):  # noqa: E501
        """get_summary_cloud  # noqa: E501

        List all Cloudpools statistics.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_summary_cloud(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str account: Specify an account for which statistics should be reported.
        :param bool degraded: Continue to report even if some nodes do not respond.Defaults to false.
        :param str nodes: Specify node(s) for which statistics should be reported. Default is 'all'. Zero (0) should be passed in as the sole argument to indicate local.
        :param str policy: Specify a policy for which statistics should be reported.
        :param str sort: Sort data by the specified comma-separated field(s). ( account | policy | in | out | reads | writes | deletes | cloud | node). Prepend 'asc:' or 'desc:' to a field to change the sort direction. 
        :param int timeout: Timeout remote commands after NUM seconds. Defaults to 5 seconds.
        :return: SummaryCloud
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_summary_cloud_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_summary_cloud_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_summary_cloud_with_http_info(self, **kwargs):  # noqa: E501
        """get_summary_cloud  # noqa: E501

        List all Cloudpools statistics.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_summary_cloud_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['account', 'degraded', 'nodes', 'policy', 'sort', 'timeout']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_summary_cloud" % key
                )
            params[key] = val
        del params['kwargs']

        if ('account' in params and
                len(params['account']) > 768):
            raise ValueError("Invalid value for parameter `account` when calling `get_summary_cloud`, length must be less than or equal to `768`")  # noqa: E501
        if ('account' in params and
                len(params['account']) < 1):
            raise ValueError("Invalid value for parameter `account` when calling `get_summary_cloud`, length must be greater than or equal to `1`")  # noqa: E501
        if ('nodes' in params and
                len(params['nodes']) > 8192):
            raise ValueError("Invalid value for parameter `nodes` when calling `get_summary_cloud`, length must be less than or equal to `8192`")  # noqa: E501
        if ('nodes' in params and
                len(params['nodes']) < 1):
            raise ValueError("Invalid value for parameter `nodes` when calling `get_summary_cloud`, length must be greater than or equal to `1`")  # noqa: E501
        if ('policy' in params and
                len(params['policy']) > 255):
            raise ValueError("Invalid value for parameter `policy` when calling `get_summary_cloud`, length must be less than or equal to `255`")  # noqa: E501
        if ('policy' in params and
                len(params['policy']) < 1):
            raise ValueError("Invalid value for parameter `policy` when calling `get_summary_cloud`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/platform/14/statistics/summary/cloud', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='SummaryCloud',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_summary_heat(self, **kwargs):  # noqa: E501
        ...
        :param int maxpath: Maximum bytes allocated for looking up a path. An ASCII character is 1 byte (it may be more for other types of encoding). The default is 4096 bytes. Zero (0) means unlimited (subject to the system limits).
        :param str nodes: A comma separated list. Specify node(s) for which statistics should be reported. Default is all. Zero (0) should be passed in as the sole argument to indicate local.
        :param bool numeric: Do not resolve LINs into filenames. Default is false. 
        :param int pathdepth: Squash paths to this directory depth. Defaults to none, i.e. the paths are not limited (subject to the system limits).
    ...
    def get_summary_protocol(self, **kwargs):  # noqa: E501
        ...
        :param str protocols: A comma separated list. Default is all external protocols. (nfs3 | smb1 | nlm | ftp | http | siq | smb2 | nfs4 | nfsrdma | nfs4rdma | papi | jobd | irp | lsass_in | lsass_out | hdfs | s3 | all | internal | external)
    ...
    def get_summary_protocol_stats(self, **kwargs):  # noqa: E501
        ...
        :param bool degraded: Continue to report if some nodes do not respond.
        :param str nodes: A comma separated list. Specify node(s) for which statistics should be reported. Default is all. Zero (0) should be passed in as the sole argument to indicate local.
        :param str protocol: A single protocol. Default is nfs3. (nfs3 | smb1 | nlm | ftp | http | siq | smb2 | nfs4 | nfsrdma | nfs4rdma | papi | jobd | irp | lsass_in | lsass_out | hdfs | s3)
        :param int timeout: Timeout remote commands after NUM seconds, where NUM is the integer passed to the argument.

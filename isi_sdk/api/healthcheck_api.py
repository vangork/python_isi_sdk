...
class HealthcheckApi(object):
    ...
    def create_healthcheck_evaluation_with_http_info(self, healthcheck_evaluation, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/22/healthcheck/evaluations', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_healthcheck_evaluation_with_http_info(self, healthcheck_evaluation_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/22/healthcheck/evaluations/{HealthcheckEvaluationId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_healthcheck_checklist_with_http_info(self, healthcheck_checklist_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/20/healthcheck/checklists/{HealthcheckChecklistId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_healthcheck_checklists_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/20/healthcheck/checklists', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_healthcheck_evaluation(self, healthcheck_evaluation_id, **kwargs):  # noqa: E501
        ...
        :param bool detailed: Default is false; return evaluation details for failing items. If true, return evaluation details for all passing and failing items.
        :param bool format_for_csv_download: Allow download of CSV formatted HC results.
    ...
    def get_healthcheck_evaluation_with_http_info(self, healthcheck_evaluation_id, **kwargs):  # noqa: E501
        ...
        all_params = ['healthcheck_evaluation_id', 'detailed', 'format_for_csv_download']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'format_for_csv_download' in params:
            query_params.append(('format_for_csv_download', params['format_for_csv_download']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/22/healthcheck/evaluations/{HealthcheckEvaluationId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_healthcheck_item_with_http_info(self, healthcheck_item_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/healthcheck/items/{HealthcheckItemId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_healthcheck_items_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/healthcheck/items', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_healthcheck_evaluations(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str checklist_id: Filter results to the specified Checklist or Item.
    ...
    def list_healthcheck_evaluations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['checklist_id', 'detailed', 'dir', 'level', 'limit', 'resume', 'sort']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('dir' in params and
                len(params['dir']) < 0):
            raise ValueError("Invalid value for parameter `dir` when calling `list_healthcheck_evaluations`, length must be greater than or equal to `0`")  # noqa: E501
        if 'limit' in params and params['limit'] > 4294967295:  # noqa: E501
        ...
        if ('sort' in params and
                len(params['sort']) > 255):
            raise ValueError("Invalid value for parameter `sort` when calling `list_healthcheck_evaluations`, length must be less than or equal to `255`")  # noqa: E501
        if ('sort' in params and
                len(params['sort']) < 0):
            raise ValueError("Invalid value for parameter `sort` when calling `list_healthcheck_evaluations`, length must be greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        if 'checklist_id' in params:
            query_params.append(('checklist_id', params['checklist_id']))  # noqa: E501
        if 'detailed' in params:
            query_params.append(('detailed', params['detailed']))  # noqa: E501
        if 'dir' in params:
            query_params.append(('dir', params['dir']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/22/healthcheck/evaluations', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_healthcheck_checklist_with_http_info(self, healthcheck_checklist, healthcheck_checklist_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/20/healthcheck/checklists/{HealthcheckChecklistId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_healthcheck_evaluation_with_http_info(self, healthcheck_evaluation, healthcheck_evaluation_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/22/healthcheck/evaluations/{HealthcheckEvaluationId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,

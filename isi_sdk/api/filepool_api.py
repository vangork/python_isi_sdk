...
class FilepoolApi(object):
    ...
    def create_filepool_policy(self, filepool_policy, **kwargs):  # noqa: E501
        ...
        Create a new file pool policy.  # noqa: E501
    ...
    def create_filepool_policy_with_http_info(self, filepool_policy, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/12/filepool/policies', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_filepool_policy_with_http_info(self, filepool_policy_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/12/filepool/policies/{FilepoolPolicyId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_filepool_policy_with_http_info(self, filepool_policy_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/12/filepool/policies/{FilepoolPolicyId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_filepool_policies(self, **kwargs):  # noqa: E501
        ...
        List all file pool policies.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_filepool_policies_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/12/filepool/policies', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_filepool_policy_with_http_info(self, filepool_policy, filepool_policy_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/12/filepool/policies/{FilepoolPolicyId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,

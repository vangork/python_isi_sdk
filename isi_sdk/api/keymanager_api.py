...
class KeymanagerApi(object):
    ...
    def create_kmip_server_with_http_info(self, kmip_server, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/keymanager/kmip/servers', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_kmip_server_with_http_info(self, kmip_server_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/keymanager/kmip/servers/{KmipServerId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_kmip_server_with_http_info(self, kmip_server_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/keymanager/kmip/servers/{KmipServerId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_kmip_servers_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/keymanager/kmip/servers', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_kmip_server_with_http_info(self, kmip_server, kmip_server_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/19/keymanager/kmip/servers/{KmipServerId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,

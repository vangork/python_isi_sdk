...
[**get_network_interfaces**](LocalApi.md#get_network_interfaces) | **GET** /platform/21/local/network/interfaces | 
...
api_instance = isi_sdk.LocalApi(isi_sdk.ApiClient(configuration))

...
[**create_cluster_add_node_item**](ClusterApi.md#create_cluster_add_node_item) | **POST** /platform/16/cluster/add-node | 
[**create_diagnostics_gather_start_item**](ClusterApi.md#create_diagnostics_gather_start_item) | **POST** /platform/21/cluster/diagnostics/gather/start | 
...
[**create_diagnostics_netlogger_start_item**](ClusterApi.md#create_diagnostics_netlogger_start_item) | **POST** /platform/21/cluster/diagnostics/netlogger/start | 
...
[**get_cluster_config**](ClusterApi.md#get_cluster_config) | **GET** /platform/17/cluster/config | 
[**get_cluster_email**](ClusterApi.md#get_cluster_email) | **GET** /platform/21/cluster/email | 
...
[**get_cluster_node**](ClusterApi.md#get_cluster_node) | **GET** /platform/16/cluster/nodes/{ClusterNodeId} | 
[**get_cluster_nodes**](ClusterApi.md#get_cluster_nodes) | **GET** /platform/16/cluster/nodes | 
...
[**get_diagnostics_gather_groups**](ClusterApi.md#get_diagnostics_gather_groups) | **GET** /platform/19/cluster/diagnostics/gather/groups | 
[**get_diagnostics_gather_settings**](ClusterApi.md#get_diagnostics_gather_settings) | **GET** /platform/21/cluster/diagnostics/gather/settings | 
[**get_diagnostics_gather_status**](ClusterApi.md#get_diagnostics_gather_status) | **GET** /platform/21/cluster/diagnostics/gather/status | 
[**get_diagnostics_netlogger**](ClusterApi.md#get_diagnostics_netlogger) | **GET** /platform/3/cluster/diagnostics/netlogger | 
[**get_diagnostics_netlogger_settings**](ClusterApi.md#get_diagnostics_netlogger_settings) | **GET** /platform/20/cluster/diagnostics/netlogger/settings | 
...
[**get_iceage_settings**](ClusterApi.md#get_iceage_settings) | **GET** /platform/16/cluster/iceage/settings | 
...
[**get_maintenance_settings**](ClusterApi.md#get_maintenance_settings) | **GET** /platform/20/cluster/maintenance/settings | 
...
[**update_cluster_email**](ClusterApi.md#update_cluster_email) | **PUT** /platform/21/cluster/email | 
...
[**update_diagnostics_gather_settings**](ClusterApi.md#update_diagnostics_gather_settings) | **PUT** /platform/21/cluster/diagnostics/gather/settings | 
[**update_diagnostics_netlogger_settings**](ClusterApi.md#update_diagnostics_netlogger_settings) | **PUT** /platform/20/cluster/diagnostics/netlogger/settings | 
[**update_iceage_settings**](ClusterApi.md#update_iceage_settings) | **PUT** /platform/16/cluster/iceage/settings | 
...
[**update_maintenance_settings**](ClusterApi.md#update_maintenance_settings) | **PUT** /platform/20/cluster/maintenance/settings | 
...
api_instance = isi_sdk.ClusterApi(isi_sdk.ApiClient(configuration))
cluster_ac = isi_sdk.ClusterAc() # ClusterAc | 
...
# create an instance of the API class
api_instance = isi_sdk.ClusterApi(isi_sdk.ApiClient(configuration))
diagnostics_gather_start_item = isi_sdk.DiagnosticsGatherStartItem() # DiagnosticsGatherStartItem | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **diagnostics_gather_start_item** | [**DiagnosticsGatherStartItem**](DiagnosticsGatherStartItem.md)|  | 
...
# create an instance of the API class
api_instance = isi_sdk.ClusterApi(isi_sdk.ApiClient(configuration))
diagnostics_gather_stop_item = isi_sdk.Empty() # Empty | 
...
# create an instance of the API class
api_instance = isi_sdk.ClusterApi(isi_sdk.ApiClient(configuration))
diagnostics_netlogger_start_item = isi_sdk.DiagnosticsNetloggerSettingsSettings() # DiagnosticsNetloggerSettingsSettings | 
...
# create an instance of the API class
api_instance = isi_sdk.ClusterApi(isi_sdk.ApiClient(configuration))
diagnostics_netlogger_stop_item = isi_sdk.Empty() # Empty | 
...
> DiagnosticsGather get_diagnostics_gather()
...
[**DiagnosticsGather**](DiagnosticsGather.md)
...
# **get_diagnostics_gather_groups**
> DiagnosticsGatherGroups get_diagnostics_gather_groups()



Get the list of valid component group arguments.
...
try:
    api_response = api_instance.get_diagnostics_gather_groups()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ClusterApi->get_diagnostics_gather_groups: %s\n" % e)
```
...
[**DiagnosticsGatherGroups**](DiagnosticsGatherGroups.md)
...
Get the default options for diagnostics gathers.
...
> DiagnosticsGatherStatus get_diagnostics_gather_status(reference=reference)



Get the list of diagnostic gathers for reference ID(s).
...
# create an instance of the API class
api_instance = isi_sdk.ClusterApi(isi_sdk.ApiClient(configuration))
reference = 'reference_example' # str | Comma separated list of reference ID(s) (optional)

try:
    api_response = api_instance.get_diagnostics_gather_status(reference=reference)
    pprint(api_response)
except ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **reference** | **str**| Comma separated list of reference ID(s) | [optional] 
...
# **get_iceage_settings**
> IceageSettings get_iceage_settings()



Get the default options for IceAge.
...
try:
    api_response = api_instance.get_iceage_settings()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ClusterApi->get_iceage_settings: %s\n" % e)
```
...
[**IceageSettings**](IceageSettings.md)
...
> MaintenanceSettings get_maintenance_settings()



Get the options for auto maintenance mode.
...
try:
    api_response = api_instance.get_maintenance_settings()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ClusterApi->get_maintenance_settings: %s\n" % e)
```
...
[**MaintenanceSettings**](MaintenanceSettings.md)
...
# create an instance of the API class
api_instance = isi_sdk.ClusterApi(isi_sdk.ApiClient(configuration))
cluster_internal_networks = isi_sdk.ClusterInternalNetworksExtended() # ClusterInternalNetworksExtended | 
...
# create an instance of the API class
api_instance = isi_sdk.ClusterApi(isi_sdk.ApiClient(configuration))
cluster_update_lnns = isi_sdk.ClusterUpdateLnns() # ClusterUpdateLnns | 
...
Set the default options for diagnostics gathers.
...
# create an instance of the API class
api_instance = isi_sdk.ClusterApi(isi_sdk.ApiClient(configuration))
diagnostics_gather_settings = isi_sdk.DiagnosticsGatherSettingsExtended() # DiagnosticsGatherSettingsExtended | 
...
# create an instance of the API class
api_instance = isi_sdk.ClusterApi(isi_sdk.ApiClient(configuration))
diagnostics_netlogger_settings = isi_sdk.DiagnosticsNetloggerSettingsSettings() # DiagnosticsNetloggerSettingsSettings | 
...
# **update_iceage_settings**
> update_iceage_settings(iceage_settings)



Set the default options for IceAge.
...
# create an instance of the API class
api_instance = isi_sdk.ClusterApi(isi_sdk.ApiClient(configuration))
iceage_settings = isi_sdk.IceageSettingsSettings() # IceageSettingsSettings | 

try:
    api_instance.update_iceage_settings(iceage_settings)
except ApiException as e:
    print("Exception when calling ClusterApi->update_iceage_settings: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **iceage_settings** | [**IceageSettingsSettings**](IceageSettingsSettings.md)|  | 
...
# create an instance of the API class
api_instance = isi_sdk.ClusterApi(isi_sdk.ApiClient(configuration))
internal_networks_preferred_network = isi_sdk.InternalNetworksPreferredNetwork() # InternalNetworksPreferredNetwork | 
...
# create an instance of the API class
api_instance = isi_sdk.ClusterApi(isi_sdk.ApiClient(configuration))
internal_networks_settings = isi_sdk.InternalNetworksSettingsExtended() # InternalNetworksSettingsExtended | 
...
> update_maintenance_settings(maintenance_settings)



Set the options for auto maintenance mode.
...
# create an instance of the API class
api_instance = isi_sdk.ClusterApi(isi_sdk.ApiClient(configuration))
maintenance_settings = isi_sdk.MaintenanceSettingsExtended() # MaintenanceSettingsExtended | 

try:
    api_instance.update_maintenance_settings(maintenance_settings)
except ApiException as e:
    print("Exception when calling ClusterApi->update_maintenance_settings: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **maintenance_settings** | [**MaintenanceSettingsExtended**](MaintenanceSettingsExtended.md)|  | 

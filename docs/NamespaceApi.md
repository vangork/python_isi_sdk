...
api_instance = isi_sdk.NamespaceApi(isi_sdk.ApiClient(configuration))
...
access_point = isi_sdk.AccessPointCreateParams() # AccessPointCreateParams | Access point parameters model.
...
directory_query = isi_sdk.DirectoryQuery() # DirectoryQuery | Directory query parameters model.
...
namespace_acl = isi_sdk.NamespaceAcl() # NamespaceAcl | Namespace ACL parameters model.
nsaccess = true # bool | Indicates that the operation is on the access point instead of the store path. (optional)
...
directory_metadata = isi_sdk.NamespaceMetadata() # NamespaceMetadata | Directory metadata parameters model.
...
file_metadata = isi_sdk.NamespaceMetadata() # NamespaceMetadata | File metadata parameters model.
...
worm_file_path = 'worm_file_path_example' # str | Write once read many file path relative to /.
worm = true # bool | View WORM properties
worm_properties = isi_sdk.WormCreateParams() # WormCreateParams | WORM parameters model.

...
api_instance = isi_sdk.FilesystemApi(isi_sdk.ApiClient(configuration))
...
# create an instance of the API class
api_instance = isi_sdk.FilesystemApi(isi_sdk.ApiClient(configuration))
settings_character_encodings = isi_sdk.SettingsCharacterEncodingsExtended() # SettingsCharacterEncodingsExtended | 
...
# create an instance of the API class
api_instance = isi_sdk.FilesystemApi(isi_sdk.ApiClient(configuration))
settings_compression = isi_sdk.SettingsCompressionExtended() # SettingsCompressionExtended | 

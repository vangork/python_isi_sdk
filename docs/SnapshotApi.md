...
api_instance = isi_sdk.SnapshotApi(isi_sdk.ApiClient(configuration))
snapshot_alias = isi_sdk.SnapshotAliasCreateParams() # SnapshotAliasCreateParams | 
...
# create an instance of the API class
api_instance = isi_sdk.SnapshotApi(isi_sdk.ApiClient(configuration))
snapshot_writable_item = isi_sdk.SnapshotWritableItem() # SnapshotWritableItem | 
...
> QuotaLicense get_snapshot_license()
...
# create an instance of the API class
api_instance = isi_sdk.SnapshotApi(isi_sdk.ApiClient(configuration))
snapshot_alias = isi_sdk.SnapshotAlias() # SnapshotAlias | 

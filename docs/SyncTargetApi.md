...
[**get_reports_report_subreport**](SyncTargetApi.md#get_reports_report_subreport) | **GET** /platform/22/sync/target/reports/{Rid}/subreports/{ReportsReportSubreportId} | 
[**get_reports_report_subreports**](SyncTargetApi.md#get_reports_report_subreports) | **GET** /platform/22/sync/target/reports/{Rid}/subreports | 
...
api_instance = isi_sdk.SyncTargetApi(isi_sdk.ApiClient(configuration))

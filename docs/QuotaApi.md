...
------------- | ------------- | -------------
[**create_quota_quota**](QuotaApi.md#create_quota_quota) | **POST** /platform/19/quota/quotas | 
...
[**delete_quota_quota**](QuotaApi.md#delete_quota_quota) | **DELETE** /platform/19/quota/quotas/{QuotaQuotaId} | 
[**delete_quota_quotas**](QuotaApi.md#delete_quota_quotas) | **DELETE** /platform/19/quota/quotas | 
...
[**get_quota_quota**](QuotaApi.md#get_quota_quota) | **GET** /platform/19/quota/quotas/{QuotaQuotaId} | 
...
[**list_quota_quotas**](QuotaApi.md#list_quota_quotas) | **GET** /platform/19/quota/quotas | 
...
[**update_quota_quota**](QuotaApi.md#update_quota_quota) | **PUT** /platform/19/quota/quotas/{QuotaQuotaId} | 
...
api_instance = isi_sdk.QuotaApi(isi_sdk.ApiClient(configuration))
...
# create an instance of the API class
api_instance = isi_sdk.QuotaApi(isi_sdk.ApiClient(configuration))
settings_mapping = isi_sdk.SettingsMappingCreateParams() # SettingsMappingCreateParams | 
...
Delete all or matching quotas. For any query argument not supplied, the default behavior is return all.
...
recurse_path_children = true # bool | If used with the path argument, delete all quotas at that path or any descendant sub-directory. (optional)
 ...
 **recurse_path_children** | **bool**| If used with the path argument, delete all quotas at that path or any descendant sub-directory. | [optional] 
...
# **get_quota_license**
> QuotaLicense get_quota_license()
...
# create an instance of the API class
api_instance = isi_sdk.QuotaApi(isi_sdk.ApiClient(configuration))
enforced = true # bool | Only list enforced quotas. (optional)
...
recurse_path_children = true # bool | If used with the path argument, match all quotas at that path or any descendant sub-directory. (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **enforced** | **bool**| Only list enforced quotas. | [optional] 
 ...
 **recurse_path_children** | **bool**| If used with the path argument, match all quotas at that path or any descendant sub-directory. | [optional] 
...
> SettingsMappingsExtended list_settings_mappings()
...
[**SettingsMappingsExtended**](SettingsMappingsExtended.md)
...
> SettingsNotifications list_settings_notifications()

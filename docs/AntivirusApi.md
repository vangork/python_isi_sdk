...
api_instance = isi_sdk.AntivirusApi(isi_sdk.ApiClient(configuration))
...
# create an instance of the API class
api_instance = isi_sdk.AntivirusApi(isi_sdk.ApiClient(configuration))
antivirus_settings = isi_sdk.AntivirusSettingsExtended() # AntivirusSettingsExtended | 

...
api_instance = isi_sdk.CloudApi(isi_sdk.ApiClient(configuration))
...
# create an instance of the API class
api_instance = isi_sdk.CloudApi(isi_sdk.ApiClient(configuration))
cloud_certificate = isi_sdk.CertificatesSyslogItem() # CertificatesSyslogItem | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **cloud_certificate** | [**CertificatesSyslogItem**](CertificatesSyslogItem.md)|  | 
...
# create an instance of the API class
api_instance = isi_sdk.CloudApi(isi_sdk.ApiClient(configuration))
cloud_proxy = isi_sdk.CloudProxyCreateParams() # CloudProxyCreateParams | 
...
# create an instance of the API class
api_instance = isi_sdk.CloudApi(isi_sdk.ApiClient(configuration))
settings_encryption_key_item = isi_sdk.Empty() # Empty | 
...
# create an instance of the API class
api_instance = isi_sdk.CloudApi(isi_sdk.ApiClient(configuration))
settings_reporting_eula_item = isi_sdk.Empty() # Empty | 
...
> CertificatesSyslog get_cloud_certificate(cloud_certificate_id)
...
# create an instance of the API class
api_instance = isi_sdk.CloudApi(isi_sdk.ApiClient(configuration))
cloud_certificate = isi_sdk.CertificatesSyslogIdParams() # CertificatesSyslogIdParams | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **cloud_certificate** | [**CertificatesSyslogIdParams**](CertificatesSyslogIdParams.md)|  | 
...
# create an instance of the API class
api_instance = isi_sdk.CloudApi(isi_sdk.ApiClient(configuration))
cloud_proxy = isi_sdk.CloudProxy() # CloudProxy | 

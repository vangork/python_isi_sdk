...
[**get_http_service**](ProtocolsApi.md#get_http_service) | **GET** /platform/15/protocols/http/services/{HttpServiceId} | 
...
[**get_nfs_waiters**](ProtocolsApi.md#get_nfs_waiters) | **GET** /platform/16/protocols/nfs/waiters | 
...
[**update_smb_share**](ProtocolsApi.md#update_smb_share) | **PUT** /platform/22/protocols/smb/shares/{SmbShareId} | 
...
# **get_http_service**
> HttpServices get_http_service(http_service_id)



Get the HTTP service status.
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
http_service_id = 'http_service_id_example' # str | Get the HTTP service status.

try:
    api_response = api_instance.get_http_service(http_service_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ProtocolsApi->get_http_service: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **http_service_id** | **str**| Get the HTTP service status. | 

### Return type

[**HttpServices**](HttpServices.md)
...
# **get_http_services**
> HttpServicesExtended get_http_services()



Get detailed information for all remote HTTP services.
...
try:
    api_response = api_instance.get_http_services()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ProtocolsApi->get_http_services: %s\n" % e)
```
...
[**HttpServicesExtended**](HttpServicesExtended.md)
...
# **get_nfs_locks**
> NfsLocks get_nfs_locks(client=client, client_id=client_id, created=created, dir=dir, limit=limit, lin=lin, path=path, sort=sort, version=version)
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
client = 'client_example' # str | Filter locks by the specified client host (optional)
client_id = 56 # int | Filter locks by the specified client ID. (optional)
created = 56 # int | Return locks created before the (optional)
dir = 'dir_example' # str | The direction of the sort. (optional)
limit = 56 # int | Return no more than this many results at once (see resume). (optional)
lin = 56 # int | Filter locks by the specified LIN in /ifs that is locked. (optional)
path = 'path_example' # str | Filter locks by the specified path under /ifs. (optional)
sort = 'sort_example' # str | The field that will be used for sorting. (optional)
version = 'version_example' # str | Filter by major NFS version: v3 or v4. (optional)

try:
    api_response = api_instance.get_nfs_locks(client=client, client_id=client_id, created=created, dir=dir, limit=limit, lin=lin, path=path, sort=sort, version=version)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ProtocolsApi->get_nfs_locks: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **client** | **str**| Filter locks by the specified client host | [optional] 
 **client_id** | **int**| Filter locks by the specified client ID. | [optional] 
 **created** | **int**| Return locks created before the | [optional] 
 **dir** | **str**| The direction of the sort. | [optional] 
 **limit** | **int**| Return no more than this many results at once (see resume). | [optional] 
 **lin** | **int**| Filter locks by the specified LIN in /ifs that is locked. | [optional] 
 **path** | **str**| Filter locks by the specified path under /ifs. | [optional] 
 **sort** | **str**| The field that will be used for sorting. | [optional] 
 **version** | **str**| Filter by major NFS version: v3 or v4. | [optional] 

### Return type

[**NfsLocks**](NfsLocks.md)
...
# **get_nfs_waiters**
> NfsWaiters get_nfs_waiters(client=client, client_id=client_id, created=created, dir=dir, limit=limit, lin=lin, path=path, sort=sort)



List all persisted lock waiters.
...
try:
    api_response = api_instance.get_nfs_waiters(client=client, client_id=client_id, created=created, dir=dir, limit=limit, lin=lin, path=path, sort=sort)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ProtocolsApi->get_nfs_waiters: %s\n" % e)
```
...
# **get_smb_sessions**
> SmbSessions get_smb_sessions(limit=limit, lnn=lnn, lnn_skip=lnn_skip, resume=resume)
...
> HdfsProxyusersExtended list_hdfs_proxyusers(dir=dir, limit=limit, resume=resume, zone=zone)
...
[**HdfsProxyusersExtended**](HdfsProxyusersExtended.md)
...
# **list_s3_buckets**
> S3BucketsExtended list_s3_buckets(dir=dir, limit=limit, offset=offset, owner=owner, resume=resume, sort=sort, zone=zone)
...
try:
    api_response = api_instance.list_s3_buckets(dir=dir, limit=limit, offset=offset, owner=owner, resume=resume, sort=sort, zone=zone)
    pprint(api_response)
except ApiException as e:
...
# **list_smb_shares**
> SmbSharesExtended list_smb_shares(dir=dir, limit=limit, offset=offset, resolve_names=resolve_names, resume=resume, scope=scope, sort=sort, zone=zone)
...
try:
    api_response = api_instance.list_smb_shares(dir=dir, limit=limit, offset=offset, resolve_names=resolve_names, resume=resume, scope=scope, sort=sort, zone=zone)
    pprint(api_response)
except ApiException as e:
...
# **update_ftp_settings**
> update_ftp_settings(ftp_settings, force=force)
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
ftp_settings = isi_sdk.FtpSettingsExtended() # FtpSettingsExtended | 
force = true # bool | Force modify FTP settings, even if it leads to FTP service being blocked (optional)

try:
    api_instance.update_ftp_settings(ftp_settings, force=force)
except ApiException as e:
 ...
 **force** | **bool**| Force modify FTP settings, even if it leads to FTP service being blocked | [optional] 
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
hdfs_crypto_settings = isi_sdk.HdfsCryptoSettingsSettings() # HdfsCryptoSettingsSettings | 
zone = 'zone_example' # str | Specifies which access zone to use. (optional)
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
hdfs_fsimage_job_settings = isi_sdk.HdfsFsimageJobSettingsSettings() # HdfsFsimageJobSettingsSettings | 
zone = 'zone_example' # str | Access zone which contains job settings. (optional)
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
hdfs_fsimage_settings = isi_sdk.HdfsFsimageSettingsSettings() # HdfsFsimageSettingsSettings | 
zone = 'zone_example' # str | Access zone which contains FSImage settings. (optional)
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
hdfs_inotify_settings = isi_sdk.HdfsInotifySettingsSettings() # HdfsInotifySettingsSettings | 
zone = 'zone_example' # str | Access zone which contains INotify settings. (optional)
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
hdfs_ranger_plugin_settings = isi_sdk.HdfsRangerPluginSettingsSettings() # HdfsRangerPluginSettingsSettings | 
zone = 'zone_example' # str | Access zone which contains HDFS ranger-plugin settings. (optional)
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
hdfs_settings_global = isi_sdk.HdfsSettingsGlobalGlobalSettings() # HdfsSettingsGlobalGlobalSettings | 
...
# **update_http_service**
> update_http_service(http_service, http_service_id)



Modify HTTP services.
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
http_service = isi_sdk.HttpService() # HttpService | 
http_service_id = 'http_service_id_example' # str | Modify HTTP services.

try:
    api_instance.update_http_service(http_service, http_service_id)
except ApiException as e:
    print("Exception when calling ProtocolsApi->update_http_service: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **http_service** | [**HttpService**](HttpService.md)|  | 
 **http_service_id** | **str**| Modify HTTP services. | 
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
http_settings = isi_sdk.HttpSettingsExtended() # HttpSettingsExtended | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **http_settings** | [**HttpSettingsExtended**](HttpSettingsExtended.md)|  | 
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
ndmp_settings_preferred_ip = isi_sdk.NdmpSettingsPreferredIp() # NdmpSettingsPreferredIp | 
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
ndmp_settings_variable = isi_sdk.NdmpSettingsVariable() # NdmpSettingsVariable | 
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
nfs_alias = isi_sdk.NfsAlias() # NfsAlias | 
...
Modify the default values for NFS exports. All input fields areoptional, but one or more must be supplied.
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
s3_bucket = isi_sdk.S3Bucket() # S3Bucket | 
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
s3_log_level = isi_sdk.S3LogLevel() # S3LogLevel | 
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
s3_settings_global = isi_sdk.S3SettingsGlobalSettings() # S3SettingsGlobalSettings | 
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
s3_settings_zone = isi_sdk.S3SettingsZoneSettings() # S3SettingsZoneSettings | 
zone = 'zone_example' # str | Access zone (optional)
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
smb_settings_global = isi_sdk.SmbSettingsGlobalExtended() # SmbSettingsGlobalExtended | 
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
smb_settings_share = isi_sdk.SmbSettingsShareExtended() # SmbSettingsShareExtended | 
zone = 'zone_example' # str | Specifies which access zone to use. (optional)
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
smb_settings_zone = isi_sdk.SmbSettingsZoneSettings() # SmbSettingsZoneSettings | 
zone = 'zone_example' # str | Name of the access zone (optional)
...
# create an instance of the API class
api_instance = isi_sdk.ProtocolsApi(isi_sdk.ApiClient(configuration))
ssh_settings = isi_sdk.SshSettingsSettings() # SshSettingsSettings | 

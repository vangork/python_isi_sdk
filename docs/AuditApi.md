...
api_instance = isi_sdk.AuditApi(isi_sdk.ApiClient(configuration))
...
# create an instance of the API class
api_instance = isi_sdk.AuditApi(isi_sdk.ApiClient(configuration))
certificates_syslog_item = isi_sdk.CertificatesSyslogItem() # CertificatesSyslogItem | 
...
> CertificatesSyslog get_certificates_syslog_by_id(certificates_syslog_id)
...
> CertificatesSyslogExtended list_certificates_syslog(dir=dir, limit=limit, resume=resume, sort=sort)
...
# create an instance of the API class
api_instance = isi_sdk.AuditApi(isi_sdk.ApiClient(configuration))
certificates_syslog_id_params = isi_sdk.CertificatesSyslogIdParams() # CertificatesSyslogIdParams | 

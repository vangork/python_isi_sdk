...
api_instance = isi_sdk.ProtocolsHdfsApi(isi_sdk.ApiClient(configuration))
proxyusers_name_member = isi_sdk.AuthAccessAccessItemFileGroup() # AuthAccessAccessItemFileGroup | 

...
api_instance = isi_sdk.AvscanApi(isi_sdk.ApiClient(configuration))
avscan_job = isi_sdk.AvscanJobCreateParams() # AvscanJobCreateParams | 
...
# create an instance of the API class
api_instance = isi_sdk.AvscanApi(isi_sdk.ApiClient(configuration))
avscan_server = isi_sdk.AvscanServerCreateParams() # AvscanServerCreateParams | 
...
# create an instance of the API class
api_instance = isi_sdk.AvscanApi(isi_sdk.ApiClient(configuration))
avscan_filter = isi_sdk.AvscanFilter() # AvscanFilter | 
...
# create an instance of the API class
api_instance = isi_sdk.AvscanApi(isi_sdk.ApiClient(configuration))
avscan_job = isi_sdk.AvscanJob() # AvscanJob | 
...
# create an instance of the API class
api_instance = isi_sdk.AvscanApi(isi_sdk.ApiClient(configuration))
avscan_server = isi_sdk.AvscanServer() # AvscanServer | 
...
# create an instance of the API class
api_instance = isi_sdk.AvscanApi(isi_sdk.ApiClient(configuration))
avscan_settings = isi_sdk.AvscanSettingsSettings() # AvscanSettingsSettings | 
